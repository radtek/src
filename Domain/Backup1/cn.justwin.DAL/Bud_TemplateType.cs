namespace cn.justwin.DAL
{
    ...
    public class Bud_TemplateType : EntityObject
    {
        ...
        public EntityCollection<cn.justwin.DAL.Bud_Template> Bud_Template
        {
            get
            {
                return this.RelationshipManager.GetRelatedCollection<cn.justwin.DAL.Bud_Template>("Pm2Model.FK__Bud_Templ__Templ__2611717D", "Bud_Template");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedCollection<cn.justwin.DAL.Bud_Template>("Pm2Model.FK__Bud_Templ__Templ__2611717D", "Bud_Template", value);
                }
            }
        }
