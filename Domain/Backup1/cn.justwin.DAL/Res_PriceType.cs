namespace cn.justwin.DAL
{
    ...
    public class Res_PriceType : EntityObject
    {
        ...
        public EntityCollection<cn.justwin.DAL.Res_Price> Res_Price
        {
            get
            {
                return this.RelationshipManager.GetRelatedCollection<cn.justwin.DAL.Res_Price>("Pm2Model.FK__Res_Price__Price__176E4C6B", "Res_Price");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedCollection<cn.justwin.DAL.Res_Price>("Pm2Model.FK__Res_Price__Price__176E4C6B", "Res_Price", value);
                }
            }
        }
