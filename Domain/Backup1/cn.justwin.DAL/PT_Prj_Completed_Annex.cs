namespace cn.justwin.DAL
{
    ...
    public class PT_Prj_Completed_Annex : EntityObject
    {
        ...
        public cn.justwin.DAL.PT_Prj_Completed_Detail PT_Prj_Completed_Detail
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_Prj_Completed_Detail>("Pm2Model.FK__PT_Prj_Co__Detai__32CD1974", "PT_Prj_Completed_Detail").Value;
            }
            set
            {
                this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_Prj_Completed_Detail>("Pm2Model.FK__PT_Prj_Co__Detai__32CD1974", "PT_Prj_Completed_Detail").Value = value;
            }
        }
        ...
        public EntityReference<cn.justwin.DAL.PT_Prj_Completed_Detail> PT_Prj_Completed_DetailReference
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_Prj_Completed_Detail>("Pm2Model.FK__PT_Prj_Co__Detai__32CD1974", "PT_Prj_Completed_Detail");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedReference<cn.justwin.DAL.PT_Prj_Completed_Detail>("Pm2Model.FK__PT_Prj_Co__Detai__32CD1974", "PT_Prj_Completed_Detail", value);
                }
            }
        }
    }
