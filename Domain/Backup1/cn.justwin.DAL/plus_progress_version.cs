namespace cn.justwin.DAL
{
    ...
    public class plus_progress_version : EntityObject
    {
        ...
        public cn.justwin.DAL.plus_progress plus_progress
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.plus_progress>("Pm2Model.FK_progress_version_ProgressId", "plus_progress").Value;
            }
            set
            {
                this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.plus_progress>("Pm2Model.FK_progress_version_ProgressId", "plus_progress").Value = value;
            }
        }
        ...
        public EntityReference<cn.justwin.DAL.plus_progress> plus_progressReference
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.plus_progress>("Pm2Model.FK_progress_version_ProgressId", "plus_progress");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedReference<cn.justwin.DAL.plus_progress>("Pm2Model.FK_progress_version_ProgressId", "plus_progress", value);
                }
            }
        }
        ...
        public EntityCollection<cn.justwin.DAL.plus_report> plus_report
        {
            get
            {
                return this.RelationshipManager.GetRelatedCollection<cn.justwin.DAL.plus_report>("Pm2Model.FK_plus_progress_version", "plus_report");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedCollection<cn.justwin.DAL.plus_report>("Pm2Model.FK_plus_progress_version", "plus_report", value);
                }
            }
        }
        ...
        public cn.justwin.DAL.PT_yhmc PT_yhmc
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_yhmc>("Pm2Model.FK_progress_version_InputUser", "PT_yhmc").Value;
            }
            set
            {
                this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_yhmc>("Pm2Model.FK_progress_version_InputUser", "PT_yhmc").Value = value;
            }
        }
        ...
        public EntityReference<cn.justwin.DAL.PT_yhmc> PT_yhmcReference
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_yhmc>("Pm2Model.FK_progress_version_InputUser", "PT_yhmc");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedReference<cn.justwin.DAL.PT_yhmc>("Pm2Model.FK_progress_version_InputUser", "PT_yhmc", value);
                }
            }
        }
