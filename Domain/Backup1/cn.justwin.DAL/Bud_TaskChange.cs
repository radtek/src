namespace cn.justwin.DAL
{
    ...
    public class Bud_TaskChange : EntityObject
    {
        ...
        public cn.justwin.DAL.PT_yhmc PT_yhmc
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_yhmc>("Pm2Model.FK__Bud_TaskC__Input__292EA0A1", "PT_yhmc").Value;
            }
            set
            {
                this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_yhmc>("Pm2Model.FK__Bud_TaskC__Input__292EA0A1", "PT_yhmc").Value = value;
            }
        }
        ...
        public EntityReference<cn.justwin.DAL.PT_yhmc> PT_yhmcReference
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_yhmc>("Pm2Model.FK__Bud_TaskC__Input__292EA0A1", "PT_yhmc");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedReference<cn.justwin.DAL.PT_yhmc>("Pm2Model.FK__Bud_TaskC__Input__292EA0A1", "PT_yhmc", value);
                }
            }
        }
