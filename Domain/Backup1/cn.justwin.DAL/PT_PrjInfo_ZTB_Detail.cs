namespace cn.justwin.DAL
{
    ...
    public class PT_PrjInfo_ZTB_Detail : EntityObject
    {
        ...
        public EntityCollection<cn.justwin.DAL.PT_PrjInfo_Kind> PT_PrjInfo_Kind
        {
            get
            {
                return this.RelationshipManager.GetRelatedCollection<cn.justwin.DAL.PT_PrjInfo_Kind>("Pm2Model.FK__PT_PrjInf__PrjGu__0313E4B1", "PT_PrjInfo_Kind");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedCollection<cn.justwin.DAL.PT_PrjInfo_Kind>("Pm2Model.FK__PT_PrjInf__PrjGu__0313E4B1", "PT_PrjInfo_Kind", value);
                }
            }
        }
        ...
        public EntityCollection<cn.justwin.DAL.PT_PrjInfo_Rank> PT_PrjInfo_Rank
        {
            get
            {
                return this.RelationshipManager.GetRelatedCollection<cn.justwin.DAL.PT_PrjInfo_Rank>("Pm2Model.FK__PT_PrjInf__PrjGu__06E47595", "PT_PrjInfo_Rank");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedCollection<cn.justwin.DAL.PT_PrjInfo_Rank>("Pm2Model.FK__PT_PrjInf__PrjGu__06E47595", "PT_PrjInfo_Rank", value);
                }
            }
        }
