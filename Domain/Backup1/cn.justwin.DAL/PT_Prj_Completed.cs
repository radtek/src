namespace cn.justwin.DAL
{
    ...
    public class PT_Prj_Completed : EntityObject
    {
        ...
        public EntityCollection<cn.justwin.DAL.PT_Prj_Completed_Detail> PT_Prj_Completed_Detail
        {
            get
            {
                return this.RelationshipManager.GetRelatedCollection<cn.justwin.DAL.PT_Prj_Completed_Detail>("Pm2Model.FK__PT_Prj_Co__PrjCo__6A525888", "PT_Prj_Completed_Detail");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedCollection<cn.justwin.DAL.PT_Prj_Completed_Detail>("Pm2Model.FK__PT_Prj_Co__PrjCo__6A525888", "PT_Prj_Completed_Detail", value);
                }
            }
        }
        ...
        public cn.justwin.DAL.PT_yhmc PT_yhmc
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_yhmc>("Pm2Model.FK__PT_Prj_Co__Input__5EE0A5DC", "PT_yhmc").Value;
            }
            set
            {
                this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_yhmc>("Pm2Model.FK__PT_Prj_Co__Input__5EE0A5DC", "PT_yhmc").Value = value;
            }
        }
        ...
        public EntityReference<cn.justwin.DAL.PT_yhmc> PT_yhmcReference
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_yhmc>("Pm2Model.FK__PT_Prj_Co__Input__5EE0A5DC", "PT_yhmc");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedReference<cn.justwin.DAL.PT_yhmc>("Pm2Model.FK__PT_Prj_Co__Input__5EE0A5DC", "PT_yhmc", value);
                }
            }
        }
    }
