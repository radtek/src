namespace cn.justwin.DAL
{
    ...
    public class plus_progress : EntityObject
    {
        ...
        public EntityCollection<cn.justwin.DAL.plus_progress_privilege> plus_progress_privilege
        {
            get
            {
                return this.RelationshipManager.GetRelatedCollection<cn.justwin.DAL.plus_progress_privilege>("Pm2Model.FK_privilege_ProgressId", "plus_progress_privilege");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedCollection<cn.justwin.DAL.plus_progress_privilege>("Pm2Model.FK_privilege_ProgressId", "plus_progress_privilege", value);
                }
            }
        }
        ...
        public EntityCollection<cn.justwin.DAL.plus_progress_version> plus_progress_version
        {
            get
            {
                return this.RelationshipManager.GetRelatedCollection<cn.justwin.DAL.plus_progress_version>("Pm2Model.FK_progress_version_ProgressId", "plus_progress_version");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedCollection<cn.justwin.DAL.plus_progress_version>("Pm2Model.FK_progress_version_ProgressId", "plus_progress_version", value);
                }
            }
        }
        ...
        public cn.justwin.DAL.PT_yhmc PT_yhmc
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_yhmc>("Pm2Model.FK_plus_progress_InputUser", "PT_yhmc").Value;
            }
            set
            {
                this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_yhmc>("Pm2Model.FK_plus_progress_InputUser", "PT_yhmc").Value = value;
            }
        }
        ...
        public EntityReference<cn.justwin.DAL.PT_yhmc> PT_yhmcReference
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_yhmc>("Pm2Model.FK_plus_progress_InputUser", "PT_yhmc");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedReference<cn.justwin.DAL.PT_yhmc>("Pm2Model.FK_plus_progress_InputUser", "PT_yhmc", value);
                }
            }
        }
    }
