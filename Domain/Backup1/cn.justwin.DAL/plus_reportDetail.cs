namespace cn.justwin.DAL
{
    ...
    public class plus_reportDetail : EntityObject
    {
        ...
        public cn.justwin.DAL.plus_report plus_report
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.plus_report>("Pm2Model.FK_plus_report", "plus_report").Value;
            }
            set
            {
                this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.plus_report>("Pm2Model.FK_plus_report", "plus_report").Value = value;
            }
        }
        ...
        public EntityReference<cn.justwin.DAL.plus_report> plus_reportReference
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.plus_report>("Pm2Model.FK_plus_report", "plus_report");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedReference<cn.justwin.DAL.plus_report>("Pm2Model.FK_plus_report", "plus_report", value);
                }
            }
        }
