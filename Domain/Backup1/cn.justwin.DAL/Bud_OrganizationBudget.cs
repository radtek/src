namespace cn.justwin.DAL
{
    ...
    public class Bud_OrganizationBudget : EntityObject
    {
        ...
        public EntityCollection<cn.justwin.DAL.Bud_OrganizationMonthBudget> Bud_OrganizationMonthBudget
        {
            get
            {
                return this.RelationshipManager.GetRelatedCollection<cn.justwin.DAL.Bud_OrganizationMonthBudget>("Pm2Model.FK__Bud_Organ__Organ__69D26A44", "Bud_OrganizationMonthBudget");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedCollection<cn.justwin.DAL.Bud_OrganizationMonthBudget>("Pm2Model.FK__Bud_Organ__Organ__69D26A44", "Bud_OrganizationMonthBudget", value);
                }
            }
        }
