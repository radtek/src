namespace com.jwsoft.pm.entpm.action
{
    ...
    public class SpoilageMain
    {
        ...
        public bool Delete(int SpoilageID)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("delete pm_Repe_SpoilageDetail ");
            builder.Append(" where SpoilageID=" + SpoilageID + " ");
            builder.Append("delete pm_Repe_SpoilageMain ");
            builder.Append(" where SpoilageID=" + SpoilageID + " ");
            return publicDbOpClass.NonQuerySqlString(builder.ToString());
        }

        public bool Exists(int SpoilageID)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select count(1) from pm_Repe_SpoilageMain");
            builder.Append(" where SpoilageID=" + SpoilageID + " ");
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select SpoilageID,DepositoryID,SpoilageNumber,SpoilageDate,TransactPerson,SpoilageMoney,Remark,TransactState,AuditState,UserCode,RecordDate ");
        ...
        public int GetMaxId()
        {
            return int.Parse(publicDbOpClass.QuaryMaxid("pm_Repe_SpoilageMain", "SpoilageID"));
        }
