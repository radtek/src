    ...
    <div id="divContent" class="divContent2">
        <table id="tableContent" class="tableContent2" cellpadding="5px" cellspacing="0">
            ...
            <tr>
                ...
                <td class="elemTd mustInput">
                    <asp:TextBox ID="txtPaymentMoney" Text="" CssClass="decimal_input {required:true,number:true, messages:{required:'支付金额 必须输入！！！',number:'支付金额 格式错误'}}" runat="server"></asp:TextBox>
                </td>
                <td class="word">
                    支付方式
                </td>
