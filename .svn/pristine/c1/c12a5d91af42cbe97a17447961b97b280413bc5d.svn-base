namespace cn.justwin.stockDAL
{
    ...
    public class OutReserve
    {
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select orid,orcode,procode,tcode,flowstate,isout,person,intime,annx,explain,PickingPeople,PickingSector,EquipmentId,writeName from Sm_OutReserve ");
            builder.Append(" where orcode=@orcode ");
        ...
        public OutReserveModel ReaderBind(IDataReader dataReader)
        {
            ...
            model.writeName = dataReader["writeName"].ToString();
            return model;
        }
