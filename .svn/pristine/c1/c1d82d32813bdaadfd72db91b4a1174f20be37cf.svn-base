<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jtgl_right.aspx.cs" Inherits="oa_System_jtgl_right" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<head runat="server"><title>集团制度列表</title><meta Content="Microsoft Visual Studio .NET 7.1" Name="GENERATOR" />
...
<meta Content="http://schemas.microsoft.com/intellisense/ie5" Name="vs_targetSchema" />
		...
		function showEditWin(op)
		{
		    ...
		    if(op == 'add')
		        url ="jtSystemInfoEdit.aspx?Op=add&cid="+cid+"&RecordID="+rid;
		     if(op == 'edit')
		        url = "jtSystemInfoEdit.aspx?Op=edit&RecordID="+rid;
		        if(op=='see')
		        url="jtSystemInfoEdit.aspx?Op=see&RecordID="+rid;
