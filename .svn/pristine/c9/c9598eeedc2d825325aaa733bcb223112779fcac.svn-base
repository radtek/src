<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DivSelectUser.aspx.cs" Inherits="Common_DivSelectUser" %>
...
<head id="Head1" runat="server"><title>选择人员</title>
    ...
    <script type="text/javascript">
        ...
        function setVal() {
            ...
            if (getRequestParam('Method') == '') {
                top.ui.closeWin();
                top.ui.callback(id, name);
            } else {
                divClose(parent);
                parent[method](id, name);
            }
        }
        //添加options
                        ...
                        <tr>
                            <td style="border: solid 0px red; width: 200px; vertical-align: top; text-align: right;">
                                ...
                                <div style="margin-right: 10px;">
                                    <asp:ListBox ID="lbSelect" Style="border: solid 1px #cdd4df;" DataTextField="v_xm" DataValueField="v_yhdm" Width="155px" Height="330px" runat="server"></asp:ListBox>
                                </div>
                            </td>
