namespace cn.justwin.DAL
{
    ...
    public class PT_d_bm : EntityObject
    {
        ...
        public EntityCollection<cn.justwin.DAL.Bud_OrgDiaryCost> Bud_OrgDiaryCost
        {
            get
            {
                return this.RelationshipManager.GetRelatedCollection<cn.justwin.DAL.Bud_OrgDiaryCost>("Pm2Model.FK__Bud_OrgDi__OrgId__31B8F9AA", "Bud_OrgDiaryCost");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedCollection<cn.justwin.DAL.Bud_OrgDiaryCost>("Pm2Model.FK__Bud_OrgDi__OrgId__31B8F9AA", "Bud_OrgDiaryCost", value);
                }
            }
        }
        ...
        public EntityCollection<cn.justwin.DAL.PT_yhmc> PT_yhmc
        {
            get
            {
                return this.RelationshipManager.GetRelatedCollection<cn.justwin.DAL.PT_yhmc>("Pm2Model.用户_部门", "PT_yhmc");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedCollection<cn.justwin.DAL.PT_yhmc>("Pm2Model.用户_部门", "PT_yhmc", value);
                }
            }
        }
