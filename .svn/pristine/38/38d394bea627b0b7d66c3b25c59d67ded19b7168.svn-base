...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function rowQuery(id) {
            ...
            var url = '/StockManage/Purchase/PurchaseViewWX.aspx?ic=' + id + "&Action=Query";;
            layer.open({
                type: 2,
                title: '查看物资采购报表',
                shadeClose: true,
                ...
                <td>
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td style="height: 100%;">
                                <div class="">
                                    <asp:GridView ID="gvwPurchase" CssClass="gvw"  Width="100%" AllowPaging="true" AutoGenerateColumns="false" EnableViewState="false" OnPageIndexChanging="gvwPurchase_PageIndexChanging" DataKeyNames="psid,pid" runat="server">
                                        <Columns>
                                            <asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px" HeaderStyle-HorizontalAlign="Right">
                                             ...
                                             <asp:TemplateField HeaderText="单据号">
                                                <ItemTemplate>
                                                    <span class="al"  onclick="rowQuery('<%# Eval("pid") %>')">
                                                        <%# Eval("pscode") %>
                                                    </span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:BoundField DataField="intime" HeaderText="采购日期" />
