<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AuditFrameWX.aspx.cs" Inherits="EPC_Workflow_AuditFrameWX" %>
...
<frameset rows="*,50" frameborder="1" bordercolor="#cccccc" framespacing="4px;">
