<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SmsOk.aspx.cs" Inherits="SMS_Fram_SmsOk" %>
                ...
                <tr>
                    <td style="background-color:#D1E0F8;height:25px;">
                        <table width="534px">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:TextBox ID="txtWriteText" Height="120px" BorderWidth="0px" Width="534px" TextMode="MultiLine" CssClass="textBox" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </td>
