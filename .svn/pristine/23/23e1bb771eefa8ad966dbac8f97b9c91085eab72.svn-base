                ...
                <td style="height: 406px; width: 100%;" valign="top">
                    <table cellpadding="0" cellspacing="2" style="width: 100%;" class="viewTable" border="0">
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="td-content" id="FileUpload1" runat="server"></td>
                        </tr>
                    </table>
                    <table style="vertical-align: top; width: 100%;">
                        <tr>
                            <td style="padding-top: 10px;">
                                <asp:GridView ID="gvWastage" Width="100%" AutoGenerateColumns="false" CssClass="viewTable"  OnRowDataBound="gvWastage_RowDataBound" runat="server">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="出库小计">
                                            <ItemTemplate>
                                                <div align="right">
