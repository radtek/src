<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResourceEditIframe.aspx.cs" Inherits="ResourceEditIframe" %>
...
<body style="overflow-y:hidden;">
    ...
    <table style="width: 100%; height: 88%;">
        ...
        <tr>
            ...
            <iframe id="InfoList" name="InfoList" src="ResourceEdit.aspx?id=&nodeId=&parentId=" frameBorder="0" width="100%"  style=" overflow-x:auto; overflow-y:hidden; "  height="100%"></iframe>  
                   ./ResourceEdit.aspx?parentId=fcd7fcca-abf2-4e2a-939f-26629ff66fd8&nodeId=6A1A7050-1F92-4291-B932-43E1DFCE6E91
                   --%>
               <%-- <iframe id="EditInfoList" name="EditInfoList" src="/BudgetManage/Resource/ResourceEdit.aspx?id=&nodeId=&parentId=" frameBorder="0" width="100%"  style=" overflow-x:auto; overflow-y:hidden; "  height="100%"></iframe> --%>
                 <iframe id="EditInfoList" name="EditInfoList" src="/BudgetManage/Resource/ResourceEdit.aspx?id=&nodeId=&parentId=" frameBorder="0" width="100%"  style=" overflow-x:auto; overflow-y:hidden; "  height="100%"></iframe> 
            </td>
        </tr>
    </table>
