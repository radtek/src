                                        ...
                                        <tr>
                                            <td style="height: 100%; vertical-align: top;">
                                                <div id="divBudget" class="pagediv">
                                                    <asp:GridView ID="gvBudget" AutoGenerateColumns="false" CssClass="gvdata" OnRowDataBound="gvPurchaseplan_RowDataBound" DataKeyNames="Id,ResourceId,ResourceName,BudTask" runat="server">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="工程量" HeaderStyle-Width="100px">
                                                                <ItemTemplate>
                                                                    <span style="cursor: default;">
                                                            ...
                                                            <asp:TemplateField HeaderText="综合单价" HeaderStyle-Width="90px">
                                                                <ItemTemplate>
                                                                    <span style="cursor: default;">
                                                            ...
                                                            <asp:TemplateField HeaderText="小计" HeaderStyle-Width="100px">
                                                                <ItemTemplate>
                                                                    <span style="cursor: default;">
                                                                        <%# Eval("Amount") %>
                                                                    </span>
