namespace cn.justwin.DAL
{
    ...
    public class Res_Template : EntityObject
    {
        ...
        public EntityCollection<cn.justwin.DAL.Res_TemplateItem> Res_TemplateItem
        {
            get
            {
                return this.RelationshipManager.GetRelatedCollection<cn.justwin.DAL.Res_TemplateItem>("Pm2Model.FK__Res_Templ__Templ__61674175", "Res_TemplateItem");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedCollection<cn.justwin.DAL.Res_TemplateItem>("Pm2Model.FK__Res_Templ__Templ__61674175", "Res_TemplateItem", value);
                }
            }
        }
