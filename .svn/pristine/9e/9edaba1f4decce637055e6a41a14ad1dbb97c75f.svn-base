...
using Wuqi.Webdiyer;
public partial class Equ_RequirePlan_RequirePlanList : NBasePage, IRequiresSessionState
{
	...
	protected void gvRequirePlan_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		if (e.Row.RowType == DataControlRowType.DataRow)
		{
			...
			e.Row.Attributes["guid"] = this.gvRequirePlan.DataKeys[e.Row.RowIndex].Value.ToString();
			e.Row.Attributes["prjGuid"] = this.gvRequirePlan.DataKeys[e.Row.RowIndex].Values["PrjId"].ToString();
		}
	}
	...
	private void BindYearMonth()
	{
		...
		string selectedValue = System.DateTime.Now.Month.ToString();
		this.ddlMonth.SelectedValue = selectedValue;
	}
}
