namespace cn.justwin.DAL
{
    ...
    public class Bud_OrgDiaryCost : EntityObject
    {
        ...
        public EntityCollection<cn.justwin.DAL.Bud_OrgDiaryDetails> Bud_OrgDiaryDetails
        {
            get
            {
                return this.RelationshipManager.GetRelatedCollection<cn.justwin.DAL.Bud_OrgDiaryDetails>("Pm2Model.FK__Bud_OrgDi__OrgDi__48C67C34", "Bud_OrgDiaryDetails");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedCollection<cn.justwin.DAL.Bud_OrgDiaryDetails>("Pm2Model.FK__Bud_OrgDi__OrgDi__48C67C34", "Bud_OrgDiaryDetails", value);
                }
            }
        }
        ...
        public cn.justwin.DAL.PT_d_bm PT_d_bm
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_d_bm>("Pm2Model.FK__Bud_OrgDi__OrgId__31B8F9AA", "PT_d_bm").Value;
            }
            set
            {
                this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_d_bm>("Pm2Model.FK__Bud_OrgDi__OrgId__31B8F9AA", "PT_d_bm").Value = value;
            }
        }
        ...
        public EntityReference<cn.justwin.DAL.PT_d_bm> PT_d_bmReference
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_d_bm>("Pm2Model.FK__Bud_OrgDi__OrgId__31B8F9AA", "PT_d_bm");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedReference<cn.justwin.DAL.PT_d_bm>("Pm2Model.FK__Bud_OrgDi__OrgId__31B8F9AA", "PT_d_bm", value);
                }
            }
        }
    }
