namespace cn.justwin.DAL
{
    ...
    public class PT_PrjInfo_Rank : EntityObject
    {
        ...
        public cn.justwin.DAL.PT_PrjInfo_ZTB_Detail PT_PrjInfo_ZTB_Detail
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_PrjInfo_ZTB_Detail>("Pm2Model.FK__PT_PrjInf__PrjGu__06E47595", "PT_PrjInfo_ZTB_Detail").Value;
            }
            set
            {
                this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_PrjInfo_ZTB_Detail>("Pm2Model.FK__PT_PrjInf__PrjGu__06E47595", "PT_PrjInfo_ZTB_Detail").Value = value;
            }
        }
        ...
        public EntityReference<cn.justwin.DAL.PT_PrjInfo_ZTB_Detail> PT_PrjInfo_ZTB_DetailReference
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.PT_PrjInfo_ZTB_Detail>("Pm2Model.FK__PT_PrjInf__PrjGu__06E47595", "PT_PrjInfo_ZTB_Detail");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedReference<cn.justwin.DAL.PT_PrjInfo_ZTB_Detail>("Pm2Model.FK__PT_PrjInf__PrjGu__06E47595", "PT_PrjInfo_ZTB_Detail", value);
                }
            }
        }
