...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function rowAdd() {
            ...
            var url = "/StockManage/SmOutReserve/AddReserveWX.aspx?prjId=" + $('#hfldPrjId').val();
        ...
        function rowEdit() {
            //parent.parent.desktop.AddReserve = window;
            var url = "/StockManage/SmOutReserve/AddReserveWX.aspx?id=" + $("#hfldPurchaseChecked").val() + '&prjId=' + $('#hfldPrjId').val();
            ...
            <tr class="ifshow">
                <td style="vertical-align: top;">
                    <table class="queryTable" cellpadding="3px" cellspacing="0px">
                        ...
                        <tr>
                            <td colspan="2"><%--//onclick="hidden1();"--%>
                                <%-- <input type="button" id="btnUnSelect1" value="查询" style="width: auto" onclick="hidden1();" />--%>
                    ...
                    <table class="tab" style="vertical-align: top;">
                        ...
                        <tr>
                            <td style="height: 100%; vertical-align: top;">
                                <div class="">
                                    <asp:GridView ID="gvOutReserve" AutoGenerateColumns="false" CssClass="gvdata" AllowPaging="true" PageSize="5" OnPageIndexChanging="gvPurchaseplan_PageIndexChanging" OnRowDataBound="gvOutReserve_RowDataBound" DataKeyNames="orcode,orid,procode" runat="server">
                                        <Columns>
