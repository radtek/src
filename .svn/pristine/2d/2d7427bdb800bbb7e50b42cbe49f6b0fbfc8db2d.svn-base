<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="ContractReportTask.aspx.cs" Inherits="BudgetManage_Construct_ContractReportTask" %>
...
<head runat="server"><title>中标预算施工报量</title>
    ...
    <script type="text/javascript">
        ...
        function addTask() {
            ...
            var url = '/StockManage/UserControl/MultiSelectConTask.aspx?prjId=' + prjId;
                ...
                <td colspan="2" align="left" style="vertical-align: bottom;">
                    <table cellspacing="0" cellpadding="0" border="1px" style="width: 100%; border-bottom: 0px;
                        ...
                        <tr>
                            ...
                            <td class="td-content">
                                <textarea id="txtNode" class="wysiwyg" cols="80" style="width: 100%;" runat="server"></textarea>
                            </td>
                        </tr>
                    </table>
                </td>
