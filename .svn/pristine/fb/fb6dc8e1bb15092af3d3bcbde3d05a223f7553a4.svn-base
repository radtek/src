<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShipElseReportView.aspx.cs" Inherits="Equ_ShipElseReport_ShipElseReportView" %>
<%@ Register TagPrefix="MyUserControl" TagName="stockmanage_common_showaudit_ascx" Src="~/StockManage/Common/ShowAudit.ascx" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server"><title>其他船产量上报查看</title>
...
<body id="print1">
    ...
    <table class="tab" style="vertical-align: top;">
        ...
        <tr id="trAudit" style="vertical-align: top;">
            <td>
                <MyUserControl:stockmanage_common_showaudit_ascx ID="ShowAudit1" BusiClass="001" BusiCode="159" runat="server" />
            </td>
        </tr>
        <tr>
        </tr>
