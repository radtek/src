<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DepYearMileStoneDetail.aspx.cs" Inherits="PrjManager_DepYearMileStoneDetail" %>
                ...
                <td style="vertical-align: top">
                    <table class="tab" style="vertical-align: top;">
                        ...
                        <tr>
                            <td>
                                <div>
                                    <asp:GridView ID="gvPrjMilestoneDetail" CssClass="gvdata" AutoGenerateColumns="false" OnRowDataBound="gvPrjMilestoneDetail_RowDataBound" DataKeyNames="NUM" runat="server">
<EmptyDataTemplate>
                                            <table id="emptyTable">
                                                <tr class="header">
...
</asp:TemplateField><asp:TemplateField HeaderText="上报时间" HeaderStyle-Width="20px" ItemStyle-HorizontalAlign="Left">
<ItemTemplate>
                                                    <%# GetRptDate(Eval("RptDate")) %>
                                                </ItemTemplate>
</asp:TemplateField><asp:TemplateField HeaderText="项目储备额" ItemStyle-CssClass="decimal_input" ItemStyle-HorizontalAlign="Right"><ItemTemplate>
                                                    <%# Eval("StoreAmount") %>
