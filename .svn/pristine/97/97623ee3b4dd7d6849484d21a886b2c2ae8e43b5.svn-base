...
using System.Web.UI.WebControls;
	public partial class upLoadFile : BasePage, IRequiresSessionState
	{
		...
		{
			if (base.Request["fid"] == null || base.Request["mid"] == null)
			{
				this.js.Text = "alert('参数错误！');window.returnValue = false; window.close();";
				return;
			}
			this._fid = base.Request["fid"].ToString();
		...
		private void btnAdd_Click(object sender, EventArgs e)
		{
			...
			annexInfo.AnnexType = 0;
			annexInfo.RecordCode = this._fid;
