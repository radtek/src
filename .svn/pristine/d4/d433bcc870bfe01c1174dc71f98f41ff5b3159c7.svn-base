...
<head id="Head1" runat="server"><title>预报销查看</title>
...
</asp:TemplateField><asp:BoundField HeaderText="名称" DataField="Name" /><asp:BoundField HeaderText="金额" DataField="Amount" /><asp:TemplateField HeaderText="成本科目"><ItemTemplate>
