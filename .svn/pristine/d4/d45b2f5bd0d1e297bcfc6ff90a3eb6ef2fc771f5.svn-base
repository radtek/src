<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RatifyView.aspx.cs" Inherits="ProgressManagement_Modify_RatifyView" %>
<%@ Register TagPrefix="MyUserControl" TagName="stockmanage_common_showaudit_ascx" Src="~/StockManage/Common/ShowAudit.ascx" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server"><title>进度计划调整已审核查看</title>
            ...
            <td style="vertical-align: top;">
                <table style="width: 100%; height: 50%; margin-top: 10px;" border="0">
                    <tr style="vertical-align: top;">
                        <td>
                            <asp:GridView ID="gvwPlans" CssClass="gvdata" AutoGenerateColumns="false" OnRowDataBound="gvwPlans_RowDataBound" DataKeyNames="ProgressVersionId" runat="server"><Columns><asp:TemplateField HeaderText="项目名称" HeaderStyle-Width="320px"><ItemTemplate>
                                           <%# Eval("PrjName") %>
                                        </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="计划名称" HeaderStyle-Width="320px"><ItemTemplate>
                                            <%# Eval("VersionName") %>
                                        </ItemTemplate></asp:TemplateField><asp:BoundField HeaderText="版本号" DataField="VersionCode" /><asp:TemplateField HeaderText="原计划名称" HeaderStyle-Width="320px"><ItemTemplate>
                                           <%# Eval("PVersionName") %>
                    ...
                    <tr id="trAudit" style="vertical-align: top;">
                        <td>
                            <MyUserControl:stockmanage_common_showaudit_ascx ID="ShowAuditFlow" BusiCode="108" BusiClass="001" runat="server" />
                        </td>
                    </tr>
                </table>
            </td>
