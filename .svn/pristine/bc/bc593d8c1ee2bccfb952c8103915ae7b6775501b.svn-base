            ...
            <tr style="height: 1px;">
                <td style="vertical-align: top;">
                    <table border="0px" cellpadding="0" cellspacing="0" class="viewTable">
                      ...
                      <input type="button" id="btnDy2" style="float: right;width: auto;display:none;" class="noprint" onclick="outEcel()" value="导出物资列表" />
                            ...
                            <td>
                                <asp:GridView ID="gvwPurchaseplanStock" Width="100%" AutoGenerateColumns="false" OnRowDataBound="gvwPurchaseplanStock_RowDataBound" XCssClass="viewTable" DataKeyNames="scode,Total,BugetSum" runat="server">
                                    ...
                                    <asp:TemplateField HeaderText="预算小计" ItemStyle-CssClass="decimal_input">
                                        ...
                                        <%--<asp:TemplateField HeaderText="预算数量" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input">
                                            <ItemTemplate>
                                                <%# Eval("ReadyNumber") %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
