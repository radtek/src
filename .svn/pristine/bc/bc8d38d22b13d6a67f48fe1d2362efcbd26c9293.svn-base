        ...
        <div class="VPage" style="padding: 5px; margin: 0px;">
            <div>
                <table cellspacing="0" cellpadding="5" width="100%" style="height: 100%" border="1">
                    <tr>
                        <td class="divHeader" style="width: 100%" colspan="2" height="20">流程启动选择3
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: right; width: 85px; white-space: nowrap;">选择流程模板
                        </td>
                        <td>
                            <asp:DropDownList ID="ddltTemplate" Width="170px" AutoPostBack="true" OnSelectedIndexChanged="ddltTemplate_SelectedIndexChanged" runat="server">
                                <asp:ListItem Value="-1" Text="---请选择流程模板---" />
                            </asp:DropDownList>
                    ...
                    <tr>
                        <td style="text-align: right; white-space: nowrap;">选择接收人
                        </td>
                        <td>
                            <asp:TextBox ID="txtReceiver" CssClass="td-input" Width="170px" runat="server"></asp:TextBox>&nbsp;
                    ...
                    <tr id="Message" visible="false" runat="server">
                        <td runat="server"></td>
                        <td runat="server">
                    ...
                    <tr>
                        <td colspan="2" height="20" style="text-align: right; padding-right: 20px">
                            <asp:Button ID="BtnAdd" Text="确  认" OnClick="BtnAdd_ClickWX" runat="server" />&nbsp;
                ...
                <table cellspacing="0" cellpadding="5" width="100%" style="height: 100%" border="1">
                    <tr>
                        <td class="divHeader" height="20" width="100%">工作流程图显示
                        </td>
                    </tr>
                    <tr>
                        <td valign="top">
