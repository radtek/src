namespace cn.justwin.DAL
{
    ...
    public class plus_report : EntityObject
    {
        ...
        public cn.justwin.DAL.plus_progress_version plus_progress_version
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.plus_progress_version>("Pm2Model.FK_plus_progress_version", "plus_progress_version").Value;
            }
            set
            {
                this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.plus_progress_version>("Pm2Model.FK_plus_progress_version", "plus_progress_version").Value = value;
            }
        }
        ...
        public EntityReference<cn.justwin.DAL.plus_progress_version> plus_progress_versionReference
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.plus_progress_version>("Pm2Model.FK_plus_progress_version", "plus_progress_version");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedReference<cn.justwin.DAL.plus_progress_version>("Pm2Model.FK_plus_progress_version", "plus_progress_version", value);
                }
            }
        }
        ...
        public EntityCollection<cn.justwin.DAL.plus_reportDetail> plus_reportDetail
        {
            get
            {
                return this.RelationshipManager.GetRelatedCollection<cn.justwin.DAL.plus_reportDetail>("Pm2Model.FK_plus_report", "plus_reportDetail");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedCollection<cn.justwin.DAL.plus_reportDetail>("Pm2Model.FK_plus_report", "plus_reportDetail", value);
                }
            }
        }
