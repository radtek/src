<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FileLibraryEdit.aspx.cs" Inherits="oa_FileManage_FileLibraryEdit" %>

<html>
<head runat="server"><title>管理档案信息</title><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
