<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FileTransactionFrame.aspx.cs" Inherits="oa_FileManage_FileTransactionFrame" %>
    ...
    <form id="formx" runat="server">
        <table width="100%"  height="100%" cellpadding="0" cellspacing="0" border="0" id="tablex" class="table-normal">
            <tr>
                ...
                <td width="75%">
                    <iframe id="frmLibrary" name="frmLibrary" src="FileTransaction.aspx?isFirst=true&lc=" frameborder="0" width="100%" height="100%" runat="server"></iframe>
                </td>
            </tr>
        </table>
    </form>
