...
public partial class oa_Vehicle_VehicleUserControl_VehicleType : NBasePage, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		if (!base.IsPostBack)
		{
			HttpRequest arg_0E_0 = base.Request;
	...
	private void DataBindProject()
	{
		...
		DataTable list = this._vehiclesType.GetList(" ParentGuid='" + guid + "' and type=0 ");
	...
	{
		string strWhere = string.Format(" ParentGuid = '{0}' and type=0 ", prjGuid);
	...
	{
		this.hfldVehicleTypeID.Value = this.trvwControlType.SelectedNode.Value;
		this.hfldVehicleTypeName.Value = this.trvwControlType.SelectedNode.Text;
	}
}
