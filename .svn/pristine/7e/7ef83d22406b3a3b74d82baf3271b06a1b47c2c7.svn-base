                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <td>
                                    <table class="queryTable" cellpadding="3px" cellspacing="0px">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtTrea" CssClass="easyui-validatebox" data-options="validType:'validQueryChars[50]'" Width="120px" runat="server"></asp:TextBox>
                            ...
                            <tr>
                                <td style="height: 100%;">
                                    <div class="">
                                        <%--CssClass="gvdata"--%>
                                        <asp:GridView ID="gvwTreasury" CssClass="gvw" Width="100%" AllowPaging="true"  AutoGenerateColumns="false" EnableViewState="false" OnPageIndexChanging="gvwPurchase_PageIndexChanging" DataKeyNames="tsid" runat="server">
                                            <Columns>
...
<ItemStyle HorizontalAlign="Right" CssClass="decimal_input"></ItemStyle>
                                                </asp:BoundField>
