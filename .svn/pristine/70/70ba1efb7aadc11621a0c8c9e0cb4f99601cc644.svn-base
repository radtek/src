namespace cn.justwin.DAL
{
    ...
    public class Bud_TemplateResource : EntityObject
    {
        ...
        public cn.justwin.DAL.Bud_TemplateItem Bud_TemplateItem
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Bud_TemplateItem>("Pm2Model.FK__Bud_Templ__Templ__6DB809C1", "Bud_TemplateItem").Value;
            }
            set
            {
                this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Bud_TemplateItem>("Pm2Model.FK__Bud_Templ__Templ__6DB809C1", "Bud_TemplateItem").Value = value;
            }
        }
        ...
        public EntityReference<cn.justwin.DAL.Bud_TemplateItem> Bud_TemplateItemReference
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Bud_TemplateItem>("Pm2Model.FK__Bud_Templ__Templ__6DB809C1", "Bud_TemplateItem");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedReference<cn.justwin.DAL.Bud_TemplateItem>("Pm2Model.FK__Bud_Templ__Templ__6DB809C1", "Bud_TemplateItem", value);
                }
            }
        }
        ...
        public cn.justwin.DAL.Res_Resource Res_Resource
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Res_Resource>("Pm2Model.FK__Bud_Templ__Resou__338B682C", "Res_Resource").Value;
            }
            set
            {
                this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Res_Resource>("Pm2Model.FK__Bud_Templ__Resou__338B682C", "Res_Resource").Value = value;
            }
        }
        ...
        public EntityReference<cn.justwin.DAL.Res_Resource> Res_ResourceReference
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Res_Resource>("Pm2Model.FK__Bud_Templ__Resou__338B682C", "Res_Resource");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedReference<cn.justwin.DAL.Res_Resource>("Pm2Model.FK__Bud_Templ__Resou__338B682C", "Res_Resource", value);
                }
            }
        }
