<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="HighlightsEdit.aspx.cs" Inherits="HighlightsEdit" %>
...
<head runat="server"><title>
        <%=HighlightsEdit._showtitle %></title><link href="../../../StockManage/skins/jquery.wysiwyg.css" rel="stylesheet" type="text/css" />
...
<body scroll="no">
    ...
    <div class="divContent2">
        ...
        <table class="tableContent2" cellspacing="0" width="100%" cellpadding="5px" border="0">
            <tr>
                <td class="word">
                    <%=HighlightsEdit._showAffairTitle %>：
                </td>
