<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RepairReportList.aspx.cs" Inherits="Equ_Repair_RepairReportList" %>
...
<head runat="server"><title>设备维修</title><link type="text/css" rel="stylesheet" href="../../Script/jquery.easyui/themes/default/easyui.css" />
...
<link type="text/css" rel="stylesheet" href="../../Script/jquery.tooltip/jquery.tooltip.css" />
	...
	<script type="text/javascript">
		$(document).ready(function () {
			var jwTable = new JustWinTable('gvRepair');
			replaceEmptyTable('emptyRepair', 'gvRepair');
			...
			$('#btnQuery').click(function () {
				var url = '/Equ/Repair/RepairReportView.aspx?ic=' + $('#hfldIdsChecked').val();
				viewopen(url, '查看设备维修');
			});
		...
		function openNewTab(action) {
			var title = '新增设备维修';
			parent.desktop.RepairReportEdit = window;
			var urlStr = '/Equ/Repair/RepairReportEdit.aspx?' + new Date().getTime() + '&action=' + action + '&equipmentType=' + $('#hfldEquipmentType').val();
			if (action == 'edit') {
		...
		//标签页查看
		function Query(id) {
			parent.desktop.RepairReportView = window;
			var url = '/Equ/Repair/RepairReportView.aspx?ic=' + id;
			toolbox_oncommand(url, "查看维修保养");
		}
	</script>
</head>
<body>
		...
		<table border="0" cellpadding="0" cellspacing="0" style="border: 0px; width: 100%;
				...
				<td style="vertical-align: top;">
					<table class="queryTable" cellpadding="3px" cellspacing="0px">
						<tr>
							...
							<td>
								<asp:TextBox ID="txtReportCode" Width="120px" runat="server"></asp:TextBox>
							</td>
							<td class="descTd">
								设备编号
							</td>
			...
			<tr>
				<td class="divFooter" style="text-align: left;">
					...
					<MyUserControl:epc_usercontrol1_wf_ascx ID="WF1" BusiClass="001" BusiCode="148" runat="server" />
				</td>
			</tr>
			<tr>
				<td style="width: 100%;">
					<table class="tab">
						<tr>
							<td style="height: 100%; vertical-align: top;">
								<div class="">
									<asp:GridView ID="gvRepair" CssClass="gvdata" AutoGenerateColumns="false" OnRowDataBound="gvRepair_RowDataBound" DataKeyNames="Id" runat="server">
<EmptyDataTemplate>
											<table id="emptyRepair" class="gvdata">
												<tr class="header">
...
<Columns><asp:TemplateField HeaderStyle-Width="20px"><HeaderTemplate>
												...
												</ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="上报日期" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px"><ItemTemplate>
												...
												</ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="维修开始时间" HeaderStyle-Width="50px"><ItemTemplate>
													
												</ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="维修结束时间" HeaderStyle-Width="50px"><ItemTemplate>
													
												</ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="维修项目"><ItemTemplate>
													<span class="tooltip" title=''>
