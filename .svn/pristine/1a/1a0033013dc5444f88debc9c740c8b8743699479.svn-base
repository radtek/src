...
public partial class Equ_RoadDrillReport_RoadDrillReportEdit : NBasePage, IRequiresSessionState
{
	...
	protected void btnSave_Click(object sender, System.EventArgs e)
	{
		try
		{
			...
			stringBuilder.Append("winclose('RoadDrillReportEdit', 'RoadDrillReportList.aspx', true)");
