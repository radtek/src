    ...
    <form id="Form1" method="post" runat="server">
        <font face="宋体">
            <table id="Table1" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                 <tr >
                    <td align="left" background="../../images1/bg_mail_title.jpg" height="37">
                        &nbsp;&nbsp; <a href="inbox.aspx" style="color: Maroon;">返回到收件箱 </a>
                        <asp:HyperLink ID="HyperLink1" Visible="false" ForeColor="Black" runat="server">返回
                        </asp:HyperLink>
                    </td>
                     <td align="right"  background="../../images1/bg_mail_title.jpg">
                                    <asp:Button ID="BtnDelN" Text="删除" CssClass="button-normal" Visible="false" OnClick="BtnDelN_Click" runat="server" />
                                    <asp:Button ID="BtnDelY" Text="彻底删除" Width="80px" CssClass="button-normal" Visible="false" OnClick="BtnDelY_Click" runat="server" />
                                    <asp:Button ID="BtnEdit" Text="编辑" Width="80px" CssClass="button-normal" Visible="false" OnClick="BtnEdit_Click" runat="server" />
                                    <asp:Button ID="BtnReply" Text="回复" CssClass="button-normal" Visible="false" OnClick="BtnReply_Click" runat="server" />
                                    <asp:Button ID="BtnTrans" Text="转发" CssClass="button-normal" Visible="false" OnClick="BtnTrans_Click" runat="server" />
                                </td>
                </tr>
				             <tr>
                ...
                <tr>
                    <td align="left" background="../../images1/bg_mail_title.jpg" height="37" colspan=2>
                        &nbsp;&nbsp; <a href="inbox.aspx" style="color: Maroon;">返回到收件箱 </a>
