...
using Wuqi.Webdiyer;
public partial class Equ_Equipment_SelectEquipmentType : NBasePage, IRequiresSessionState
{
	private EquEquipmentTypeService equTypeSer = new EquEquipmentTypeService();
	private string id = string.Empty;
	private string noChildIdList = string.Empty;
	...
	public void BindTrvw()
	{
		...
		this.hfldNoChildIdList.Value = this.noChildIdList;
	...
	protected void gvwEquipmentType_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		if (e.Row.RowType == DataControlRowType.DataRow)
		{
			...
			e.Row.Attributes["name"] = this.gvwEquipmentType.DataKeys[e.Row.RowIndex].Values["Name"].ToString();
		}
	}
}
