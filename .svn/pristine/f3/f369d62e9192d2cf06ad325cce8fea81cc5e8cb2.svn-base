...
public partial class oa_Vehicle_VehicleUserControl_Oauser : NBasePage, IRequiresSessionState
{
	...
	{
		if (!string.IsNullOrEmpty(base.Request.QueryString["TypeNameControl"]) && !string.IsNullOrEmpty(base.Request.QueryString["TypeIdControl"]))
		{
			this.hfldTypeId.Value = base.Request.QueryString["TypeIdControl"].ToString();
			string value = base.Request.QueryString["TypeNameControl"].ToString();
