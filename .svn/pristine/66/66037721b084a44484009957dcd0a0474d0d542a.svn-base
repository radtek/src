...
public partial class Equ_RoadMixerReport_RoadMixerReportEdit : NBasePage, IRequiresSessionState
{
	...
	protected void btnSave_Click(object sender, System.EventArgs e)
	{
		try
		{
			...
			stringBuilder.Append("winclose('RoadMixerReportEdit', 'RoadMixerReportList.aspx', true)");
