                    ...
                    <div class="pagediv">
                        <asp:GridView ID="gvwContract" CssClass="gvdata" AutoGenerateColumns="false" OnRowDataBound="gvwContract_RowDataBound" DataKeyNames="ID,PrjGuid,PaymentCode" runat="server">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="支付编号">
                                    <ItemTemplate>
                                ...
                                <asp:BoundField DataField="PaymentMoney" ItemStyle-HorizontalAlign="Right" HeaderText="支付金额" ItemStyle-CssClass="decimal_input" />
                                <asp:TemplateField HeaderText="实际支付金额" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input">
                                    <ItemTemplate>
                                ...
                                <asp:BoundField DataField="PaymentPerson" HeaderText="申请人" />
