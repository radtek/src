<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HighlightsView.aspx.cs" Inherits="EPC_QuaitySafety_HighlightsView" %>
...
<body scroll="no" style="height: 100%;">
    ...
    <div class="divContent2">
        <table width="100%">
            <tr>
                <td class="divHeader" style="width: 100%">
                      <%=EPC_QuaitySafety_HighlightsView._showAffairTitle.Substring(0, 4) %>
                </td>
            </tr>
        </table>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%"  class="viewTable">
            ...
            <tr>
                <td class="descTd" style="white-space: nowrap;">
                    <%=EPC_QuaitySafety_HighlightsView._showAffairTitle %>
                </td>
                <td class="elemTd">
