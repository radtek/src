<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoadInterlockReportList.aspx.cs" Inherits="Equ_RoadInterlockReport_RoadInterlockReportList" %>
...
<head runat="server"><title>预制联锁块上报</title><link type="text/css" rel="stylesheet" href="../../Script/jquery.easyui/themes/default/easyui.css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnQuery').click(function () {
                var url = '/Equ/RoadInterlockReport/RoadInterlockReportView.aspx?ic=' + $('#hfldIdsChecked').val();
                viewopen(url, '查看预制联锁块上报');
            });
        ...
        function openNewTab(action) {
            var title = '新增预制联锁块上报';
            parent.desktop.RoadInterlockReportEdit = window;
            var urlStr = '/Equ/RoadInterlockReport/RoadInterlockReportEdit.aspx?' + new Date().getTime() + '&action=' + action;
            if (action == 'edit') {
        ...
        //标签页查看
        function Query(id) {
            parent.desktop.RoadInterlockReportView = window;
            var url = '/Equ/RoadInterlockReport/RoadInterlockReportView.aspx?ic=' + id;
            toolbox_oncommand(url, "查看预制联锁块上报");
        }
        // 选择项目
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border: 0px; width: 100%;
            ...
            <tr>
                <td class="divFooter" style="text-align: left;">
                    ...
                    <MyUserControl:epc_usercontrol1_wf_ascx ID="WF1" BusiClass="001" BusiCode="164" runat="server" />
                </td>
            </tr>
            <tr>
                <td style="width: 100%;">
...
<Columns><asp:TemplateField HeaderStyle-Width="20px"><HeaderTemplate>
                                                ...
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="施工产量" ItemStyle-CssClass="decimal_input"><ItemTemplate>
