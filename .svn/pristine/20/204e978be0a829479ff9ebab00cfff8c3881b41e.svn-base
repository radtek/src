<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoadInterlockReport.aspx.cs" Inherits="Equ_Report_Land_RoadInterlockReport" %>
...
<head runat="server"><title>预制联锁块日机械产量报表</title><link type="text/css" rel="stylesheet" href="../../../Script/jquery.easyui/themes/default/easyui.css" />
...
<link type="text/css" rel="stylesheet" href="../../../Script/jquery.tooltip/jquery.tooltip.css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var jwTable = new JustWinTable('gvwInterlock');
            replaceEmptyTable('emptyInterlock', 'gvwInterlock');
            // 显示被截取的信息
            jw.tooltip();
        });
        ...
        function setWidthHeight() {
            //alert('aaa');
            $('#gvwInterlock').height($(this).height() - 70);
            $('#gvwInterlock').width($(this).width() - 4);
            //$('#divContent').height($(window).height());
            //$('#divContent').width($(window).width() - 4);
            ...
            <td>
                <table class="queryTable" cellpadding="3px" cellspacing="0px">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtInterlockCode" Width="100%" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="vertical-align: top;">
                <div class="pagediv" style="width: 100%">
                    <asp:GridView ID="gvwInterlock" AutoGenerateColumns="false" CssClass="gvdata" Width="100%" ShowFooter="true" OnRowDataBound="gvwInterlock_RowDataBound" runat="server">
<EmptyDataTemplate>
                            <table id="emptyInterlock">
                                <tr class="header">
                                    <th>
                                        序号
                                    </th>
...
<Columns><asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px"><ItemTemplate>
                                ...
                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="预制联锁块设备编号"><ItemTemplate>
                                    <span class="tooltip" title=''>
