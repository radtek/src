                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        <td style="text-align: left;" class="divFooter">
                                            ...
                                            <asp:Button ID="btnDown" Text="下载" Enabled="true" OnClick="btnDown_Click" runat="server" />
                                    ...
                                    <tr>
                                        <td style="height: 81.5%;">
                                            <div style="height: 100%; width: 1040px;">
                                                <asp:GridView ID="gvFile" CssClass="gvdata" Width="100%" AutoGenerateColumns="False" OnRowDataBound="gvFile_RowDataBound" DataKeyNames="Id,FileName" runat="server">
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="编辑人">
                                                            <ItemTemplate>
                                                                <center><%# Eval("DocEditUserName").ToString()%></center>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="流程状态" HeaderStyle-Width="80px">
                                                           ...
                                                           <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                <center><%# Eval("PrjName").ToString()%></center>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
