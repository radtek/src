     ...
     <table id="Table1" cellspacing="0" cellpadding="0" width="100%" align="center" border="0" class="table-normal">
            <tr>               
                ...
                <td class="td-toolsbar" style="height: 24px">             
                   <asp:Button ID="BtnConfirm" Width="85px" Text="销假审核" Enabled="false" OnClick="BtnConfirm_Click" runat="server" />&nbsp;
            ...
            <tr>
                <td>
                     <div id="dvDeptBox" class ="div-scroll" style="WIDTH:100%;HEIGHT:100%">
                         ...
                         <asp:SqlDataSource ID="SqlConfirm" SelectCommand="SELECT [RecordID], [AuditState], [UserCode], [RecordDate], [LeaveType], [LeaveDays], [BackDate], [Reason], [IsApply], [Days], [BeginDate], [IsConfirm], [ConfirmUser] FROM [HR_Leave_Application] WHERE ([AuditState] = @AuditState) order by RecordDate desc" ConnectionString='<%$ ConnectionStrings:Sql %>' runat="server"><SelectParameters><asp:Parameter DefaultValue="1" Name="AuditState" Type="String" /></SelectParameters></asp:SqlDataSource>
                     </div>
                     </td>
              </tr>
            </table>
