<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HighlightsList.aspx.cs" Inherits="HighlightsList" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head runat="server"><title>质量记录</title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OpType(obj, PrjCode) {
            ...
            switch (type) {
                case "EDIT":
                    url = "/EPC/QuaitySafety/QualityHighlights/HighlightsEdit.aspx?Flag=" + _type + "&Type=EDIT&i_id=" + Id + "&DatumClass=" + Class + "&PrjCode=" + PrjCode;
                    break;
                case "ADD":
                    url = "/EPC/QuaitySafety/QualityHighlights/HighlightsEdit.aspx?Flag=" + _type + "&Type=Add&DatumClass=" + Class + "&PrjCode=" + PrjCode;
                    break;
                case "SEE":
                    url = "/EPC/QuaitySafety/QualityHighlights/HighlightsView.aspx?Flag=" + _type + "&Type=SEE&i_id=" + Id + "&DatumClass=" + Class + "&PrjCode=" + PrjCode;
                    break;
            }
