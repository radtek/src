<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="TenderInfoQuery.aspx.cs" Inherits="PrjManager_TenderInfoQuery" %>
...
<head runat="server"><title>招投标项目查询</title><link rel="Stylesheet" type="text/css" href="/Script/jquery.easyui/themes/default/easyui.css" />
<link rel="Stylesheet" type="text/css" href="/Script/jquery.easyui/themes/icon.css" />
    ...
    <script type="text/javascript">
        ...
        function showMoreName() {
            var tab = document.getElementById('gvDataInfo');
            if (tab != null) {
                ...
                <td style="vertical-align: top">
                    <table class="tab" style="vertical-align: top;">
                        ...
                        <tr>
                            <td>
                                <div>
                                    <asp:GridView ID="gvDataInfo" CssClass="gvdata" AutoGenerateColumns="false" ShowFooter="true" OnRowDataBound="gvDataInfo_RowDataBound" DataKeyNames="PrjGuid,TypeCode" runat="server">
<EmptyDataTemplate>
                                            <table id="emptyTable">
                                                <tr class="header">
                                                    <th scope="col">
...
</asp:TemplateField><asp:BoundField HeaderText="项目类型" DataField="PrjKindName" Visible="false" /><asp:TemplateField HeaderText="立项申请日期"><ItemTemplate>
