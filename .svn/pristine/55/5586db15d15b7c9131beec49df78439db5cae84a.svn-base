...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function printURL1() {
            //var paymentId = document.getElementById('hfldPaymentId').value;
            var ContractId = document.getElementById('hldfContractId').value;
            var url = '/ContractManage/PayoutPayment/PayoutPaymentEditView.aspx?ContractId=' + ContractId;
            //viewopen(url);
            layer.open({
                type: 2,
                title: '查看该合同的付款记录',
        ...
        //查看该项目的支出合同
        function printURL2() {
            var ProjectName = document.getElementById('LblProjectName').innerHTML;
            var url = '/ContractManage/PayoutContract/PayoutContractViewByProject.aspx?action=ByProject&ProjectName=' + ProjectName;
            //viewopen(url);
            layer.open({
                type: 2,
                title: '查看该项目的支出合同',
        ...
        function printURL3() {
            ...
            //var ContractId = document.getElementById('hldfContractId').value;
            var ProjectName = document.getElementById('LblProjectName').innerHTML;
            var url = '/ContractManage/ContractReport/PayoutPaymentViewByProject.aspx?action=ByProject&ProjectName=' + ProjectName;
            //viewopen(url);
            layer.open({
                type: 2,
                title: '本项目的付款累计',
        ...
        function printURL4() {
            //var paymentId = document.getElementById('hfldPaymentId').value;
            //var ContractId = document.getElementById('hldfContractId').value;
            var ProjectId = document.getElementById('LblprjGuid').value;
            var ContractName = document.getElementById('lblContractName').innerHTML;
            //alert(ProjectId);
            var url = '/StockManage/Purchase/Purchase2.aspx?PrjGuid=' + ProjectId + '&action=ByProject&ContractName=' + ContractName;
            //viewopen(url);
            layer.open({
                type: 2,
                title: '查看该合同的采购单',
...
<body id="print">
    <form id="form1" runat="server">
        <table class="tab" style="vertical-align: top;">
            <tr>
                <td class="divHeader">支出合同付款
                    ...
                    <input type="button" id="btnDy" style="float: right; text-align: center" class="noprint" onclick="winPrint()"
                        value=" 打 印 " /></br></br>
                <input type="button" id="payPurchase" style="float: right; text-align: center; width: auto" class="noprint" onclick="printURL4()"
                    value=" 查看该合同的采购单" />&nbsp;&nbsp;
                <input type="button" id="payCounts" style="float: right; text-align: center; width: auto" class="noprint" onclick="printURL1()"
                    value=" 查看该合同的付款记录" />&nbsp;&nbsp;
                <input type="button" id="contracts" style="float: right; text-align: center; width: auto" class="noprint" onclick="printURL2()"
                    value=" 查看该项目的支出合同" />
                </td>
            </tr>
            <tr style="height: 1px;">
            ...
            <tr style="height: 1px;">
                <td style="vertical-align: top;">
                    <table border="0px" cellpadding="0" cellspacing="0" class="viewTable" style="width: 100%; margin: auto;">
                        <tr>
                            <td colspan="4" class="groupInfo">合同基本信息
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4" class="groupInfo">本项目付款累计
                            </td>
                        </tr>
                        <tr>
                            <td class="descTd">付款累计
                            </td>
                            <td class="elemTd" colspan="3">
                                <asp:Label ID="paySums" runat="server" Style="float: left; margin-right: 20px; margin-top: 2px;"></asp:Label><input type="button" id="btnDy3" style="float: left; text-align: center; width: auto" class="noprint" onclick="printURL3()"
                                    value=" 查看详情" />
                            </td>
                        </tr>
                        <tr id="tr1" class="groupInfo">
                            <td colspan="4" class="groupInfo">资金计划
                            </td>
                        </tr>
                        <tr id="tr2">
                            <td class="descTd">计划月份
                            </td>
                            <td class="elemTd">
                                <asp:Label ID="lblMonthDate" runat="server"></asp:Label>
                            </td>
                            <td class="descTd">计划金额
                            </td>
                            <td class="elemTd">
                        ...
                        <tr>
                            <td colspan="4" class="groupInfo">付款单信息
                            </td>
                        </tr>
                        <tr>
                            <td class="descTd">结算累计
                            </td>
                            <td class="elemTd">
            ...
            <tr id="trSate" style="height: 1px;" runat="server">
                    ...
                    <div>
                        ...
                        <table cellpadding="0" cellspacing="0" class="viewTable" style="width: 100%; margin: auto;">
                            <tr>
                                ...
                                <td align="center">合同金额
                                </td>
                                <td align="center">已结算金额
                                </td>
                                <td align="center">已支付金额
                                </td>
                                <td align="center">本次支付金额
                                </td>
                                <td align="center">已支付金额/合同金额
                                </td>
                            </tr>
                            <tr>
                                <td align="center">
            ...
            <tr id="trKzzb" style="vertical-align: top; height: 1px;">
                <td style="vertical-align: top; padding-top: 10px;">
                    <div style="font-size: 13px; font-weight: bold; text-align: center;">
                        <asp:Label ID="lblTitlTarget" Font-Size="13px" Font-Bold="true" runat="server"></asp:Label>
                    </div>
                    <asp:GridView ID="gvBudget" AutoGenerateColumns="false" CssClass="gvdata" Width="100%" DataKeyNames="TargetId" runat="server">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="合同签订金额">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="本次支付金额">
                                <ItemTemplate>
                                    <%# Convert.ToDecimal(Eval("CurrentPaymentAmount")).ToString("0.000") %>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="已支付金额<br/>/合同签订金额">
                                <ItemTemplate>
                ...
                <td>
                    <table width="100%">
                        <tr style="height: 25px; display: none;">
                            <td class="fontsize">领款人签名：
                            </td>
                            <td class="fontsize">日期：
                            </td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="3" style="border-bottom: dashed 1px black;"></td>
                        </tr>
                        <tr style="height: 50px">
                            <td class="fontsize">回执
                            </td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr style="height: 30px">
                            <td class="fontsize">分包商/供应商：
                            </td>
                            <td class="fontsize">金额：
                            </td>
                            <td class="fontsize">日期：
                            </td>
                        </tr>
        ...
        <asp:HiddenField ID="LblprjGuid" runat="server" />
