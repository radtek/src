<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContractLedger.aspx.cs" Inherits="ContractManage_ContractExecution_ContractLedger" %>
...
<head id="Head1" runat="server"><title>合同台账列表</title><link type="text/css" rel="stylesheet" href="../../Script/jquery.tooltip/jquery.tooltip.css" />
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			// trFrame为存放Frame的TR,必需将整个Table的高度设置为100%
