<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyEditTest.aspx.cs" Inherits="ContractManage_PayoutModify_ModifyEditTest" %>
...
<head id="Head1" runat="server"><title>合同变更</title><link href="../../Script/jquery.tooltip/jquery.tooltip.css" rel="stylesheet" type="text/css" />
    ...
    <div id="divContent2" class="divContent2">
        <table id="tableContent" class="tableContent2" cellpadding="5px" cellspacing="0">
            ...
            <tr>
                ...
                <td class="txt readonly">
                    <asp:TextBox ID="txtContractMoney" Height="15px" Width="100%" CssClass="easyui-numberbox" data-options="min:-99999999999,max:99999999999,precision:3,groupSeparator:','" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
                <td class="word">
                    最终金额
                </td>
                <td class="txt readonly">
                    <asp:TextBox ID="txtFinalMoney" Height="15px" CssClass="easyui-numberbox" data-options="min:-99999999999,max:99999999999,precision:3,groupSeparator:','" Width="100%" ReadOnly="true" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="word">
...
<ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hfldModifyTaskId" Value='<%# Convert.ToString(Eval("ModifyTaskId")) %>' runat="server" />
                                    </ItemTemplate>
                                        ...
                                        <asp:Label ID="lblUnit" flag="Unit" CssClass="{required:true, messages:{required:'清单内的单位必须输入'}}" Text='<%# Convert.ToString(Eval("Unit")) %>' runat="server"></asp:Label>
...
<ItemTemplate>
                                        <asp:Label ID="lblUnitPrice" flag="UnitPrice" CssClass="decimal_input" Style="text-align: right;" Text='<%# Convert.ToString(Eval("UnitPrice")) %>' runat="server"></asp:Label>
                                    </ItemTemplate>
</asp:TemplateField><asp:TemplateField HeaderText="小计" HeaderStyle-Width="70px">
<ItemTemplate>
                                        <asp:Label ID="lblTotal" flag="Total" CssClass="decimal_input" Style="text-align: right;" Text='<%# Convert.ToString(Eval("Total")) %>' runat="server"></asp:Label>
                                    </ItemTemplate>
</asp:TemplateField><asp:TemplateField HeaderText="变更类型" HeaderStyle-Width="70px">
<ItemTemplate>
                                     <asp:Label ID="lblModifyType" flag="ModifyType" Style="text-align: right;" Text='<%# Convert.ToString((Eval("ModifyType").ToString() == "0") ? "清单外" : "清单内") %>' runat="server"></asp:Label>                                
                                    </ItemTemplate>
</asp:TemplateField><asp:TemplateField HeaderText="备注"><ItemTemplate>
                                        <asp:Label ID="hlinkShowNote" Style="text-decoration: none; color: Black;" Text='<%# Convert.ToString(Eval("Note").ToString()) %>' runat="server"></asp:Label>
                                    </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="排序" Visible="false"><ItemTemplate>
                                        <asp:HiddenField ID="hfldOrderNumber" Value='<%# Convert.ToString(StringUtility.GetStr(Convert.ToString(Eval("OrderNumber")))) %>' runat="server" />                                      
