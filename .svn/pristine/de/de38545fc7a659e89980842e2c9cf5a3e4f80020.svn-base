namespace cn.justwin.Domain.Entities
{
    ...
    [Serializable]
    public class BudContractTask : ICloneable
    {
        public virtual object Clone()
        {
            return new BudContractTask { 
                ...
                IsValid = this.IsValid, Note = this.Note, ModifyId = this.ModifyId, ModifyType = this.ModifyType
             };
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return (this.TaskId == ((BudContractTask) obj).TaskId);
        }
