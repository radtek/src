namespace com.jwsoft.common.baseclass
{
    ...
    public class SubwayBasePage : Page
    {
        ...
        private void InitBasePage()
        {
            ...
            try
            {
                ...
                str4 = (((str4 + "var objs = document.getElementsByTagName('input');" + "for(i=0;i<objs.length;i++)") + "{" + "if(objs[i].id.substr(0,6)=='btnSee')") + "{" + "objs[i].style.display = 'none';") + "}}" + "</script>";
