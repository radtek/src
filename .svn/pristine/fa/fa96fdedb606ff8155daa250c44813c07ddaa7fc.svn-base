namespace cn.justwin.DAL
{
    ...
    public class Res_TemplateItem : EntityObject
    {
        ...
        public cn.justwin.DAL.Res_Template Res_Template
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Res_Template>("Pm2Model.FK__Res_Templ__Templ__61674175", "Res_Template").Value;
            }
            set
            {
                this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Res_Template>("Pm2Model.FK__Res_Templ__Templ__61674175", "Res_Template").Value = value;
            }
        }
        ...
        public EntityReference<cn.justwin.DAL.Res_Template> Res_TemplateReference
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Res_Template>("Pm2Model.FK__Res_Templ__Templ__61674175", "Res_Template");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedReference<cn.justwin.DAL.Res_Template>("Pm2Model.FK__Res_Templ__Templ__61674175", "Res_Template", value);
                }
            }
        }
    }
