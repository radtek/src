<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayoutPayment.aspx.cs" Inherits="ContractManage_ContractReport_PayoutPayment" %>
                ...
                <td>
                    <table class="queryTable" cellpadding="3px" cellspacing="0px">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtStartDate" onclick="WdatePicker()" Width="120px" runat="server"></asp:TextBox>
                            </td>
                            <td class="descTd">至
                            </td>
                            <td>
                                <asp:TextBox ID="txtEndDate" onclick="WdatePicker()" Width="120px" runat="server"></asp:TextBox>
                            </td>
                            <td class="descTd">乙方
                            </td>
                            <td>
                    ...
                    <div class="pagediv" style="width: 1800px">
                        <asp:GridView ID="gvwContract" CssClass="gvdata" AutoGenerateColumns="false" OnRowDataBound="gvwContract_RowDataBound" DataKeyNames="ContractID,IsMainContract" runat="server">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ContractCode" HeaderText="合同编号" HeaderStyle-Width="100px" />
                                <asp:TemplateField HeaderText="合同名称" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="乙方" HeaderStyle-Width="200px">
                                    <ItemTemplate>
                                        <%# StringUtility.GetStr(Eval("CorpName").ToString()) %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField HeaderText="签订人" DataField="SignPersonName" />
                                <asp:BoundField DataField="ModifiedMoney" ItemStyle-HorizontalAlign="Right" HeaderText="最终金额" ItemStyle-CssClass="decimal_input" ItemStyle-Width="80px" />
                                <asp:BoundField DataField="PaymentTotal" ItemStyle-HorizontalAlign="Right" HeaderText="付款累计" ItemStyle-CssClass="decimal_input" ItemStyle-Width="80px" />
                                <asp:TemplateField HeaderText="实际付款累计" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Right" HeaderStyle-CssClass="decimal_input">
                                    <ItemTemplate>
                                        <%# WebUtil.SapRealContractMoney(Eval("ContractCode").ToString(), "C") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="百分比" ItemStyle-CssClass="percent">
                                    <ItemTemplate>
                                        <%# string.Format("{0:P}", Eval("Rate")) %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="合同状态" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="30px">
                                    <ItemTemplate>
                                        <%# WebUtil.GetConState(Eval("conState").ToString()) %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="签订时间" HeaderStyle-Width="80px">
                                    <ItemTemplate>
                                        <%# string.Format("{0:d}", Eval("SignDate")) %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="合同类型" HeaderStyle-Width="200px">
                                    <ItemTemplate>
                                        <%# StringUtility.GetStr(Eval("TypeName").ToString()) %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="项目" HeaderStyle-Width="150px">
                                    <ItemTemplate>
                                        <%# StringUtility.GetStr(Eval("PrjName").ToString()) %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="项目类型" HeaderStyle-Width="200px">
                                    <ItemTemplate>
