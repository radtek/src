...
using Wuqi.Webdiyer;
public partial class ContractManage_IncometContract_ContractMeasure : NBasePage, IRequiresSessionState
{
	...
	protected void gvPurchaseplan_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		if (e.Row.RowIndex > -1)
		{
			try
			{
				...
				e.Row.Attributes["prjId"] = this.gvConract.DataKeys[e.Row.RowIndex]["Project"].ToString();
