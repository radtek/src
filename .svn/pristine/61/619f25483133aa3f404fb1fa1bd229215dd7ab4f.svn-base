...
public partial class Equ_ShipTeamReport_ShipTeamReportEdit : NBasePage, IRequiresSessionState
{
	...
	protected void btnSave_Click(object sender, System.EventArgs e)
	{
		try
		{
			...
			stringBuilder.Append("winclose('ShipTeamReportEdit', 'ShipTeamReportList.aspx', true)");
