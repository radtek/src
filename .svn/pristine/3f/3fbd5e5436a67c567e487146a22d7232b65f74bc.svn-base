<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShipElseReportEdit.aspx.cs" Inherits="Equ_ShipElseReport_ShipElseReportEdit" %>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server"><title>编辑其他船上报</title>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnCancel').click(function () {
                winclose('ShipElseReportEdit', 'ShipElseReportList.aspx', false);
            });
        });
        // 选择项目
