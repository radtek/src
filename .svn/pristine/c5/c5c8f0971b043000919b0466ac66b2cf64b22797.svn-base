namespace cn.justwin.Domain
{
    ...
    public class BudTask
    {
        ...
        public static void Add(cn.justwin.Domain.BudTask task, bool isLock)
        {
        ...
        public static void AddResource(cn.justwin.Domain.BudTask budTask)
        {
        ...
        public static List<cn.justwin.Domain.BudTask> ChangeId(List<string> lstIds)
        {
            ...
            {
                cn.justwin.Domain.BudTask byId = GetById(str);
                if (byId == null)
                {
            ...
            foreach (string str2 in lstIds)
            {
                ...
                foreach (cn.justwin.Domain.BudTask task4 in list)
                {
                    if (task4.Id == str2)
                    {
                        task4.Id = str3;
        ...
        public static cn.justwin.Domain.BudTask Create(string Id, string ParentTaskId, BudTaskType taskType, string Prj, string Code, string Name, string Unit, decimal quantity, DateTime? StartDate, DateTime? EndDate, bool IsValid, string Note, string InputUser, DateTime InputDate, decimal? unitPrice, decimal? total)
        {
            ...
            task = new cn.justwin.Domain.BudTask {
                Id = Id,
                InputDate = InputDate,
                InputUser = InputUser,
                IsValid = IsValid,
        ...
        private static void DeleteResource(cn.justwin.Domain.BudTask budTask, pm2Entities context)
        {
        ...
        public static IList<cn.justwin.Domain.BudTask> GetAll(string priceTypeId, string prjId, string isWBSRelevance, string taskType, string year, string month)
        {
            List<cn.justwin.Domain.BudTask> list = new List<cn.justwin.Domain.BudTask>();
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(CommandType.Text, builder.ToString(), commandParameters))
            {
                while (reader.Read())
                {
                    cn.justwin.Domain.BudTask item = new cn.justwin.Domain.BudTask {
                    ...
                    if (isWBSRelevance == "1")
                    {
                        if (CheckChilds(item.Id))
                        {
                            ...
                            foreach (cn.justwin.Domain.BudTask task2 in list)
                            {
        ...
        public static IList<cn.justwin.Domain.BudTask> GetAllByPrjId(string prjId)
        {
            List<cn.justwin.Domain.BudTask> list = new List<cn.justwin.Domain.BudTask>();
            using (pm2Entities entities = new pm2Entities())
            {
                return (from m in entities.Bud_Task
                    ...
                    select new cn.justwin.Domain.BudTask { Id = m.TaskId, Code = m.TaskCode, Name = m.TaskName, Unit = m.Unit, OrderNumber = m.OrderNumber }).ToList<cn.justwin.Domain.BudTask>();
            }
        }

        public static IList<cn.justwin.Domain.BudTask> GetAllTaskId(string prjId)
        {
            List<cn.justwin.Domain.BudTask> list = new List<cn.justwin.Domain.BudTask>();
            using (pm2Entities entities = new pm2Entities())
            {
                return (from m in entities.Bud_Task
                    orderby m.OrderNumber
                    where m.PrjId == prjId
                    select new cn.justwin.Domain.BudTask { Id = m.TaskId, ParentId = m.ParentId }).ToList<cn.justwin.Domain.BudTask>();
            }
        }
        ...
        public static cn.justwin.Domain.BudTask GetById(string id)
        {
            cn.justwin.Domain.BudTask task = new cn.justwin.Domain.BudTask();
            using (pm2Entities entities = new pm2Entities())
            {
                ParameterExpression expression2;
                return (from m in entities.Bud_Task
                    where m.TaskId == id
                    select m).Select<Bud_Task, cn.justwin.Domain.BudTask>(Expression.Lambda<System.Func<Bud_Task, cn.justwin.Domain.BudTask>>(Expression.MemberInit(Expression.New((ConstructorInfo) methodof(cn.justwin.Domain.BudTask..ctor), new Expression[0]), new MemberBinding[] { 
                    Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_Id), Expression.Property(expression2 = Expression.Parameter(typeof(Bud_Task), "m"), (MethodInfo) methodof(Bud_Task.get_TaskId))), Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_Code), Expression.Property(expression2, (MethodInfo) methodof(Bud_Task.get_TaskCode))), Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_Name), Expression.Property(expression2, (MethodInfo) methodof(Bud_Task.get_TaskName))), Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_StartDate), Expression.Property(expression2, (MethodInfo) methodof(Bud_Task.get_StartDate))), Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_EndDate), Expression.Property(expression2, (MethodInfo) methodof(Bud_Task.get_EndDate))), Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_Unit), Expression.Property(expression2, (MethodInfo) methodof(Bud_Task.get_Unit))), Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_UnitPrice), Expression.Property(expression2, (MethodInfo) methodof(Bud_Task.get_UnitPrice))), Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_Quantity), Expression.Property(expression2, (MethodInfo) methodof(Bud_Task.get_Quantity))), Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_Total), Expression.Property(expression2, (MethodInfo) methodof(Bud_Task.get_Total))), Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_Note), Expression.Property(expression2, (MethodInfo) methodof(Bud_Task.get_Note))), Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_OrderNumber), Expression.Property(expression2, (MethodInfo) methodof(Bud_Task.get_OrderNumber))), Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_ParentId), Expression.Property(expression2, (MethodInfo) methodof(Bud_Task.get_ParentId))), Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_Prj), Expression.Property(expression2, (MethodInfo) methodof(Bud_Task.get_PrjId))), Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_InputUser), Expression.Property(expression2, (MethodInfo) methodof(Bud_Task.get_InputUser))), Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_InputDate), Expression.Property(expression2, (MethodInfo) methodof(Bud_Task.get_InputDate))), Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_Version), Expression.Constant(1, typeof(int))), 
                    Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_IsValid), Expression.Coalesce(Expression.Property(expression2, (MethodInfo) methodof(Bud_Task.get_IsValid)), Expression.Constant(true, typeof(bool)))), Expression.Bind((MethodInfo) methodof(cn.justwin.Domain.BudTask.set_Mondified), Expression.Property(expression2, (MethodInfo) methodof(Bud_Task.get_Modified)))
                 }), new ParameterExpression[] { expression2 })).FirstOrDefault<cn.justwin.Domain.BudTask>();
            }
        }
        ...
        public IList<string> GetConsTaskIdList()
        {
            using (pm2Entities entities = new pm2Entities())
            {
                return (from ct in entities.Bud_ConsTask
                    join cr in entities.Bud_ConsReport on ct.Bud_ConsReport equals cr into cr
        ...
        public static IList<cn.justwin.Domain.BudTask> GetFirstLayerList(string projectId)
        {
            IList<cn.justwin.Domain.BudTask> list = new List<cn.justwin.Domain.BudTask>();
            using (pm2Entities entities = new pm2Entities())
            {
        ...
        public static IList<cn.justwin.Domain.BudTask> GetListByParentId(string parentId)
        {
            IList<cn.justwin.Domain.BudTask> list = new List<cn.justwin.Domain.BudTask>();
            using (pm2Entities entities = new pm2Entities())
            {
        ...
        public static void GetQuantityAndTotal(cn.justwin.Domain.BudTask budTask, pm2Entities context, IQueryable<Bud_Task> bud_TaskList, string priceTypeId, string prjId)
        {
        ...
        public static string GetResourcesInfoByTaskId(string taskId)
        {
            ...
            using (pm2Entities entities = new pm2Entities())
            {
                ...
                List<BudModifyTaskRes> first = (from mt in service2
                    join m in service on mt.ModifyId equals m.ModifyId into m
                    join mtr in service3 on mt.ModifyTaskId equals mtr.ModifyTaskId into mtr
                ...
                using (var enumerator = list.GetEnumerator())
                {
                    ...
                    while (enumerator.MoveNext())
                    {
                        ...
                        str = str + taskResource.specification.Replace(',', 0xff0c) + ",";
                        str = str + taskResource.brand.Replace(',', 0xff0c) + ",";
                        if (!string.IsNullOrEmpty(taskResource.modelNumber))
                        {
                            str = str + taskResource.modelNumber.Replace(',', 0xff0c) + ",";
                        }
                        else
                        {
                            str = str + ",";
                        }
                        str = str + taskResource.TechnicalParameter.Replace(',', 0xff0c) + ",";
                        decimal? nullable = 0M;
                        decimal num = 0M;
                        ...
                        if (predicate == null)
                        {
                            predicate = list => list.ResourceId == taskResource.ResourceId;
                        }
                ...
                using (List<string>.Enumerator enumerator3 = service3.GetModifyTasResIds(first).GetEnumerator())
                {
                    ...
                    while (enumerator3.MoveNext())
                    {
                        ...
                        str = str + byId.Specification.Replace(',', 0xff0c) + ",";
                        str = str + byId.Brand.Replace(',', 0xff0c) + ",";
                        if (!string.IsNullOrEmpty(byId.ModelNumber))
                        {
                            str = str + byId.ModelNumber.Replace(',', 0xff0c) + ",";
                        }
                        else
                        {
                            str = str + ",";
                        }
                        str = str + byId.TechnicalParameter.Replace(',', 0xff0c) + ",";
                        decimal num2 = 0M;
                        decimal num3 = 0M;
        ...
        public static DataTable GetSumTotal(IList<cn.justwin.Domain.BudTask> lstTask, IList<ResType> restypelst, string priceType)
        {
            ...
            foreach (cn.justwin.Domain.BudTask task in lstTask)
            {
        ...
        {
            int num = orderNumberList.Max<string>((System.Func<string, int>) (n => n.Length));
            System.Func<string, bool> predicate = null;
            System.Func<string, bool> func2 = null;
            System.Func<string, bool> func3 = null;
        ...
        public static void Update(cn.justwin.Domain.BudTask budtask, bool isLock)
        {
            using (pm2Entities entities = new pm2Entities())
            {
                Bud_Task task = (from m in entities.Bud_Task
        ...
        private static bool UpdateVersion(string prjId, string isWBSRelevance)
        {
            ...
            using (pm2Entities entities = new pm2Entities())
            {
                ...
                List<cn.justwin.Domain.BudTask> list2 = ChangeId(lstIds);
                int num = 0;
                foreach (string str in lstIds)
                {
                    cn.justwin.Domain.BudTask task = list2[num];
