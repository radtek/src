<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyLogEdit.aspx.cs" Inherits="OA3_WorkLog_MyLogEdit" %>
...
<body>
    <script type="text/javascript">
        ...
        function opentask_id() {
            var action = getRequestParam('action');
            if (action != 'view') {
                jw.selectTask({ idinput: 'hdntask_id', nameinput: 'task_id' });
            }
        }
        ...
        function AddOption() {
            ...
            if ($("#CheckTime").val() == "1") {
                $.ajax({
                    type: "POST",
                    url: "../../WeChat/Ajax/AjaxGetMsg.aspx/CheckClashTime",
                    data: "{KeyId: '" + $("#KeyId").val() + "',userCode: '" + $("#userCode").val() + "',LogType: '" + $("#LogType").val() + "',sDate: '" + $("#start_time").val() + "',eDate: '" + $("#end_time").val() + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: false,
                    success: function Success(data) {
                        if (data.d != "") {
                            ...
                            // document.getElementById('ShowClash').style.display = "inline";
                            $("#Label1").html("填写的日志日期和已有日志的时间有重叠,如下:</br>" + data.d);
                            document.getElementById('IfClash').value = "1";
                        }
                        else {
                            document.getElementById('dl').style.display = "none";
                            //document.getElementById('ShowClash').style.display = "none";
                            document.getElementById('IfClash').value = "0";
                        }
                    }
                });
            }
    ...
    <form id="form1" runat="server">
                    ...
                    <table class="tableContent2" cellpadding="5px" cellspacing="0" style="vertical-align: middle; width: 80%">
                        <tr>
                            ...
                            <td style="width: 90%; text-align: left" colspan="2">
                                <asp:DropDownList ID="type_id" runat="server" Width="100%" onchange="typeChange()"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="word" align="right">日志标题
                            </td>
                            <td class="txt mustInput" colspan="2">
                                <asp:TextBox ID="title" Height="100%" Width="100%" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr id="dl" style="display: none;">
                            <td style="width: 10%; text-align: right">时间重叠的日志
                            </td>
                            <td style="text-align: left;" colspan="2">
                                <asp:TextBox ID="IfClash" runat="server" Style="display: none"></asp:TextBox>
                                <asp:Label ID="Label1" runat="server" Text="" ForeColor="#2464b9"></asp:Label>
                            </td>
                           
                        </tr>
                        <tr>
                            <td style="width: 10%; text-align: right">日志内容
                            </td>
                            <td style="text-align: left;" colspan="2">
                                <asp:TextBox ID="content" Style="overflow: auto; line-height: 1.25" Height="120px" Width="100%" Wrap="true" Rows="20" TextMode="MultiLine" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="text-align: right;" class="auto-style1">相关音频
                            </td>
                            <td style="text-align: left" class="auto-style2" colspan="2">
                                <MyUserControl:usercontrol_fileupload_fileupload_ascx3 ID="FileUpload3" Name="音频" FileType="*.mp3" Class="JournalVoices" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right;" class="auto-style1">相关视频
                            </td>
                            <td style="text-align: left" class="auto-style2" colspan="2">
                                <MyUserControl:usercontrol_fileupload_fileupload_ascx4 ID="FileUpload4" Name="视频" FileType="*.mp4" Class="JournalVideos" runat="server" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left" class="auto-style2">
                                 <input type="text" id="task_id" readonly="readonly" class="select_input" imgclick="opentask_id" runat="server" />
					<asp:HiddenField ID="hdntask_id" runat="server" />
                            </td>
                             <td style="text-align: left;">
                                <input type="button" value="清空" onclick="clearT();" /></td>
                        </tr>
                    </table>
                </div>
            </div>
        ...
        <asp:TextBox ID="LogType" runat="server" Style="display: none;"></asp:TextBox>
        <asp:TextBox ID="userCode" runat="server" Style="display: none;"></asp:TextBox>
        <asp:TextBox ID="CheckTime" runat="server" Style="display: none;"></asp:TextBox>
