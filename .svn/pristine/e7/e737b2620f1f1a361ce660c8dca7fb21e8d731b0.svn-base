...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //setButton(jwtable, 'btnSC', 'btnWrite', 'btnView', 'KeyId');

            //setButton(jwtable, '', 'btnWrite', '', 'KeyId');
        ...
        function rowQuery(id) {
            var url = 'ViewReserve.aspx?ic=' + id + '&BusiCode=076&BusiClass=001';
                        ...
                        <tr style="height: 25px;">
                            ...
                            <td>
                                <asp:DropDownList ID="status" runat="server" CssClass="ddcss" Width="120px">
                                    <asp:ListItem Value="wqr" Selected>未确认</asp:ListItem>
                    ...
                    <table class="tab" style="vertical-align: top;">
                        <tr>
                            <td class="divFooter" style="text-align: left">
                                 <asp:Button ID="btnOkAfter" Text="补充签名" Width="80px"  OnClick="btnOkAfter_Click" runat="server" style="display:none;"/>
                                    ...
                                    <asp:GridView ID="gvOutReserve" AutoGenerateColumns="false" CssClass="gvdata" AllowPaging="true" PageSize="5" OnPageIndexChanging="gvPurchaseplan_PageIndexChanging" OnRowDataBound="gvOutReserve_RowDataBound" DataKeyNames="orcode" runat="server">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="手写签名">
                                                <ItemTemplate>
                                                   <%-- <span class="al tooltip" onclick="writeName('<%# Eval("orid") %>','签名出库')" style="display: <%# (Eval("isout").ToString() == "False") ? "none": "none" %>">签名并出库
                                                    </span>&nbsp;--%>
                                                    <span class="al tooltip" onclick="writeName('<%# Eval("orid") %>','签名')" style="display: <%# (Eval("writeName").ToString() == "") ? "none": "none" %>">签名
                                                    </span>&nbsp;
