    ...
    <script type="text/javascript">
        ...
        function openkc() {
            if (document.getElementById("hfldTrea").value == "" || document.getElementById("hdnProjectCode").value == "") {
                ...
                var url = '/StockManage/Refunding/BackStockListWX.aspx?tcode=' + $("#hfldTrea").val() + '&prcode=' + $("#hdnProjectCode").val();
                layer.open({
                    type: 2,
                    title: '从出库单中选择',
                    shadeClose: true,
    ...
    <form id="form1" runat="server">
        ...
        <div class="divContent2">
            ...
            <div>
                            ...
                            <div class="pagediv">
                ...
                </table> <asp:GridView ID="gvNeedNote"  CssClass="gvw"  Width="100%" AutoGenerateColumns="false" OnRowDataBound="gvNeedNote_RowDataBound" DataKeyNames="scode" runat="server">
                                    <EmptyDataTemplate>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="剩余量" ItemStyle-CssClass="decimal_input">
                                            <ItemTemplate>
                                                <%# Convert.ToString(base.GetNumber(Eval("number").ToString(), Eval("orcode").ToString(), Eval("sprice").ToString(), Eval("scode").ToString(), Eval("CorpId").ToString())) %>
                                        ...
                                        <asp:TemplateField HeaderText="退库数量" >
                                            <ItemTemplate>
                                                <asp:TextBox Style="text-align: right;width:30px" CssClass="decimal_input" ID="txtTNum" ToolTip='<%# Convert.ToString(Eval("orsid")) %>' Text='<%# Convert.ToString(Eval("tnumber")) %>' No='<%# Convert.ToString(Container.DataItemIndex) %>' runat="server"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="退库小计" HeaderStyle-Width="80px">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="分部分项" HeaderStyle-Width="60px" Visible="false">
                                            <ItemTemplate>
        ...
        <div class="divFooter2">
            <table class="tableFooter2">
                <tr>
                    <td>
                        <asp:Button ID="btnSave" Text="保存" OnClientClick="return valForm()" Style="cursor: pointer;" OnClick="btnSaveWX_Click" runat="server" />
