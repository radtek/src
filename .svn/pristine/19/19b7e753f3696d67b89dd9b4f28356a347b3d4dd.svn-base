<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoadTeamReportList.aspx.cs" Inherits="Equ_RoadTeamReport_RoadTeamReportList" %>
...
<head runat="server"><title>陆上设备台班上报</title><link type="text/css" rel="stylesheet" href="../../Script/jquery.easyui/themes/default/easyui.css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnQuery').click(function () {
                var url = '/Equ/RoadTeamReport/RoadTeamReportView.aspx?ic=' + $('#hfldIdsChecked').val();
                viewopen(url, '查看陆上设备台班上报');
            });
            setWfButtonState2(jwTable, 'WF1');
        });
        //打开新的标签页 新增/编辑
        function openNewTab(action) {
            var title = '新增陆上设备台班上报';
            parent.desktop.RoadTeamReportEdit = window;
            var urlStr = '/Equ/RoadTeamReport/RoadTeamReportEdit.aspx?' + new Date().getTime() + '&action=' + action;
            if (action == 'edit') {
        ...
        //标签页查看
        function Query(id) {
            parent.desktop.RoadTeamReportView = window;
            var url = '/Equ/RoadTeamReport/RoadTeamReportView.aspx?ic=' + id;
            toolbox_oncommand(url, "查看陆上设备台班上报");
        }
        // 选择项目
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border: 0px; width: 100%;
            ...
            <tr>
                <td class="divFooter" style="text-align: left;">
                    ...
                    <MyUserControl:epc_usercontrol1_wf_ascx ID="WF1" BusiClass="001" BusiCode="153" runat="server" />
                </td>
            </tr>
            <tr>
                <td style="width: 100%;">
...
<Columns><asp:TemplateField HeaderStyle-Width="20px"><HeaderTemplate>
                                                ...
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="施工内容"><ItemTemplate>
                                                    <span class="tooltip" title=''>
