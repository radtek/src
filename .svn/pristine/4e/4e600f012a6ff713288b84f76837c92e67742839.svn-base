<%@ Page Language="C#" AutoEventWireup="true" CodeFile="scheduleplanmain.aspx.cs" Inherits="SchedulePlanMain" %>
						...
						<table class="table-none" id="Table1" height="100%" cellSpacing="0" cellPadding="0" width="100%"
							...
							<tr class="td-toolstbar">
								...
								<td align="right">
									...
									<asp:Button ID="BtnSchedulePlan" Enabled="false" Text="进度计划编制" Width="100px" runat="server" />&nbsp;<asp:Button ID="BtnView" Enabled="false" Text="查  看" runat="server" />&nbsp;<asp:Button ID="BtnGTT" Enabled="false" Text="甘特图" runat="server" />&nbsp;
