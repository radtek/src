<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AllocUser.aspx.cs" Inherits="Common_AllocUser" EnableEventValidation="false" %>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server"><title>分配人员</title>
	...
	<script type="text/javascript">
		...
		function succeed() {
			var pName = jw.getRequestParam('parentName');
			if (!pName) {
				var winNo = jw.getRequestParam('winNo');
				top.ui.show('保存成功！');
				top.ui.closeWin({ winNo: winNo });
				...
				top.ui.winSuccess({ parentName: pName });
			}
		...
		<table class="tableContent" cellpadding="5px" cellspacing="0">
			...
			<tr>
				<td style="border: solid 0px red; text-align: right;">
					...
					<asp:Button ID="btnSave" Text="保存" OnClientClick="saveUser();" OnClick="btnSave_Click" runat="server" />
