...
<head runat="server"><title>入库单管理</title>
	...
	<script type="text/javascript">
		...
		function addStorage() {
			...
			var url = '/StockManage/Storage/StorageEdit.aspx?Action=Add';
			...
			<td style="height: 96%; width: 100%;">
				<table class="tab" style="vertical-align: top;">
					...
					<tr style="height: 100%; vertical-align: top">
						<td>
							<div class="">
								<asp:GridView ID="gvwStorage" CssClass="gvdata" Width="100%" AutoGenerateColumns="false" AllowPaging="true" OnRowDataBound="gvwStorage_RowDataBound" OnPageIndexChanging="gvwStorage_PageIndexChanging" DataKeyNames="scode,sid,project" runat="server"><Columns><asp:TemplateField HeaderStyle-Width="20px"><HeaderTemplate>
												...
												<span class="al" onclick="viewopen('StorageView.aspx?&ic=<%# Eval("sid") %>',820,500)">
													<%# Eval("scode") %>
												</span>
