...
using Wuqi.Webdiyer;
public partial class ContractManage_ContractReport_IncometInvoiceReport : NBasePage, IRequiresSessionState
{
	...
	public DataTable GetTable(string strWhere)
	{
		...
		this.contractCount = this.incometContractBll.GetReportTb(this.txtConType.Text.Trim(), this.txtPrjName.Value, this.txtContractCode.Text.Trim(), this.txtContractName.Text.Trim(), this.txtStartTime.Text.Trim(), this.txtEndTime.Text.Trim(), this.txtParty.Value.Trim(), "Invoice", strWhere, this.dropPrjKindClass.SelectedValue);
		this.ViewState["contract"] = this.contractCount;
		this.AspNetPager1.RecordCount = this.contractCount.Rows.Count;
		return this.incometContractBll.GetReportTb(this.txtConType.Text.Trim(), this.txtPrjName.Value, this.txtContractCode.Text.Trim(), this.txtContractName.Text.Trim(), this.txtStartTime.Text.Trim(), this.txtEndTime.Text.Trim(), this.txtParty.Value.Trim(), "Invoice", strWhere, this.dropPrjKindClass.SelectedValue, this.AspNetPager1.CurrentPageIndex, this.AspNetPager1.PageSize);
	}
	...
	protected void btnexecl_Click(object sender, System.EventArgs e)
	{
		...
		new Common2().ExportToExecelAll(this.GetTitleByTable(dt), "收入合同发票报表.xls", base.Request.Browser.Browser);
	}
	public DataTable GetTitleByTable(DataTable dt)
	{
		...
		dt.Columns["prjTypeName"].ColumnName = "项目类型";
		...
		dt.Columns.Remove(dt.Columns["Notes"]);
		dt.Columns.Remove(dt.Columns["CodeName"]);
		...
		dt.Columns["发票累计"].SetOrdinal(10);
		dt.Columns["已开发票收款比率"].SetOrdinal(11);
