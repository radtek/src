<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Track.aspx.cs" Inherits="ProgressManagement_Track_Track" %>
...
<head id="Head1" runat="server"><title>计划审核</title>
	...
	<script type="text/javascript">
		...
		function lookInfo(version, verId, verName) {
			var url = '/ProgressManagement/Track/TrackDetail.aspx?' + '&verId=' + verId + '&type=2';
			toolbox_oncommand(url, verName + '-总体进度');
		}
	</script>
</head>
<body>
							...
							<td style="width: 100%; vertical-align: top; height: 100%; border-left: solid 2px #CADEED;">
								<table class="tab">
									<tr class="divFooter" style="text-align: left;">
										<td>
											<input type="button" id="btnEdit" value="总体进度" disabled="disabled" style="width: auto;" />
										</td>
									</tr>
									<tr>
