<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompanyDrawStatSubTab.aspx.cs" Inherits="oa_WorkManage_SubCompanyManage_CompanyDrawStatSubTab" %>
...
<meta http-equiv="Pragma" content="no-cache" />
	...
	function OpenWin(op)
	{
		...
		var url= "CompanyDrawStatSubTabEdit.aspx?op=" + op + "&id="+RecordID+"&ic="+ICRecordID;
	...
	function OpenWinImport()
	{
	    var RecordID = document.getElementById('HdnRecordID').value;
	    var ICRecordID = document.getElementById('HdnICRecordID').value;
		var url= "CompanyDrawFrame.aspx?op=d&id="+RecordID+"&ic="+ICRecordID;
        ...
        <table width="100%"  height="100%" cellpadding="0" cellspacing="0" border="0" id="tablex" class="table-normal">
            ...
            <tr>
                <td height="20px" class="td-toolsbar">
                    ...
                    <asp:Button ID="btnImport" Text="从部门导入" Enabled="false" Width="80px" OnClick="btnImport_Click" runat="server" />
