namespace cn.justwin.DAL
{
    ...
    public class Bud_ContractTask : EntityObject
    {
        ...
        public EntityCollection<cn.justwin.DAL.Bud_ContractResource> Bud_ContractResource
        {
            get
            {
                return this.RelationshipManager.GetRelatedCollection<cn.justwin.DAL.Bud_ContractResource>("Pm2Model.FK__Bud_Contr__TaskI__6F6B4809", "Bud_ContractResource");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedCollection<cn.justwin.DAL.Bud_ContractResource>("Pm2Model.FK__Bud_Contr__TaskI__6F6B4809", "Bud_ContractResource", value);
                }
            }
        }
