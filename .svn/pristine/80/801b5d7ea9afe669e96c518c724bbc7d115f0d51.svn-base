<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShipFlatReport.aspx.cs" Inherits="Equ_Report_Ship_ShipFlatReport" %>
...
<head id="Head1" runat="server"><title>平板船产量表</title><link rel="Stylesheet" type="text/css" href="../../../Script/jquery.easyui/themes/default/easyui.css" />
...
</asp:TemplateField><asp:TemplateField HeaderText="平板船编号">
<ItemTemplate>
                                        <span class="tooltip" title=''>
                                            
                                        </span>
                                    </ItemTemplate>
</asp:TemplateField><asp:TemplateField HeaderText="平板船名称">
<ItemTemplate>
                                        <span class="tooltip" title=''>
...
</asp:TemplateField><asp:TemplateField HeaderText="作业船数" ItemStyle-HorizontalAlign="Right"><ItemTemplate>
                                        
                                    </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="每船产量" ItemStyle-CssClass="decimal_input" ItemStyle-HorizontalAlign="Right"><ItemTemplate>
                                        
                                    </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="扣船方数" ItemStyle-CssClass="decimal_input" ItemStyle-HorizontalAlign="Right"><ItemTemplate>
                                        
                                    </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="完成方数" ItemStyle-CssClass="decimal_input" ItemStyle-HorizontalAlign="Right"><ItemTemplate>
