<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ratify.aspx.cs" Inherits="ProgressManagement_Modify_Ratify" %>
...
<head id="Head1" runat="server"><title>计划审核</title>
	...
	<script type="text/javascript">
		...
		function setButton(jwTable, hdChkId) {
			...
			jwTable.registClickTrListener(function () {
				...
				if ($('#' + this.id).get(0).cells[3].innerText == "已审核") {
...
<Columns><asp:BoundField HeaderText="序号" DataField="No" HeaderStyle-Width="20px" /><asp:ButtonField HeaderText="计划名称" DataTextField="VersionName" /><asp:BoundField HeaderText="版本号" DataField="VersionCode" /><asp:BoundField HeaderText="审核状态" /><asp:BoundField HeaderText="主计划" DataField="Main" HeaderStyle-Width="30px" /><asp:BoundField HeaderText="发起人" DataField="OrganigerName" /><asp:BoundField HeaderText="参与审核人" /><asp:BoundField DataField="ArriveTime" HeaderText="提交时间" HeaderStyle-Width="100px" /><asp:TemplateField HeaderText="流程状态"><ItemTemplate>
