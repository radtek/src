        ...
        public static cn.justwin.BLL.ProgressManagement.Version GetById(string verId)
        {
            using (pm2Entities entities = new pm2Entities())
            {
                ...
                return (from m in entities.plus_progress_version
                    where m.ProgressVersionId == verId
                    select m).Select<plus_progress_version, cn.justwin.BLL.ProgressManagement.Version>(Expression.Lambda<System.Func<plus_progress_version, cn.justwin.BLL.ProgressManagement.Version>>(Expression.MemberInit(Expression.New((ConstructorInfo) methodof(cn.justwin.BLL.ProgressManagement.Version..ctor), new Expression[0]), new MemberBinding[] { Expression.Bind((MethodInfo) methodof(cn.justwin.BLL.ProgressManagement.Version.set_ProgressVersionId), Expression.Property(expression2 = Expression.Parameter(typeof(plus_progress_version), "m"), (MethodInfo) methodof(plus_progress_version.get_ProgressVersionId))), Expression.Bind((MethodInfo) methodof(cn.justwin.BLL.ProgressManagement.Version.set_ProgressId), Expression.Property(Expression.Property(expression2, (MethodInfo) methodof(plus_progress_version.get_plus_progress)), (MethodInfo) methodof(plus_progress.get_ProgressId))), Expression.Bind((MethodInfo) methodof(cn.justwin.BLL.ProgressManagement.Version.set_VersionName), Expression.Property(expression2, (MethodInfo) methodof(plus_progress_version.get_VersionName))), Expression.Bind((MethodInfo) methodof(cn.justwin.BLL.ProgressManagement.Version.set_VersionCode), Expression.Property(expression2, (MethodInfo) methodof(plus_progress_version.get_VersionCode))), Expression.Bind((MethodInfo) methodof(cn.justwin.BLL.ProgressManagement.Version.set_InputUser), Expression.Property(Expression.Property(expression2, (MethodInfo) methodof(plus_progress_version.get_PT_yhmc)), (MethodInfo) methodof(PT_yhmc.get_v_yhdm))), Expression.Bind((MethodInfo) methodof(cn.justwin.BLL.ProgressManagement.Version.set_Note), Expression.Property(expression2, (MethodInfo) methodof(plus_progress_version.get_Note))), Expression.Bind((MethodInfo) methodof(cn.justwin.BLL.ProgressManagement.Version.set_FlowState), Expression.Coalesce(Expression.Property(expression2, (MethodInfo) methodof(plus_progress_version.get_FlowState)), Expression.Constant(-1, typeof(int)))), Expression.Bind((MethodInfo) methodof(cn.justwin.BLL.ProgressManagement.Version.set_InputDate), Expression.Convert(Expression.Property(expression2, (MethodInfo) methodof(plus_progress_version.get_InputDate)), typeof(DateTime))), Expression.Bind((MethodInfo) methodof(cn.justwin.BLL.ProgressManagement.Version.set_IsLatest), Expression.Convert(Expression.Property(expression2, (MethodInfo) methodof(plus_progress_version.get_IsLatest)), typeof(bool))), Expression.Bind((MethodInfo) methodof(cn.justwin.BLL.ProgressManagement.Version.set_ParentVersionId), Expression.Property(expression2, (MethodInfo) methodof(plus_progress_version.get_ParentVersionId))) }), new ParameterExpression[] { expression2 })).FirstOrDefault<cn.justwin.BLL.ProgressManagement.Version>();
            }
        }
