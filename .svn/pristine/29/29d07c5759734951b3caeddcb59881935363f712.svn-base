...
<script language="javascript" type="text/javascript">
    $(document).ready(function () {
        ...
        $('#btnStartWF').click(function () {
            ...
            var src = "/EPC/WorkFlow/StartWFWX.aspx?"
				+ "fid=" + $("#WF1_FID").val()
    ...
    function OpenViewWF() {
        ...
        var url = "/epc/Workflow/AuditViewWFWX.aspx?ic=" + rid + '&bc=' + BusinessCode + '&bcl=' + BusinessClass;
    ...
    function OpenPrintWF() {
        ...
        var url = "/epc/Workflow/AuditViewPrintWX.aspx?ic=" + rid + '&bc=' + BusinessCode + '&bcl=' + BusinessClass + "&content=" + encodeURI(content);
...
<input type="button" value="撤回" id="CancelBt" disabled="disabled" style="display:none;"/>&nbsp;
...
<%--<div id="divinfo" title="撤回审核" class="easyui-window" data-options="modal:true,closed:true,iconCls:'icon-save'"
    ...
    <img alt="" src="/images/help.jpg" />&nbsp; <span style="font-size: 15px; font-weight: bold">确定撤回此审核吗？</span>
    <br />
    <br />
    ...
    <div style="text-align: right;">
        ...
        <input type="button" id="btnWfRecallCancel" value="取消" onclick="page_close();" />
    </div>
</div>--%>
<!-- 超级删除密码 -->
