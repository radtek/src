                ...
                <td style="height: 100%; vertical-align: top;">
                    <div id="divScroll" runat="server">
                        <table width="100%" height="100%" cellpadding="0" cellspacing="0" id="tb">
                                ...
                                <td>
                                    <fieldset style="width: 85%; margin: auto; text-align: center">
                                        ...
                                        <table id="tableContent" class="tableContent2" style="width: 95%" cellpadding="5px"
                                            ...
                                            <tr>
                                                <td class="word" style="white-space: nowrap;">招标代理单位
                                                </td>
                                                <td class="txt">
                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                    <span class="spanSelect" style="width: 100%;">
                                                        <asp:TextBox ID="txtDutyPerson" Style="width: 80%; height: 15px; border: none; line-height: 16px; margin: 1px 2px"
                                                            runat="server"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                    <span class="spanSelect" style="width: 99%">
                                                        <asp:TextBox ID="txtPrjReadOne" ReadOnly="true" Style="width: 80%; height: 15px; border: none; line-height: 16px; margin: 1px 0px 1px 2px;"
                                                            runat="server"></asp:TextBox>
                                                ...
                                                <td class="txt">
                                                    <span class="spanSelect" style="width: 99%">
                                                        <asp:TextBox ID="inUser" ReadOnly="true" Style="width: 89%; height: 15px; border: none; line-height: 16px; margin: 1px 0px 1px 2px;"
                                                            runat="server"></asp:TextBox>
                                                        <img alt="提醒接收人" onclick="selectUser('inUserId', 'inUser');" src="../../images/icon.bmp" style="float: right;" id="img6" runat="server" />
                            ...
                            <tr id="tr_qd" style="display: none" runat="server">
                                <td runat="server">
                                    <fieldset style="width: 85%; margin: auto;">
                            ...
                            <tr id="tr_qdn" style="display: none" runat="server">
                                <td runat="server">
                                    <fieldset style="width: 85%; margin: auto;">
                            ...
                            <tr id="tr_ys" style="display: none" runat="server">
                                <td runat="server">
                                    <fieldset style="width: 85%; margin: auto;">
                                        ...
                                        <div id="div14" title="项目资格预审基本资料" style="display: none" runat="server">
                                            <table id="table6" class="tableContent2" style="width: 96%" cellpadding="5px" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="" style="padding-right: 3px;">
                                                        <span class="spanSelect" style="width: 99%;">
                                                            <asp:TextBox ID="txtAgent" Style="width: 80%; height: 15px; border: none; line-height: 16px; margin: 1px 2px"
                                                                runat="server"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="">
                                                        <span class="spanSelect" style="width: 99%">
                                                            <asp:TextBox ID="txtQualificationReadOne" ReadOnly="true" Style="width: 80%; height: 15px; border: none; line-height: 16px; margin: 1px 0px 1px 2px;"
                                                                runat="server"></asp:TextBox>
                            ...
                            <tr id="tr_yspass" style="display: none" runat="server">
                                <td runat="server">
                                    <fieldset style="width: 85%; margin: auto;">
                            ...
                            <tr id="tr_ysfail" style="display: none" runat="server">
                                <td runat="server">
                                    <fieldset style="width: 85%; margin: auto;">
                            ...
                            <tr id="tr_tb" style="display: none" runat="server">
                                <td runat="server">
                                    <fieldset style="width: 85%; margin: auto;">
                                        ...
                                        <div id="div4" title="项目投标基本资料" style="display: none" runat="server">
                                            <table id="table2" class="tableContent2" style="width: 96%" cellpadding="5px" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="">
                                                        <span class="spanSelect" style="width: 99%">
                                                            <asp:TextBox ID="txtTenderReadOne" ReadOnly="true" Style="width: 80%; height: 15px; border: none; line-height: 16px; margin: 1px 0px 1px 2px;"
                                                                runat="server"></asp:TextBox>
                            ...
                            <tr id="tr_zb" style="display: none" runat="server">
                                <td runat="server">
                                    <fieldset style="width: 85%; margin: auto;">
                            ...
                            <tr id="tr_lb" style="display: none" runat="server">
                                <td runat="server">
                                    <fieldset style="width: 85%; margin: auto;">
                                        ...
                                        <div id="div6" title="项目落标基本资料" style="display: none" runat="server">
                                            <table id="table4" class="tableContent2" style="width: 94%" cellpadding="5px" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="word">落标保证金是否退还
                                                    </td>
                                                    <td class="txt">
                                                        <asp:RadioButtonList ID="RblOutBidIsReturn" RepeatDirection="Horizontal" RepeatLayout="Flow" runat="server">
