...
public partial class OA3_WorkLog_StatisticByUserCost : NBasePage, IRequiresSessionState
{
    ...
    protected void DataBinds()
    {
        ...
        System.DateTime? endTime = DateTimeHelper.GetDateTime(this.txtStartTime.Text);
...
//    NBasePage, IRequiresSessionState
//{
//    protected void Page_Load(object sender, EventArgs e)
//    {
//        if (!base.IsPostBack)
...
//        if (!string.IsNullOrEmpty(startTime.ToString()))
//        {
//            strDate += " AND start_time >='" + startTime + "'";
//        }
//        if (!string.IsNullOrEmpty(endTime.ToString()))
//        {
//            strDate += " AND start_time <'" + Convert.ToDateTime(endTime).AddMonths(1) + "'";
//        }
//        string strSql = string.Format(@"SELECT creater,v_xm, COUNT(Id) counts, SUM(datediff(minute, start_time, end_time)) sums
