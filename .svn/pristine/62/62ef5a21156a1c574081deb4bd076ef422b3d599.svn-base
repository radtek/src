<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IndividualDrawApplyAssTabEdit.aspx.cs" Inherits="oa_WorkManage_StorageManage_IndividualDrawApplyAssTabEdit" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server"><title>个人领用申请登记</title>
	...
	<!--
	    ...
	    function PickMatterial()
	    {
	        ...
	        Matterial[3] = "";
	        Matterial[4] = "";
		    var url= "MattrialSelect.aspx?type=0";
