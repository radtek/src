...
using Wuqi.Webdiyer;
public partial class ProgressManagement_Track_Milestone : NBasePage, IRequiresSessionState
{
	...
	protected void BindPlans()
	{
		...
		DataTable latestPlans = Progress.GetLatestPlans(this.prjId, userCode, this.AspNetPager1.CurrentPageIndex, this.AspNetPager1.PageSize);
		this.gvwPlans.DataSource = latestPlans;
