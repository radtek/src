...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function addTask() {
            ...
            var url = "/StockManage/UserControl/SelMultiProgressTaskWX.aspx?proVerId=" + proVerId + "&ButtonId=btnBindResTask&winNo=1";
            layer.open({
                type: 2,
                title: '选择进度任务',
                shadeClose: true,
            ...
            <table style="border: 0px; width: 100%; height: 100%;">
                <tr style="width: 100%; height: 5%;">
                    <td style="text-align: left; width: 100%;">
                        <span style="float:left">上报日期
                        <asp:TextBox ID="txtDate" Width="80px" onclick="WdatePicker()" runat="server"></asp:TextBox></span>
                    </td>
                </tr>
                <tr><td style="text-align: left; width: 100%;">
                        <span style="float:left">记录人</span><span class="spanSelect" style="width: 122px;float:left">
                            <asp:TextBox ReadOnly="true" ID="txtInputUser" Style="width: 97px; border: none; line-height: 16px; margin: 1px 0px 1px 2px;"
                ...
                <tr>
                    <td  style="width: 100%; vertical-align: top; height: 61%;">
                        <div id="divBudget" class="pagediv" style="border-bottom: solid 0px red;">
                            <asp:GridView ID="gvwTask" AutoGenerateColumns="false" OnRowDataBound="gvwTask_RowDataBound" DataKeyNames="Id,TaskUID" runat="server">
                                <EmptyDataTemplate>
                                    <table id="gvwEmpty">
                                        <tr class="header">
                                            <th rowspan="2" scope="col" style="width: 25px;">序号
                                            </th>
                                            <th rowspan="2" scope="col">任务名称
                                            </th>
                                            <th rowspan="2" scope="col">工期
                                            </th>
                                            <th scope="col">计划开始日期
                                            </th>
                                            <th scope="col">计划结束日期
                                            ...
                                            <th rowspan="2" scope="col" colspan="2">完成百分比
                                            </th>
                                            <th rowspan="2" scope="col">说明
                                            </th>
                                        </tr>
                                    </table>
                                </EmptyDataTemplate>
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="计划开始日期" HeaderStyle-Width="80px" DataField="START_" DataFormatString="{0:yyy-M-d}" />
                                    <asp:BoundField HeaderText="计划结束日期" HeaderStyle-Width="80px" DataField="FINISH_" DataFormatString="{0:yyy-M-d}" />
                                    <asp:TemplateField HeaderText="实际开始日期" HeaderStyle-Width="80px">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="实际结束日期" HeaderStyle-Width="80px">
                                        <ItemTemplate>
