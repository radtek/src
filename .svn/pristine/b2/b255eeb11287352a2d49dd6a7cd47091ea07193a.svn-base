...
public partial class StockManage_sendGoods_SelectByNoteList : NBasePage, IRequiresSessionState
{
	...
	public void BindNeedGv()
	{
		...
		if (base.Request.QueryString["prjGuid"] != null)
		{
			...
			if (dateTime != Convert.ToDateTime("2079/6/6"))
			{
	...
	private void cbClick()
	{
		...
		base.RegisterScript("window.parent.document.getElementById('hdwscodeP').value='" + this.hdwscode.Value + "'");
		this.BindNeedNote();
	}
