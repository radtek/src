...
using System.Web.UI.WebControls;
	public partial class HighlightsList : NBasePage, IRequiresSessionState
	{
		...
		private void P_Type()
		{
			...
			if (base.Request.QueryString["TypeId"] == "8")
			{
				this.strTitle = "质 量 ";
				if (base.Request.QueryString["type"] == "Edit")
				{
					this.Literal1.Text = "质量亮点维护";
				}
				else
				{
					this.Literal1.Text = "质量亮点查看";
				}
				HighlightsList.listTitleStr = "质量亮点名称";
				this.hdnClass.Value = "8";
			}
			else
			{
				if (base.Request.QueryString["TypeId"] == "9")
				{
					if (base.Request.QueryString["type"] == "Edit")
					{
						this.Literal1.Text = "质量活动维护";
					}
					else
					{
						this.Literal1.Text = "质量活动查看";
					}
					this.strTitle = "质 量 ";
					HighlightsList.listTitleStr = "质量活动名称";
		...
		protected override void OnInit(EventArgs e)
		{
			if (base.Request.QueryString["Type"] == "Edit")
			{
				HighlightsList._typeVal = "Edit";
			}
			else
			{
				HighlightsList._typeVal = "List";
				this.TR_Btn.Visible = false;
			}
			DataTable list = this.flc.GetList("1<0");
			this.ViewState[HighlightsList.temTable] = list.Clone();
		...
		protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
		{
			if (e.Row.RowType == DataControlRowType.DataRow)
			{
				...
				string text2 = HighlightsList.StripHTML(e.Row.Cells[5].Text);
				if (text2.Length > 22)
				{
			...
			else
			{
				...
				{
					e.Row.Cells[3].Text = HighlightsList.listTitleStr;
					if (base.Request.QueryString["type"] == "List")
					{
						e.Row.Cells[0].Text = "";
						e.Row.Cells[0].Visible = false;
		...
		public static string StripHTML(string strHtml)
		{
			...
			text.Replace(">", "");
			text.Replace("\r\n", "");
			return HighlightsList.DelHTML(text);
		}
		...
		private void GET_SelectRow()
		{
			...
			foreach (GridViewRow gridViewRow in this.GridView1.Rows)
			{
				...
				if (checkBox != null && checkBox.Checked)
				{
					...
					if (this.ViewState[HighlightsList.resourceTable] != null)
					{
						DataTable dataTable2 = this.ViewState[HighlightsList.resourceTable] as DataTable;
			...
			this.ViewState[HighlightsList.temTable] = dataTable;
		}
	}
