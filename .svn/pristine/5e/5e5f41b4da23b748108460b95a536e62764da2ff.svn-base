<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SetPrjMember.aspx.cs" Inherits="PrjManager_SetPrjMember" EnableEventValidation="false" %>

<!DOCTYPE html >
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server"><title>设置项目小组成员</title>
    <style type="text/css">
        #departmentDiv
        {
            width: 40%;
...
<body>
    ...
    <div class="divContent" style="height: 450px; width: 600px; margin-left: 20px; overflow: hidden;">
        <table class="tableContent" cellpadding="5px" cellspacing="0">
            ...
            <tr>
                <td style="text-align: right;">
                    ...
                    <input type="button" value="取消" id="btnCanel" />
                </td>
            </tr>
