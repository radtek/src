<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShipFlatReportList.aspx.cs" Inherits="Equ_ShipFlatReport_ShipFlatReportList" %>
...
<head runat="server"><title>平板船产量上报</title><link type="text/css" rel="stylesheet" href="../../Script/jquery.easyui/themes/default/easyui.css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnQuery').click(function () {
                var url = '/Equ/ShipFlatReport/ShipFlatReportView.aspx?ic=' + $('#hfldIdsChecked').val();
                viewopen(url, '查看平板船产量上报');
            });
        ...
        function openNewTab(action) {
            var title = '新增平板船产量上报';
            parent.desktop.ShipFlatReportEdit = window;
            var urlStr = '/Equ/ShipFlatReport/ShipFlatReportEdit.aspx?' + new Date().getTime() + '&action=' + action;
            if (action == 'edit') {
        ...
        //标签页查看
        function Query(id) {
            parent.desktop.ShipFlatReportView = window;
            var url = '/Equ/ShipFlatReport/ShipFlatReportView.aspx?ic=' + id;
            toolbox_oncommand(url, "查看平板船产量上报");
        }
        // 选择项目
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border: 0px; width: 100%;
            ...
            <tr>
                <td class="divFooter" style="text-align: left;">
                    ...
                    <MyUserControl:epc_usercontrol1_wf_ascx ID="WF1" BusiClass="001" BusiCode="158" runat="server" />
                </td>
            </tr>
            <tr>
                <td style="width: 100%;">
...
<Columns><asp:TemplateField HeaderStyle-Width="20px"><HeaderTemplate>
                                                ...
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="当次完成方数" ItemStyle-CssClass="decimal_input"><ItemTemplate>
