<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplicationConfirm.aspx.cs" Inherits="HR_Leave_ApplicationConfirm" %>
<%@ Import Namespace="com.jwsoft.web.WebControls"%>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server"><title>销假申请</title>
...
<body class="body_clear" scroll="no">
    ...
    <table class="table-normal" cellspacing="0" cellpadding="0" width="100%" border="1">
      <tr>
             <td class="td-title" colspan="2">销假申请</td>
      </tr>
       <tr>
	        <td class="td-label" >
		        销假天数:</td>
