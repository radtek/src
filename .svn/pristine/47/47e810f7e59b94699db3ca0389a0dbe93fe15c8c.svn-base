<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jtSystemInfoEdit.aspx.cs" Inherits="oa_System_jtSystemInfoEdit" %>


<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server"><title>�����ƶȹ���</title><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
