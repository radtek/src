    ...
    <table style="width: 100%; height: 99%;" cellpadding="0" cellspacing="0" id="tablex">
        <tr>
            <td width="20%" valign="top" style="">
                <div class="gridBox">
                     <asp:Button ID="LinkButton1" Text="导出组织机构信息" style="width: auto;" runat="server" OnClick="LinkButton1_Click" />
             <%--       <asp:Button ID="btnTBtoWX" Text="同步组织机构到微信" style="width: auto;" runat="server" OnClick="btnTBtoWX_Click" />--%>
                      <asp:Button ID="btnFromWX" Text="同步部门(微信->本地)" style="width: auto;" runat="server" OnClick="btnFromWX_Click" />
                    <hr />
