...
public partial class Common_DivSelectUser : NBasePage, IRequiresSessionState
{
	...
	protected void trvwDepartment_SelectedNodeChanged(object sender, System.EventArgs e)
	{
		...
		this.lbSelect.DataSource = this.ptYhmcBll.GetAllModelByWhere(string.Format("where state=1 and i_bmdm = {0}", selectedValue));
