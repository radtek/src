<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShipElseReportList.aspx.cs" Inherits="Equ_ShipElseReport_ShipElseReportList" %>
...
<head runat="server"><title>其他船产量上报</title><link type="text/css" rel="stylesheet" href="../../Script/jquery.easyui/themes/default/easyui.css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnQuery').click(function () {
                var url = '/Equ/ShipElseReport/ShipElseReportView.aspx?ic=' + $('#hfldIdsChecked').val();
                viewopen(url, '查看其他船产量上报');
            });
        ...
        function openNewTab(action) {
            var title = '新增其他船产量上报';
            parent.desktop.ShipElseReportEdit = window;
            var urlStr = '/Equ/ShipElseReport/ShipElseReportEdit.aspx?' + new Date().getTime() + '&action=' + action;
            if (action == 'edit') {
        ...
        function Query(id) {
            ...
            var url = '/Equ/ShipElseReport/ShipElseReportView.aspx?ic=' + id;
            toolbox_oncommand(url, "查看其他船产量上报");
        }
        // 选择项目
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border: 0px; width: 100%;
            ...
            <tr>
                <td class="divFooter" style="text-align: left;">
                    ...
                    <MyUserControl:epc_usercontrol1_wf_ascx ID="WF1" BusiClass="001" BusiCode="159" runat="server" />
                </td>
            </tr>
            <tr>
                <td style="width: 100%;">
