...
public partial class Equ_RoadInterlockReport_RoadInterlockReportEdit : NBasePage, IRequiresSessionState
{
	...
	protected void btnSave_Click(object sender, System.EventArgs e)
	{
		try
		{
			...
			stringBuilder.Append("winclose('RoadInterlockReportEdit', 'RoadInterlockReportList.aspx', true)");
