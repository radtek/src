<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CostPreReimburseModify.aspx.cs" Inherits="BudgetManage_Cost_CostPreReimburseModify" %>
...
<head runat="server"><title>预报销变更申请</title>
    ...
    <script type="text/javascript">
        ...
        function addCostDiary(action) {
            top.ui._CostPreReimburseModifyEdit = window;
            ...
            var url = '/BudgetManage/Cost/CostPreReimburseModifyEdit.aspx?year=' + year + '&prjId=' + prjId;
            var type = 'P';
            if (year == 'zzjg') {
                type = 'O'
                typeCost = '组织机构';
            ...
            var typeCost = '预报销变更';
            var titleText = '新增' + typeCost + '申请';
            if (action == 'edit') {
                titleText = '编辑' + typeCost + '申请';
                url = url + '&id=' + id;
            }
            url += '&costType=' + type;
        ...
        function view(id) {
            ...
            var url = '/BudgetManage/Cost/CostPreReimburseModifyDetails.aspx?ic=' + id;
            viewopen(url);
        }
	</script>
</head>
								...
								<table class="tab">
									<tr>
										<td class="divFooter" style="text-align: left;">
											...
											<MyUserControl:epc_usercontrol1_wf_ascx ID="WF1" BusiCode="170" BusiClass="001" runat="server" />
										</td>
									</tr>
									<tr>
...
<ItemTemplate>
																...
																</ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="变更后的金额" ItemStyle-CssClass="decimal_input">
<ItemTemplate>
