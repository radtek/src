<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResourceList.aspx.cs" Inherits="BudgetManage_Budget_TaskResource" %>
...
<head id="Head1" runat="server"><title></title>
    ...
    <style type="text/css">
        ...
        .tableContent2 td
        {
            border: 1px solid rgb(202,222,237);
        }
    </style>
</head>
<body>
    ...
    <div class="divHeader">
        <table id="table" style="border: 0px; width: 96%; height: 670px; margin-right: auto;
            ...
            <tr class="taskInfo">
                <td>
                    <table class="tableContent2" style="width: 100%; margin-right: auto; margin-left: auto;
                        ...
                        <tr>
                            <td class="word" style="vertical-align: middle">
                                项目特征描述
                            </td>
                            <td class="txt readonly">
                            ...
                            <td class="txt readonly" style="vertical-align: middle">
                                <asp:Label ID="lblQu" runat="server"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td colspan="3" style="vertical-align: top;">
                    <div class="pagediv" id="divBudget" style="height: 30%; width: 90%; margin-left: auto">
                        <asp:GridView ID="gvResource" AutoGenerateColumns="false" CssClass="gvdata" OnRowDataBound="gvPurchaseplan_RowDataBound" DataKeyNames="resourceId,price,number" runat="server">
<EmptyDataTemplate>
...
</asp:TemplateField><asp:TemplateField HeaderText="资源编号" HeaderStyle-Width="10%" HeaderStyle-HorizontalAlign="Left"><ItemTemplate>
...
<ItemTemplate>
                                    ...
                                    </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="单价" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="50px"><ItemTemplate>
                                        ...
                                        <asp:TextBox Style="text-align: right;" Width="90px" Height="15px" ID="txtLoss" CssClass="decimal_input" onblur="computTotal(this.No,this)" Text='<%# System.Convert.ToString((Eval("LossCoefficient").ToString() == "") ? "1.000" : Eval("LossCoefficient"), System.Globalization.CultureInfo.CurrentCulture) %>' No='<%# System.Convert.ToString(Container.DataItemIndex, System.Globalization.CultureInfo.CurrentCulture) %>' runat="server"></asp:TextBox>
            ...
            <tr>
                <td style="width: 100%; height: 15%;">
                    <div id="divBottom" class="divFooter2" style="width: 97%; margin-left: auto; margin-right: auto">
