...
public partial class Equ_RoadTeamReport_RoadTeamReportEdit : NBasePage, IRequiresSessionState
{
	...
	protected void btnSave_Click(object sender, System.EventArgs e)
	{
		try
		{
			...
			stringBuilder.Append("winclose('RoadTeamReportEdit', 'RoadTeamReportList.aspx', true)");
