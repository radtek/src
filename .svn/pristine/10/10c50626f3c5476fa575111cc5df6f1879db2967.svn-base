    ...
    <form id="form1" runat="server">
        <div style="width: 16%; height: 100%; margin: 0; position: absolute; border-right: 1px solid #B5CCDE;">
            <span class="spanSelect" id="spanwrite_mail" style="width: 100%; height: 25px; border: 0; background: url(/images1/email/understood.gif) repeat-x;">
                ...
                <input type="button" id="write_mail" value="写邮件" style="line-height: 25px; border: 0px; height: 25px; font-size: 12px; text-align: left; color: #333; float: left; width: 77%; background: url(/images1/email/understood.gif) repeat-x;" />
            </span><span class="spanSelect" id="spaninbox" style="width: 100%; height: 25px; border: 0; background: url(/images1/email/over.gif) repeat-x;">
                <img src="../../images1/email/2.gif" style="float: left; margin: 8px 2px 0 5%;" id="imginbox" onclick="funimginbox();" runat="server" />

                <input type="button" id="inbox" value="收件箱" style="line-height: 25px; border: 0px; height: 25px; color: #004592; font-weight: bold; text-align: left; width: 77%; background: url(/images1/email/over.gif) repeat-x;"
                    runat="server" />

            </span><span class="spanSelect" id="spandraft" style="width: 100%; height: 25px; border: 0; background: url(/images1/email/understood.gif) repeat-x;">
                <img src="../../images1/email/3.gif" style="float: left; margin: 8px 2px 0 5%;" id="imgdraft" onclick="funimgdraft();" runat="server" />

                <input type="button" id="draft" value="草稿箱" style="line-height: 25px; border: 0px; width: 77%; height: 25px; text-align: left; color: #333; background: url(/images1/email/understood.gif) repeat-x;"
                    runat="server" />

            </span><span class="spanSelect" id="spanrepeal" style="width: 100%; height: 25px; border: 0; background: url(/images1/email/understood.gif) repeat-x;">
                <img src="../../images1/email/4.gif" style="float: left; margin: 8px 2px 0 5%;" id="imgrepeal" onclick="funimgrepeal();" runat="server" />

                <input type="button" id="repeal" value="撤回邮件" style="line-height: 25px; border: 0px; width: 77%; height: 25px; text-align: left; color: #333; background: url(/images1/email/understood.gif) repeat-x;"
                    runat="server" />

            </span><span class="spanSelect" id="spanoutbox" style="width: 100%; height: 25px; border: 0; background: url(/images1/email/understood.gif) repeat-x;">
                <img src="../../images1/email/5.gif" style="float: left; margin: 8px 2px 0 5%;" id="imgoutbox" onclick="funimgoutbox();" runat="server" />

                <input type="button" id="outbox" value="已发送邮件" style="line-height: 25px; border: 0px; width: 77%; height: 25px; text-align: left; color: #333; background: url(/images1/email/understood.gif) repeat-x;"
                    runat="server" />

            </span><span class="spanSelect" id="spandeleted" style="width: 100%; height: 25px; border: 0; background: url(/images1/email/understood.gif) repeat-x;">
                <img src="../../images1/email/6.gif" style="float: left; margin: 8px 2px 0 5%;" id="imgdeleted" onclick="funimgdeleted();" runat="server" />

                <input type="button" id="deleted" value="已删除邮件" style="line-height: 25px; border: 0px; width: 77%; height: 25px; text-align: left; color: #333; background: url(/images1/email/understood.gif) repeat-x;"
                    runat="server" />

            </span>
        </div>
        <div style="width: 84%; height: 98%; position: absolute; right: 0px; border-left: 1px solid #A9BCE6;">
            <iframe id="iframeMail" width="100%" height="100%" frameborder="0" src="Inbox.aspx"></iframe>
        </div>
        <div id="divOpenAdjunct" title="查看附件" style="display: none;">
            <table id="annexTable" class="gvdata" style="width: 100%;" runat="server">
                <tr class="header" runat="server">
                    <td style="width: 60%" runat="server">名称
                    </td>
                    <td style="width: 30%" runat="server">大小
                    </td>
                    <td runat="server"></td>
                </tr>
            </table>
