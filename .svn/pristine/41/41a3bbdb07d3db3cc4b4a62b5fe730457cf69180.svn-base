<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JournalDetail.aspx.cs" Inherits="oa_JournalManage_JournalDetail" %>
                ...
                <tr>
                    ...
                    <td class="elemTd" id="FileUpload1" runat="server">
                        ...
                        <%--<MyUserControl:usercontrol_fileupload_fileupload_ascx ID="FileUpload1" Name="图片" FileType="*.jpg;*.gif;*.png" Class="BuildDiaryPhoto" runat="server" />
                           <table id="FileUpload1" border="0" cellpadding="0" cellspacing="0" style="width: 500px;" runat="server"></table>--%>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="elemTd" id="FileUpload2" runat="server">
                        <%--     <MyUserControl:usercontrol_fileupload_fileupload_ascx ID="FileUpload2" Name="附件" runat="server" />
                                <table id="FileUpload2" border="0" cellpadding="0" cellspacing="0" style="width: 500px;" runat="server"></table>--%>
                    </td>
                </tr>
                <tr>
