    ...
    public class BudTaskResourceServices
    {
            ...
            foreach (DataRow row in this.dtResource.Rows)
            {
                ...
                if (this.amountIndex != -1)
                {
                    ...
                    catch
                    {
                        ...
                        {
                            item = "在您的Excel中：序号" + str8 + "【资源名称：" + name + "，品牌：" + brand + "，规格：" + specification + "，型号：" + modelNumber + "】,存在非有效数字,请修改！";
                        }
                        errors.Add(item);
                    }
                }
                ...
                if (string.IsNullOrEmpty(str9))
                {
                    ...
                    else
                    {
                        ...
                        //string specification = string.Empty;
                        //string modelNumber = string.Empty;
                        //【资源名称：钢材，品牌：上海钢铁，规格：1.0*1500*c，型号：11】
                        item = "在您的Excel中：序号" + str8 + "【资源名称：" + name + "，品牌："+ brand + "，规格："+ specification + "，型号："+ modelNumber + "】,在资源库中不存在或无法对应,请修改！";
                    }
                    errors.Add(item);
                    try
                    {
                ...
                else
                {
                    try
                    {
                        ...
                        if (!cn.justwin.Domain.BudContractTask.IsLeaf(taskId))
                        {
                            ...
                            {
                                item = "在您的Excel中：序号" + str8 + "【资源名称：" + name + "，品牌：" + brand + "，规格：" + specification + "，型号：" + modelNumber + "】,不允许配置资源,请修改！";
                            }
                            errors.Add(item);
                        }
                    ...
                    catch
                    {
                        ...
                        {
                            item = "在您的Excel中：序号" + str8 + "【资源名称：" + name + "，品牌：" + brand + "，规格：" + specification + "，型号：" + modelNumber + "】,在WBS信息中的不存在,请修改！";
                        }
                        errors.Add(item);
                    }
                }
        ...
        public void AddResource(string[] colArray, string inputUser, List<string> errors, string prjId, string isWBSRelevance, char sep)
        {
            ...
            foreach (DataRow row in this.dtResource.Rows)
            {
                ...
                {
                    item = "在您的Excel中：资源名称：" + name + "，品牌：" + brand + "，规格："+ specification + "，型号："+ modelNumber + "，在资源库中不存在或无法对应。";
                    errors.Add(item);
                }
                string taskId = string.Empty;
                ...
                if (isWBSRelevance == "1")
                {
                    ...
                    {
                        ResourceTemp.Add(ResourceTemp.Create(str11, taskId, resourceCode, name, unitPrice, quanity, amount, prjId, brand, specification, modelNumber));/**/
                    }
                }
                ...
                {
                    ResourceTemp.Add(ResourceTemp.Create(str11, null, resourceCode, name, unitPrice, quanity, amount, prjId, brand, specification, modelNumber));/**/
                }
            }
            BudTaskServices.codeAndTaskId.Clear();
        }
