...
using Wuqi.Webdiyer;
public partial class Equ_Report_Land_RoadDrainReport : NBasePage, IRequiresSessionState
{
	...
	protected void gvwDrainReport_RowDataBound(object sender, GridViewRowEventArgs e)
	{
	...
	public DataTable GetTitleByTable(DataTable dt)
	{
		...
		{
			dt.Columns["EquCode"].ColumnName = "排水板设备编号";
		}
		if (dt.Columns["SubcontractGroup"] != null)
		{
			dt.Columns["SubcontractGroup"].ColumnName = "分包队伍";
		}
		if (dt.Columns["ConstructionQty"] != null)
		{
			dt.Columns["ConstructionQty"].ColumnName = "施工产量";
		}
