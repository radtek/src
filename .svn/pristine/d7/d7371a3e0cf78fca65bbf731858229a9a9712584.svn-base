<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrjCompletedList.aspx.cs" Inherits="PrjManager_Completed_PrjCompletedList" %>
...
<head runat="server"><title>竣工验收申请</title>
    ...
    <script type="text/javascript">
        ...
        function setButton2(jwTable) {
            ...
            jwTable.registClickTrListener(function () {
                ...
                if ($(this).attr('limit') == "1") {
                    if ($(this).attr('prjstate') != "10" || $(this).attr('prjstate') != '7') {
            ...
            jwTable.registClickSingleCHKListener(function () {
                ...
                if (checkedChk.length == "1") {
                    ...
                    if ($(tr1).attr('limit') == "1") {
                        if ($(tr1).attr('prjstate') != "10") {
                            if ($(tr1).attr('prjstate') != '7') {
                                $('#btnCompleted').attr('disabled', 'disabled');
                                $('#btnStartWF').attr('disabled', 'disabled');
                                $('#CancelBt').attr('disabled', 'disabled');
                                $('#WF1_btnViewWF').attr('disabled', 'disabled');
                                $('#WF1_btnWFPrint').attr('disabled', 'disabled');
                            } else {
                                if ($(tr1).attr('state') == "-1" || $(tr1).attr('state') == "-3") {
        ...
        function setCompleted() {
            $('#btnCompleted').click(function () {
                top.ui._PrjCompletedList = window;
                var url = "/PrjManager/Completed/PrjCompleted.aspx?PrjId=" + $('#hfldCheckedIds').val();
                toolbox_oncommand(url, "编制竣工验收单");
            });
        }
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="divFooter" style="text-align: left; padding-left: 2px;">
                <input type="button" id="btnCompleted" value="编制竣工验收单" style="width: 120px" disabled="disabled" />
                <input type="button" id="btnQuery" value="查看" disabled="disabled" onclick="Query()" />
                <MyUserControl:epc_usercontrol1_wf_ascx ID="WF1" BusiCode="106" BusiClass="001" runat="server" />
            </td>
        </tr>
        <tr>
            <td>
