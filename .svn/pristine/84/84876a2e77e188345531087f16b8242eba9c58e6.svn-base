<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPayendFeedback.aspx.cs" Inherits="ContractManage_ContractPayend_AddPayendFeedback" %>
...
<body>
    ...
    <table class="tab">
            ...
            <td style="width: 100%;" valign="top">
                <table cellpadding="0" cellspacing="2" class="viewTable" style="width: 100%;" border="0">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:Label ID="lblProvisionMatter" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td colspan="3">
                            <asp:Label ID="lblProjectCondition" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td colspan="3">
                            <asp:Label ID="lblOtherExplain" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
        ...
        <tr class="bottonrow">
            <td style="text-align: right;">
                ...
                <asp:Button ID="btnSave" Text="暂存" OnClick="btnSave_Click" runat="server" />
    ...
    <asp:HiddenField ID="hdFeedbackState" runat="server" />
    </form>
</body>
</html>
