            ...
            <tr style="vertical-align: top; height: 70%;">
                <td>
                    <div style="height: 22px; line-height: 22px;">
                        <span id="SpWBS" onclick="setTem('0')" class="temShow" style="margin-left: 0px;" runat="server">WBS信息</span> <span id="SpResource" onclick="setTem('1')" class="temHide" runat="server">资源信息</span> <span id="SpError" onclick="setTem('2')" class="temHide" runat="server">警告信息 </span>
                    </div>
                    <div id="WBSData" class="tabdivgv">
                        <div id="divWBS" style="overflow: auto;">
                            <asp:GridView ID="gvwWBSData" CssClass="gvdata" OnRowDataBound="gvwWBSData_RowDataBound" runat="server">
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                        </ItemTemplate>
                    ...
                    <div id="ResData" class="tabdivgv" style="display: none;">
                        <div id="divRes" style="overflow: auto;">
                            <asp:GridView ID="gvwResData" CssClass="gvdata" OnRowDataBound="gvwResData_RowDataBound" runat="server">
                                <Columns>
                                    <asp:TemplateField HeaderStyle-Width="20px">
                                        <HeaderTemplate>
                                            <asp:CheckBox ID="cbAllBox" runat="server" />
                    ...
                    <div id="ErrorData" class="tabdivgv" style="display: none;">
                        <div id="divError" style="overflow: auto;">
                            <asp:GridView ID="gvwError" CssClass="gvdata" runat="server">
                                <Columns>
                                    <asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px">
                                        <ItemTemplate>
