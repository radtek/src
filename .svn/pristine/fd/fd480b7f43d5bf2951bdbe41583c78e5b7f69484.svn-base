namespace cn.justwin.DAL
{
    ...
    public class Bud_ContractResource : EntityObject
    {
        ...
        public cn.justwin.DAL.Bud_ContractTask Bud_ContractTask
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Bud_ContractTask>("Pm2Model.FK__Bud_Contr__TaskI__6F6B4809", "Bud_ContractTask").Value;
            }
            set
            {
                this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Bud_ContractTask>("Pm2Model.FK__Bud_Contr__TaskI__6F6B4809", "Bud_ContractTask").Value = value;
            }
        }
        ...
        public EntityReference<cn.justwin.DAL.Bud_ContractTask> Bud_ContractTaskReference
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Bud_ContractTask>("Pm2Model.FK__Bud_Contr__TaskI__6F6B4809", "Bud_ContractTask");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedReference<cn.justwin.DAL.Bud_ContractTask>("Pm2Model.FK__Bud_Contr__TaskI__6F6B4809", "Bud_ContractTask", value);
                }
            }
        }
        ...
        public cn.justwin.DAL.Res_Resource Res_Resource
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Res_Resource>("Pm2Model.FK__Bud_Contr__Resou__705F6C42", "Res_Resource").Value;
            }
            set
            {
                this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Res_Resource>("Pm2Model.FK__Bud_Contr__Resou__705F6C42", "Res_Resource").Value = value;
            }
        }
        ...
        public EntityReference<cn.justwin.DAL.Res_Resource> Res_ResourceReference
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Res_Resource>("Pm2Model.FK__Bud_Contr__Resou__705F6C42", "Res_Resource");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedReference<cn.justwin.DAL.Res_Resource>("Pm2Model.FK__Bud_Contr__Resou__705F6C42", "Res_Resource", value);
                }
            }
        }
