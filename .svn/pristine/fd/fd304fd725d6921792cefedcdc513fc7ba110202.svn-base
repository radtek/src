...
using Wuqi.Webdiyer;
public partial class TenderManage_BidQuery : NBasePage, IRequiresSessionState
{
	...
	{
		System.Collections.Generic.List<int> prjState = this.GetPrjState();
		DataTable all = TenderInfo.GetAll(this.txtPrjName.Text, this.txtPrjCode.Text, this.txtName.Text, this.dropPrjKindClass.SelectedValue, this.txtStartTime.Text, this.txtEndTime.Text, prjState, null, base.UserCode, this.txtTenderPrjManager.Text, false, 3, this.AspNetPager1.CurrentPageIndex, 2147483647, ProjectParameter.QualificationPass, "PftFlowState");
