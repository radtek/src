...
public partial class SMS_Fram_SmsOk : NBasePage, IRequiresSessionState
{

	protected void Page_Load(object sender, EventArgs e)
	{
		this.BtnSave.Attributes["onclick"] = "if(document.getElementById('txtPersons').value=='') alert('接收人不能为空!');return false;";
	}
