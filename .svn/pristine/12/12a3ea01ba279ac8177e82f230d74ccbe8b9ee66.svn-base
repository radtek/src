...
using Wuqi.Webdiyer;
public partial class Equ_Report_Land_RoadTeamReport : NBasePage, IRequiresSessionState
{
	...
	protected override void OnInit(System.EventArgs e)
	{
		...
		{
			this.equType = base.Request["type"];
		}
		base.OnInit(e);
	}
	...
	protected void gvwTeamReport_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		...
		if (e.Row.RowType == DataControlRowType.Footer)
		{
			...
			e.Row.Cells[10].Text = this.total;
		}
	}
	...
	public DataTable GetTitleByTable(DataTable dt)
	{
		...
		if (dt.Columns["SubcontractTeam"] != null)
		{
			dt.Columns["SubcontractTeam"].ColumnName = "分包队伍";
		}
		if (dt.Columns["StartDate"] != null)
		{
			dt.Columns["StartDate"].ColumnName = "施工开始时间";
		}
		if (dt.Columns["EndDate"] != null)
		{
			dt.Columns["EndDate"].ColumnName = "施工结束时间";
		}
		if (dt.Columns["TeamQty"] != null)
		{
			dt.Columns["TeamQty"].ColumnName = "当日台班数";
		}
		if (dt.Columns["SubconstractChargeMan"] != null)
		{
			dt.Columns["SubconstractChargeMan"].ColumnName = "分包现场负责人";
		}
		if (dt.Columns["OwnerWorker"] != null)
		{
			dt.Columns["OwnerWorker"].ColumnName = "甲方施工员";
		}
