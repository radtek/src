...
public partial class oa_WorkManage_SubCompanyManage_PersonDrawStat : BasePage, IRequiresSessionState
{
	...
	protected void btnStartWF_Click(object sender, EventArgs e)
	{
		...
		string text = FlowAuditAction.BeginFlow("013", "001", recordID, "", base.UserCode);
		if (text == "工作流程已成功启动")
		{
	...
	{
		this.strWhere = "ApplyType='p' and iYear=" + ((this.txtYear.Text.Trim() == "") ? DateTime.Now.Year.ToString() : this.txtYear.Text.Trim());
		this.Bind(this.strWhere);
	}
}
