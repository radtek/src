<%@ Page Language="C#" AutoEventWireup="true" CodeFile="productvaluemonthreport.aspx.cs" Inherits="ProductValueMonthReport" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<head runat="server"><title>MonthPlanList</title><meta Content="Microsoft Visual Studio .NET 7.1" Name="GENERATOR" />
...
<meta Content="http://schemas.microsoft.com/intellisense/ie5" Name="vs_targetSchema" />
		...
		<script language="javascript">
			function MonthProductValueEdit(type,month,sf,projectCode)			
			{
				...
				{
					case 1:
						self.location.href = "ProductValueStat.aspx?t="+type+"&m="+month+"&pc="+projectCode+"&pn="+projectname+"&IsExam="+'<%=Request["t"] %>';
						break;
					case 2:
						self.location.href = "ProductValueFill.aspx?t="+type+"&m="+month+"&pc="+projectCode+"&pn="+projectname+"&IsExam="+'<%=Request["t"] %>';
						break;
				}
				return false;
			}
	...
	<body class="body_frame" scroll="no">
		<form id="Formx" method="post" runat="server">
			...
			<input id="HdnProjectName" style="WIDTH: 10px" type="hidden" runat="server" />
...
</asp:TemplateColumn><asp:TemplateColumn HeaderText="产值计量上报">
<ItemTemplate>
...
</asp:TemplateColumn><asp:BoundColumn HeaderText="完成产值汇总"></asp:BoundColumn></Columns></asp:DataGrid></div>
					</td>
				</tr>
			</table>
		</form>
