<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BudgetCompletedList.aspx.cs" Inherits="ContractManage_IncometContract_BudgetCompletedList" %>
...
<link rel="Stylesheet" type="text/css" href="/Script/jquery.easyui/jquery.easyui.extension.css" />
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			var jwTable = new JustWinTable('gvwBudModify');
			replaceEmptyTable('emptyTask', 'gvwBudModify');
			//清单外，字体红色显示
			$('#gvwBudModify').find("tr").each(function () {
					...
					<table border="0" class="tab">
						...
						<tr>
							<td style="width: 100%; background-color: rgb(238,242,242);" valign="top">
								<asp:GridView ID="gvwBudModify" Width="100%" AutoGenerateColumns="false" CssClass="gvdata" ShowFooter="true" OnRowDataBound="gvwBudModify_RowDataBound" DataKeyNames="TaskId,ModifyType,Total,Quantity" runat="server">
<EmptyDataTemplate>
