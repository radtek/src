    ...
    <form id="Form1" method="post" runat="server">
        <table class="table-none" height="100%" cellspacing="0" cellpadding="0" width="100%"
            ...
            <tr>
                <td valign="top">
                    <div>
                        <asp:DataGrid ID="DgrdList" Width="100%" AutoGenerateColumns="false" AllowPaging="true" PageSize="15" CssClass="grid" DataKeyField="CorpID" OnPageIndexChanged="DgrdList_PageIndexChanged" runat="server">
                            ...
                            <Columns>
                               ...
                               <%-- <asp:BoundColumn DataField="CorpName" HeaderText="单位名称"></asp:BoundColumn>--%>
                                ...
                                <asp:BoundColumn HeaderText="流程状态" DataField="AuditState" Visible="true"></asp:BoundColumn>
                            </Columns>
                        </asp:DataGrid>
                    </div>
                </td>
