<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RefuelApplyList.aspx.cs" Inherits="Equ_ShipOilWear_RefuelApplyList" %>
...
<link type="text/css" rel="stylesheet" href="../../Script/jquery.tooltip/jquery.tooltip.css" />
    ...
    <script type="text/javascript" src="../Script/ShipOilWear/RefuelApplyList.js"></script>
</head>
<body>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border: 0px; width: 100%;
            ...
            <tr>
                <td class="divFooter" style="text-align: left;">
                    ...
                    <MyUserControl:epc_usercontrol1_wf_ascx ID="WF1" BusiClass="001" BusiCode="143" runat="server" />
                </td>
            </tr>
            <tr>
                <td style="width: 100%;">
                    <table class="tab">
                        <tr>
                            <td style="height: 100%; vertical-align: top;">
                                <div class="">
                                    <asp:GridView ID="gvRefuelApply" CssClass="gvdata" AutoGenerateColumns="false" OnRowDataBound="gvRefuelApply_RowDataBound" DataKeyNames="Id,PrjId" runat="server">
<EmptyDataTemplate>
                                            <table id="emptyRefuelApply" class="gvdata">
                                                <tr class="header">
...
<Columns><asp:TemplateField HeaderStyle-Width="20px"><HeaderTemplate>
                                                ...
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="申请加油船编号"><ItemTemplate>
                                                ...
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="油耗预算编号"><ItemTemplate>
                                                    <span class="tooltip" title=''>
                                                        
                                                    </span>
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="本次申请数量" ItemStyle-CssClass="decimal_input"><ItemTemplate>
                                                    
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="是否委托采购" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px"><ItemTemplate>
                                                    
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="申请加油日期" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px"><ItemTemplate>
