...
public partial class ContractManage_PayoutContract_PayoutContract : NBasePage, IRequiresSessionState
{
	...
	private DataTable SearchContracts()
	{
		...
		this.contracts = this.payoutContract.SelectLedger(startDate, endDate, startMoney, endMoney, this.txtContractCode.Text.Trim(), this.txtContractName.Text.Trim(), this.txtConType.Text.Trim(), strProjectName, base.UserCode, text);
		...
		return this.payoutContract.SelectLedger(startDate, endDate, startMoney, endMoney, this.txtContractCode.Text.Trim(), this.txtContractName.Text.Trim(), this.txtConType.Text.Trim(), strProjectName, base.UserCode, text, this.AspNetPager1.CurrentPageIndex, this.AspNetPager1.PageSize);
	}
