<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrjMilestoneDetailDepList.aspx.cs" Inherits="PrjManager_PrjMilestoneDetailDepList" %>
...
</asp:TemplateField><asp:TemplateField HeaderText="项目编号" ItemStyle-HorizontalAlign="Left"><ItemTemplate>
                                                    <%# Eval("PrjCode") %>
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="项目名称" ItemStyle-HorizontalAlign="Left"><ItemTemplate>
                                                    <%# Eval("PrjName") %>
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="上报时间" ItemStyle-HorizontalAlign="Left"><ItemTemplate>
                                                    <%# GetRptDate(Eval("RptDate")) %>
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="部门" ItemStyle-HorizontalAlign="Left"><ItemTemplate>
                                                    <%# Eval("DepName") %>
