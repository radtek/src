...
using Wuqi.Webdiyer;
public partial class ContractManage_PayoutContract_PayoutContractMain : NBasePage, IRequiresSessionState
{
	...
	private void SetTitle()
	{
		...
		{
			string arg_2D_0 = base.Request["spId"];
		}
	}
	protected void btnSearch_Click(object sender, System.EventArgs e)
	{
		this.AspNetPager1.CurrentPageIndex = 1;
		this.hfldContract.Value = "";
		DataTable dtcontract = this.SearchContracts();
		this.DataBindContracts(dtcontract);
	}
	...
	private DataTable SearchContracts()
	{
		...
		string text = " AND Con_Payout_Contract.FlowState = '1' AND  CorpName like '%" + this.txtBName.Text.Trim() + "%'";
