<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShipTeamReportEdit.aspx.cs" Inherits="Equ_ShipTeamReport_ShipTeamReportEdit" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnCancel').click(function () {
                winclose('ShipTeamReportEdit', 'ShipTeamReportList.aspx', false);
            });
        });
        // 选择项目
    ...
    <div id="divContent2" class="divContent2">
        <table class="tableContent2" cellpadding="5px" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtHoldCapacity" Height="15px" Width="100%" Text="0.000" CssClass="decimal_input" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="word">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtMachineTeamCount" Height="15px" Width="100%" Text="0.000" CssClass="decimal_input" runat="server"></asp:TextBox>
                </td>
                <td class="word">
                    台班时间
                </td>
                <td>
                    <asp:TextBox ID="txtMachineTeamDuration" Height="15px" Width="100%" Text="0.000" CssClass="decimal_input" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="word">
                ...
                <td>
                    <asp:DropDownList ID="ddlType" Width="100%" runat="server"><asp:ListItem Value="D" Text="耙吸船" /><asp:ListItem Value="E" Text="其它船" /></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td class="word">
