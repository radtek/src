<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GiveUpList.aspx.cs" Inherits="TenderManage_GiveUpList" %>
...
<head runat="server"><title>放弃数据一览</title><link rel="Stylesheet" type="text/css" href="/Script/jquery.easyui/themes/default/easyui.css" />
                    ...
                    <table class="tab" style="vertical-align: top;">
                        <tr>
                            <td class="divFooter" style="text-align: left">
                                <asp:Button ID="btnReset" Text="启用" disabled="disabled" OnClick="btnReset_Click" runat="server" />
