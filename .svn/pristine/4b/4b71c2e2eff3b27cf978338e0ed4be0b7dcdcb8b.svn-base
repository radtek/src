namespace cn.justwin.DAL
{
    ...
    public class Bud_IndirectBudget : EntityObject
    {
        ...
        public EntityCollection<cn.justwin.DAL.Bud_IndirectMonthBudget> Bud_IndirectMonthBudget
        {
            get
            {
                return this.RelationshipManager.GetRelatedCollection<cn.justwin.DAL.Bud_IndirectMonthBudget>("Pm2Model.FK__Bud_Indir__Indir__0801EBA9", "Bud_IndirectMonthBudget");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedCollection<cn.justwin.DAL.Bud_IndirectMonthBudget>("Pm2Model.FK__Bud_Indir__Indir__0801EBA9", "Bud_IndirectMonthBudget", value);
                }
            }
        }
