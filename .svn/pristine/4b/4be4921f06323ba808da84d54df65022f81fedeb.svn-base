...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function lookPlanWBS(id) {;
            //alert(id);
            var url = '/ProgressManagement/Plan/PlanViewWX.aspx?ic=' + id;
            layer.open({
                type: 2,
                title: '查看进度计划',
                shadeClose: true,
        ...
        function lookPlanWBS() {
            ...
            var url = '/ProgressManagement/Plan/PlanViewWX.aspx?ic=' + progressId;
            layer.open({
                type: 2,
                title: '查看进度计划',
                shadeClose: true,
                                    ...
                                    <table class="tab">
                                        <tr class="divFooter" style="text-align: left;">
                                            ...
                                            <td style="display:none;">
                                                ...
                                                <input type="button" id="btnAdd" value="新增" onclick="editPlan('add')" runat="server" style="display:none;"/>

                                                <input type="button" id="btnEdit" value="编辑" state="1" disabled="disabled" onclick="editPlan('edit')" style="display:none;"/>
                                                <asp:Button ID="btnDel" Text="删除" state="1" disabled="disabled" OnClientClick="return confirm('您确定要删除吗？');" OnClick="btnDel_Click" runat="server" style="display:none;"/>
                                                <input type="button" id="btnplaitWBS" value="编制进度" state="1" disabled="disabled"
                                                    style="width: auto;" onclick="plaitPlanWBS()" style="display:none;"/>
                                                
                                                <MyUserControl:epc_usercontrol1_wf_ascx ID="WF1" BusiCode="107" BusiClass="001" runat="server" style="display:none;"/>
                                            </td>
                                        </tr>
                                        <tr>
                                                ...
                                                <div id="divBudget" class="pagediv" style="overflow: hidden;">
                                                    <asp:GridView ID="gvwPlans" CssClass="gvdata" AutoGenerateColumns="false" OnRowDataBound="gvwPlans_RowDataBound" DataKeyNames="ProgressVersionId,ProgressId" runat="server">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="计划名称" HeaderStyle-Width="320px">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <div style="position: absolute; margin-top: 5px;">
                                                                        <span class="al" style="font-size: 16px; text-decoration: none;" onclick="lookPlanWBS('<%# Eval("ProgressId") %>')">
                                                                           <%# StringUtility.GetStr(Eval("VersionName"), 20) %>
                                                                        </span>
                                                                    </div>
                                                                    <div style="float: right; color: #999999; font-size: 12px;">
                                                                        <span style="float: right;">版本号:<%# Eval("VersionCode") %></span>
                                                                        </br>
                                                            ...
                                                            <asp:BoundField HeaderText="执行" DataField="Latest" HeaderStyle-Width="30px"/>
                                                              <asp:TemplateField HeaderText="流程状态" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <%# Common2.GetState(Eval("FlowState").ToString()) %>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:BoundField HeaderText="主计划" HeaderStyle-Width="30px" DataField="Main" Visible="False"/>
