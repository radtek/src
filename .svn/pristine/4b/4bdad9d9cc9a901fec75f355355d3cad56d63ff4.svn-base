<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewContractPayend.aspx.cs" Inherits="ContractManage_ContractPayend_ViewContractPayend" %>
            ...
            <td style="width: 100%;" valign="top">
                <table cellpadding="0" cellspacing="2" class="viewTable" style="width: 100%;" border="0">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:Label ID="lblPayendTopics" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 10%; text-align: right;">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:TextBox ReadOnly="true" Style="border: solid 0px red; height: 100px;" TextMode="MultiLine" ID="txtProvisionMatter" runat="server"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:TextBox ReadOnly="true" Style="border: solid 0px red; height: 100px;" TextMode="MultiLine" ID="txtProjectCondition" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td colspan="3">
                            <asp:TextBox ReadOnly="true" Style="border: solid 0px red; height: 100px;" TextMode="MultiLine" ID="txtOtherExplain" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </td>
