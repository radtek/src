<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResourceList.aspx.cs" Inherits="BudgetManage_Template_BudTemplateResource" %>
...
<head id="Head1" runat="server"><title></title><link href="../../Script/jquery.tooltip/jquery.tooltip.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        ...
        function selectResource() {
            ...
            top.ui._TemplateResList = window;
            ...
            <tr>
                <td colspan="3" style="vertical-align: top;">
                    <div class="pagediv" id="divBudget" style="height: 200px;">
                        <asp:GridView ID="gvResource" AutoGenerateColumns="false" CssClass="gvdata" OnRowDataBound="gvPurchaseplan_RowDataBound" DataKeyNames="resourceId,id" runat="server">
<EmptyDataTemplate>
...
<ItemTemplate>
                                        ...
                                        <asp:TextBox Style="text-align: right;" Width="90px" Height="15px" ID="txtLossCoefficient" CssClass="decimal_input" Text='<%# System.Convert.ToString((Eval("LossCoefficient").ToString() == "") ? "0.000" : Eval("LossCoefficient"), System.Globalization.CultureInfo.CurrentCulture) %>' No='<%# System.Convert.ToString(Container.DataItemIndex, System.Globalization.CultureInfo.CurrentCulture) %>' runat="server"></asp:TextBox>
    ...
    <asp:Button ID="btnBindResource" Width="0px" BackColor="Transparent" OnClick="btnBindResource_Click" runat="server" />
