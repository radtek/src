namespace cn.justwin.DAL
{
    ...
    public class Bud_OrganizationMonthBudget : EntityObject
    {
        ...
        public cn.justwin.DAL.Bud_OrganizationBudget Bud_OrganizationBudget
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Bud_OrganizationBudget>("Pm2Model.FK__Bud_Organ__Organ__69D26A44", "Bud_OrganizationBudget").Value;
            }
            set
            {
                this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Bud_OrganizationBudget>("Pm2Model.FK__Bud_Organ__Organ__69D26A44", "Bud_OrganizationBudget").Value = value;
            }
        }
        ...
        public EntityReference<cn.justwin.DAL.Bud_OrganizationBudget> Bud_OrganizationBudgetReference
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Bud_OrganizationBudget>("Pm2Model.FK__Bud_Organ__Organ__69D26A44", "Bud_OrganizationBudget");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedReference<cn.justwin.DAL.Bud_OrganizationBudget>("Pm2Model.FK__Bud_Organ__Organ__69D26A44", "Bud_OrganizationBudget", value);
                }
            }
        }
