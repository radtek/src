<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShipFlatReportView.aspx.cs" Inherits="Equ_ShipFlatReport_ShipFlatReportView" %>
<%@ Register TagPrefix="MyUserControl" TagName="stockmanage_common_showaudit_ascx" Src="~/StockManage/Common/ShowAudit.ascx" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server"><title>平板船产量上报查看</title>
...
<body id="print1">
    ...
    <table class="tab" style="vertical-align: top;">
            ...
            <td style="vertical-align: top;">
                <table class="viewTable" cellpadding="0px" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td class="elemTd">
                            <asp:Label ID="lblShipCount" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="descTd">
        ...
        <tr id="trAudit" style="vertical-align: top;">
            <td>
                <MyUserControl:stockmanage_common_showaudit_ascx ID="ShowAudit1" BusiClass="001" BusiCode="158" runat="server" />
            </td>
        </tr>
        <tr>
        </tr>
