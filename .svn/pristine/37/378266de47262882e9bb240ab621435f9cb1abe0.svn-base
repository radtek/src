            ...
            <td>
                <table class="queryTable" cellpadding="3px" cellspacing="0px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlWXZT" Width="120px" runat="server">
                                <asp:ListItem></asp:ListItem>
                                <asp:ListItem Value="1">已激活</asp:ListItem>
                                <asp:ListItem Value="2">已禁用</asp:ListItem>
                                <asp:ListItem Value="4">未激活</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
...
<ItemTemplate>
                                                ...
                                                <%# Eval("V_Dlid") %>
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="微信号"><ItemTemplate>
                                                <%# Eval("WXID") %>
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="微信状态"><ItemTemplate>
                                                <%# Eval("WXZT") %>
