<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RepairPlanComplete.aspx.cs" Inherits="Equ_Report_Ship_RepairPlanComplete" %>
...
</asp:TemplateField><asp:TemplateField HeaderStyle-Width="80px" HeaderText="完成人">
<ItemTemplate>
