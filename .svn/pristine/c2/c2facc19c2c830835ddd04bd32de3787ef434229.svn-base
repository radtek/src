...
<head runat="server"><title>入库单设置</title>
            ...
            <tr>
                <td>
                    <div class="headerDiv" style="text-align: left;">
                        ...
                        <%--<input type="button" id="selectResource" style="width: 150px" value="从资源中选择" />--%>
...
<ItemTemplate>
    ...
    <asp:HiddenField ID="hfldResourceCode" runat="server" />
           <%-- <asp:HiddenField ID="hfldResourceCode2" runat="server" />--%>
    ...
    <asp:Button ID="btnBindResource" Text="" OnClick="btnBindResource_Click" runat="server" />
        <%-- <asp:Button ID="btnBindResource2" Text="" OnClick="btnBindResource2_Click" runat="server" />--%>
    </form>
</body>
</html>
