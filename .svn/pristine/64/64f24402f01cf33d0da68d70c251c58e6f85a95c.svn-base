<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoadDrainReportList.aspx.cs" Inherits="Equ_RoadDrainReport_RoadDrainReportList" %>
...
<head runat="server"><title>排水板设备上报</title><link type="text/css" rel="stylesheet" href="../../Script/jquery.easyui/themes/default/easyui.css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnQuery').click(function () {
                var url = '/Equ/RoadDrainReport/RoadDrainReportView.aspx?ic=' + $('#hfldIdsChecked').val();
                viewopen(url, '查看排水板设备上报');
            });
        ...
        function openNewTab(action) {
            var title = '新增排水板设备上报';
            parent.desktop.RoadDrainReportEdit = window;
            var urlStr = '/Equ/RoadDrainReport/RoadDrainReportEdit.aspx?' + new Date().getTime() + '&action=' + action;
            if (action == 'edit') {
        ...
        //标签页查看
        function Query(id) {
            parent.desktop.RoadDrainReportView = window;
            var url = '/Equ/RoadDrainReport/RoadDrainReportView.aspx?ic=' + id;
            toolbox_oncommand(url, "查看排水板设备上报");
        }
        // 选择项目
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border: 0px; width: 100%;
            ...
            <tr>
                <td class="divFooter" style="text-align: left;">
                    ...
                    <MyUserControl:epc_usercontrol1_wf_ascx ID="WF1" BusiClass="001" BusiCode="163" runat="server" />
                </td>
            </tr>
            <tr>
                <td style="width: 100%;">
