...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function rowQuery(id) {
            ///onclick="viewopen('/StockManage/SmOutReserve/ViewReserve.aspx?ic=<%# Eval("orid") %>')">
            var url = '/StockManage/SmOutReserve/ViewReserveWX.aspx?ic=' + id;
            layer.open({
                type: 2,
                title: '查看出库报表',
                shadeClose: true,
                ...
                <td>
                    <table class="queryTable" cellpadding="3px" cellspacing="0px">
                        ...
                        <tr>
                            ...
                            <td> <asp:TextBox ID="txtCorp" Width="120px" CssClass="easyui-validatebox" data-options="validType:'validQueryChars[50]'" runat="server"></asp:TextBox>
                    ...
                    <table border="0" class="tab">
                        ...
                        <tr>
                            <td style="height: 100%; vertical-align: top;">
                                <div class="">
                                    <asp:GridView ID="gvPurchaseplan" CssClass="gvw"  AutoGenerateColumns="false" AllowPaging="true" PageSize="5" OnPageIndexChanging="gvPurchaseplan_PageIndexChanging" DataKeyNames="orcode" runat="server">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="出库编号">
                                                <ItemTemplate>
                                                    <span class="al" onclick="rowQuery('<%# Eval("orid") %>')"> 
                                                        <%# Eval("orcode") %>
                                                    </span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
