<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IEPInfoEdit.aspx.cs" Inherits="AccountManage_IEPInfo_IEPInfoEdit" %>
    ...
    <div class="divContent2">
        <table class="tableContent2" cellpadding="5px" cellspacing="0">
            ...
            <tr>
                ...
                <td class="txt">
                    <asp:RadioButton ID="rdbTypeIn" Text="收入" GroupName="type" runat="server" /><asp:RadioButton ID="rdbTypeOut" Text="支出" GroupName="type" runat="server" />
                </td>
            </tr>
            <tr>
                <td class="word">
                ...
                <td class="txt">
                    ...
                    <asp:CompareValidator ID="CompareValidator1" ErrorMessage="金额必须为数字且大于0" ControlToValidate="txtMoney" Operator="GreaterThanEqual" Type="Currency" ValueToCompare="0" Display="Dynamic" runat="server"></asp:CompareValidator>
                </td>
            </tr>
            <tr>
                <td class="word">
