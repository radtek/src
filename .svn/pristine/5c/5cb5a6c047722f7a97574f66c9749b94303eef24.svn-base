        ...
        <div style="height: 95%; overflow: auto; width: 100%">
                    ...
                    <tr>
                        ...
                        <td class="txt" id="Td2">
                            <span class="spanSelect" style="width: 100%">
                                <asp:TextBox ID="txtReportUser" Width="90%" ReadOnly="true" Style="height: 15px; border: none; line-height: 16px; margin: 1px 2px"
                                    ToolTip="请单击图标选择" runat="server"></asp:TextBox>
                        ...
                        <td class="txt" id="Td3">
                            <span class="spanSelect" style="width: 100%">
                                <asp:TextBox ID="txtPart" Width="90%" ReadOnly="true" Style="height: 15px; border: none; line-height: 16px; margin: 1px 2px"
                                    name="txtPart" runat="server"></asp:TextBox>
                            </span>
                        </td>
                    </tr>
                    <tr>
            ...
            <div align="center" id="mTable" style="margin-top: 5px; vertical-align: top;">
                <div style="vertical-align: top;">
                    <table class="tableContent2" cellpadding="5" cellspacing="0" style="vertical-align: middle; width: 80%">
                        <tr>
                            <td>
                                <table width="100%">
                                    <tr>
                                        <td style="width: 10%; text-align: right;">开始时间
                                        </td>
                                        <td style="width: 15%; text-align: left">
                                            <asp:TextBox ID="BeginDate" Height="100%" Width="99%" onclick="WdatePicker()" runat="server"></asp:TextBox>
                                        </td>
                                        <td style="width: 10%; text-align: right;">结束时间
                                        </td>
                                        <td style="width: 15%; text-align: left">
                                            <asp:TextBox ID="EndDate" Height="100%" Width="99%" onclick="WdatePicker()" runat="server"></asp:TextBox>
                                        </td>
                                        <td style="width: 10%; text-align: right;">负&nbsp;责&nbsp;人
                                        </td>
                                        <td style="width: 15%; text-align: left">
                                            <span class="spanSelect" style="width: 100%">
                                                <asp:TextBox ID="txtDuty" Width="90%" ReadOnly="false" Style="height: 15px; border: none; line-height: 16px; margin: 1px 2px"
                                                    runat="server"></asp:TextBox>
                                            </span>
                                        </td>
                                        <td style="width: 10%; text-align: right;">责&nbsp;任&nbsp;人
                                        </td>
                                        <td style="width: 15%; text-align: left">
                                            <span class="spanSelect" style="width: 100%">
                                                <asp:TextBox ID="txtResponsibility" Width="90%" ReadOnly="false" Style="height: 15px; border: none; line-height: 16px; margin: 1px 2px"
                                                    runat="server"></asp:TextBox>
                                            </span>
                                        </td>
                                    </tr>
                        ...
                        <tr>
                            <td colspan="8">
                                <table width="100%">
                                    <tr>
                                        <td style="width: 10%; text-align: right">计划内容
                                        </td>
