<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoadTeamReport.aspx.cs" Inherits="Equ_Report_Land_RoadTeamReport" %>
...
<head runat="server"><title>日机械产量报表</title><link type="text/css" rel="stylesheet" href="../../../Script/jquery.easyui/themes/default/easyui.css" />
...
<link type="text/css" rel="stylesheet" href="../../../Script/jquery.tooltip/jquery.tooltip.css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var jwTable = new JustWinTable('gvwTeamReport');
            replaceEmptyTable('emptyTeamReport', 'gvwTeamReport');
            // 显示被截取的信息
            jw.tooltip();
        })
        // 选择项目
        ...
        <tr>
            <td style="vertical-align: top;">
                <div class="pagediv" style="width: 100%">
                    <asp:GridView ID="gvwTeamReport" AutoGenerateColumns="false" CssClass="gvdata" Width="100%" ShowFooter="true" OnRowDataBound="gvwTeamReport_RowDataBound" runat="server">
<EmptyDataTemplate>
                            <table id="emptyTeamReport">
                                <tr class="header">
                                    <th style="width: 25px;">
                                        序号
                                    </th>
...
<Columns><asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px"><ItemTemplate>
                                ...
                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="施工开始时间" ItemStyle-HorizontalAlign="Center"><ItemTemplate>
                                    
                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="施工结束时间" ItemStyle-HorizontalAlign="Center"><ItemTemplate>
                                    
                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="当日台班数" ItemStyle-CssClass="decimal_input" ItemStyle-HorizontalAlign="Right"><ItemTemplate>
