<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DepMonthMileStoneList.aspx.cs" Inherits="PrjManager_DepMonthMileStoneList" %>
...
<head id="Head1" runat="server"><title>部门月度</title>
    ...
    <script type="text/javascript">
        ...
        function Query(name) {
            ...
            var url = '/PrjManager/DepMonthMileStoneDetail.aspx?name=' + name + '&month=' + month + '&year=' + year;
            toolbox_oncommand(url, "部门月度里程碑明细查看");
        }
    </script>
</head>
<body>
