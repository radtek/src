<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="PrjTotalQuery.aspx.cs" Inherits="PrjManager_PrjTotalQuery" %>
...
<head runat="server"><title>项目信息</title><link href="/Script/jquery.tooltip/jquery.tooltip.css" rel="Stylesheet" type="text/css" />
<link href="/Script/jquery.tooltip/jquery.tooltip.css" rel="Stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        ...
        function Query() {
            viewopen('/PrjManager/PrjInfoView.aspx?&&ic=' + document.getElementById("hfldCheckedIds").value, '项目信息查看');
        }
        //甲方名称
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="spanSelect" style="width: 122px;">
                                    <asp:TextBox ID="txtName" CssClass="easyui-validatebox" data-options="validType:'validQueryChars[50]'" Style="width: 97px; height: 15px; border: none; line-height: 16px; margin: 1px 0px 1px 2px;" runat="server"></asp:TextBox>
                    ...
                    <table border="0" class="tab">
                        ...
                        <tr>
                            <td style="width: 100%;" valign="top">
                                <div>
                                    <asp:GridView ID="gvPrjInfo" CssClass="gvdata" AutoGenerateColumns="false" ShowFooter="true" OnRowDataBound="gvPrjInfo_RowDataBound" DataKeyNames="PrjGuid,TypeCode,Primit,i_ChildNum,IsTender" runat="server">
<EmptyDataTemplate>
                                            <table id="emptyTable">
                                                <tr class="header">
                                                    <th scope="col">
