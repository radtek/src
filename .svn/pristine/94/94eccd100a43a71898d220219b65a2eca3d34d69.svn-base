namespace cn.justwin.stockBLL
{
    ...
    public class Storage
    {
        ...
        {
            return this.dal.AddMake(trans, model);
        }
        ...
        public DataTable SelectMake(DateTime? startDate, DateTime? endDate, string storageCode, string treasuryName, string person)
        {
            StringBuilder builder = new StringBuilder();
            if (startDate.HasValue)
            {
            ...
            builder.Append(this.GetConditionByIsFirstMake());
            return this.dal.GetTable(builder.ToString());
        }
        private string GetConditionByIsFirstMake()
        {
            return " AND isfirst != 1  AND isfirst != 0";
        }
