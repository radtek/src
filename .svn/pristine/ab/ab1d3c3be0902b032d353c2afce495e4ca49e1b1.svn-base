<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShipDeploymentPlanList.aspx.cs" Inherits="Equ_ShipDeploymentPlan_ShipDeploymentPlanList" %>
...
<link type="text/css" rel="stylesheet" href="../../Script/jquery.tooltip/jquery.tooltip.css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function rowAdd() {
                parent.desktop.ShipDeploymentPlanEdit = window;
                var url = "/Equ/ShipDeploymentPlan/ShipDeploymentPlanEdit.aspx?action=add";
                toolbox_oncommand(url, "新增船机调配计划");
            }
            function rowEdit() {
                parent.desktop.ShipDeploymentPlanEdit = window;
                var url = "/Equ/ShipDeploymentPlan/ShipDeploymentPlanEdit.aspx?action=edit&id=" + $('#hfldId').val();
                toolbox_oncommand(url, "编辑船机调配计划");
            }
            function queryShipDeploymentPlan() {
                viewopen('/Equ/ShipDeploymentPlan/ShipDeploymentPlanView.aspx?ic=' + $('#hfldId').val(), 820, 500, '查看产值上报');
            }
...
<Columns><asp:TemplateField HeaderStyle-Width="20px"><HeaderTemplate>
                                                    ...
                                                    <span class="link" onclick="viewopen('ShipDeploymentPlanView.aspx?ic=',820,500)">
                                                        
                                                    </span>
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="申请提出日期"><ItemTemplate>
                                                    
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="设备编号"><ItemTemplate>
                                                    <span class="tooltip" title=''>
                                                        
                                                    </span>
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="挖深"><ItemTemplate>
                                                    
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="本月预算工程量" ItemStyle-CssClass="decimal_input"><ItemTemplate>
                                                    
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="本月预算油耗"><ItemTemplate>
