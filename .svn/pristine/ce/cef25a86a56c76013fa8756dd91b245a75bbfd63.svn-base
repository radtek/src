<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OutReserve.aspx.cs" Inherits="StockManage_Report_OutReserve" %>
<%@ Import Namespace="cn.justwin.BLL"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server"><title>出库报表</title><link rel="Stylesheet" type="text/css" href="../../Script/jquery.easyui/themes/default/easyui.css" />
			...
			<td>
				<table class="queryTable" cellpadding="3px" cellspacing="0px">
					...
					<tr style="height: 25px;">					
						...
						<td>
							<asp:TextBox ID="txtCorp" CssClass="select_input easyui-validatebox" Style="width: 120px;" data-options="validType:'validQueryChars[50]'" imgclick="pickCorp" runat="server"></asp:TextBox>
				...
				<table border="0" class="tab">
					...
					<tr>
						<td style="height: 100%; vertical-align: top;">
							<div class="">
								<asp:GridView ID="gvPurchaseplan" AutoGenerateColumns="false" CssClass="gvdata" AllowPaging="true" PageSize="5" OnPageIndexChanging="gvPurchaseplan_PageIndexChanging" DataKeyNames="orcode" runat="server"><Columns><asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px" HeaderStyle-HorizontalAlign="Right"><ItemTemplate>
												...
												<span class="al" onclick="viewopen('/StockManage/SmOutReserve/ViewReserve.aspx?ic=<%# Eval("orid") %>')">
													<%# Eval("orcode") %>
												</span>
