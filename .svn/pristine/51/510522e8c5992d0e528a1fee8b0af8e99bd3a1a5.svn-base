namespace com.jwsoft.pm.entpm.action
{
    ...
    public class MakeThumbnail : AnnexAction
    {
        ...
        private IntendancePhotoListAction intendancePhotoListAction;

        public MakeThumbnail()
        {
            this.intendancePhotoListAction = new IntendancePhotoListAction();
        }
        ...
        public int UpDateAnnex(Guid AnnexCode, string Remark)
        {
            StringBuilder builder = new StringBuilder();
