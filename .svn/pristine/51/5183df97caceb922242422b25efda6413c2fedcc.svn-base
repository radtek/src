...
<head id="Head1" runat="server"><title>退库报表</title><link rel="Stylesheet" type="text/css" href="../../Script/jquery.easyui/themes/default/easyui.css" />
				...
				<table border="0" class="tab">
					...
					<tr>
						<td style="height: 100%; vertical-align: top;">
							<div class="">
								<asp:GridView ID="gvPurchaseplan" AutoGenerateColumns="false" CssClass="gvdata" AllowPaging="true" PageSize="5" OnPageIndexChanging="gvPurchaseplan_PageIndexChanging" DataKeyNames="rcode" runat="server"><Columns><asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px" HeaderStyle-HorizontalAlign="Right"><ItemTemplate>
												<%# Container.DataItemIndex + 1 %>
											</ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="退库编号"><ItemTemplate>
												<span class="al" onclick="viewopen('/StockManage/Refunding/ViewRefunding.aspx?ic=<%# Eval("rid") %>&t=1','','')">
													<%# Eval("rcode") %>
												</span>
