namespace cn.justwin.stockBLL
{
    ...
    public class PtYhmcBll
    {
        ...
        public DataTable GetUserInfoByDepartBooks(string departmentId,  int year, int month)
        {
            return this.ptYhmcService.GetUserInfoByDepartBooks(departmentId, year, month);
        }
