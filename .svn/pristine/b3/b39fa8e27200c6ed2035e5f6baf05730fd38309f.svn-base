...
using System.Web.UI.WebControls;
	public partial class EquipAccountList : PageBase, IRequiresSessionState
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!base.IsPostBack)
			{
				...
				this.ViewState["A"] = "";
				this.ViewState["B"] = "";
				this.btnAdd.Attributes["onclick"] = "openEquipmentEdit('add')";
				this.btnUpd.Attributes["onclick"] = "openEquipmentEdit('upd')";
		...
		{
			int num = EquipmentAction.DelEquipment(new Guid(this.hdnEquipmentUniqueCode.Value.ToString()));
			if (num == 1)
			{
