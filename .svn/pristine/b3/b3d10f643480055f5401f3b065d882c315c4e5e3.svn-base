...
public partial class Equ_ShipOilWear_BudTaskList : NBasePage, IRequiresSessionState
{
	...
	protected void gvwResource_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		if (e.Row.RowType == DataControlRowType.DataRow)
		{
			...
			e.Row.Attributes["TaskCode"] = this.gvBudget.DataKeys[e.Row.RowIndex]["TaskCode"].ToString();
		}
	}
