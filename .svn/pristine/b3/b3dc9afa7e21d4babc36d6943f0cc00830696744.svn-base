<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VehicleType.aspx.cs" Inherits="oa_Vehicle_VehicleUserControl_VehicleType" %>
    ...
    <script type="text/javascript">
            ...
            for (var i = 0; i < anchor.length; i++) {
                if (anchor[i].getAttribute('title') == 'ContractType') {
                    anchor[i].onclick = function () {
                        ...
                        document.getElementById('hfldVehicleTypeID').value = typeId;
                        document.getElementById('hfldVehicleTypeName').value = typeName;
                        return false;
                    }
        ...
        function save() {
            if (top.ui.callback != null) {
                top.ui.callback({ name: $('#hfldVehicleTypeName').val(), code: $('#hfldVehicleTypeID').val() });
...
<body>
    ...
    <div class="pagediv">
        ...
        <asp:HiddenField ID="hfldVehicleTypeName" runat="server" />
