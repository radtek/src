...
<head runat="server"><title>支出合同付款报表</title><link href="../../Script/jquery.tooltip/jquery.tooltip.css" rel="Stylesheet" type="text/css" />
...
<Columns><asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px"><ItemTemplate>
                                ...
                                </ItemTemplate></asp:TemplateField><asp:BoundField HeaderText="签订人" DataField="SignPersonName" /><asp:BoundField DataField="ModifiedMoney" ItemStyle-HorizontalAlign="Right" HeaderText="最终金额" ItemStyle-CssClass="decimal_input" ItemStyle-Width="80px" /><asp:BoundField DataField="PaymentTotal" ItemStyle-HorizontalAlign="Right" HeaderText="付款累计" ItemStyle-CssClass="decimal_input" ItemStyle-Width="80px" /><asp:TemplateField HeaderText="实际付款累计" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Right" HeaderStyle-CssClass="decimal_input"><ItemTemplate>
                                    <%# WebUtil.SapRealContractMoney(Eval("ContractCode").ToString(), "C") %>
                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="百分比" ItemStyle-CssClass="percent"><ItemTemplate>
