namespace cn.justwin.DAL
{
    ...
    public class Bud_ConsTask : EntityObject
    {
        ...
        public cn.justwin.DAL.Bud_ConsReport Bud_ConsReport
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Bud_ConsReport>("Pm2Model.FK__Bud_ConsT__ConsR__61DC42C1", "Bud_ConsReport").Value;
            }
            set
            {
                this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Bud_ConsReport>("Pm2Model.FK__Bud_ConsT__ConsR__61DC42C1", "Bud_ConsReport").Value = value;
            }
        }
        ...
        public EntityReference<cn.justwin.DAL.Bud_ConsReport> Bud_ConsReportReference
        {
            get
            {
                return this.RelationshipManager.GetRelatedReference<cn.justwin.DAL.Bud_ConsReport>("Pm2Model.FK__Bud_ConsT__ConsR__61DC42C1", "Bud_ConsReport");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedReference<cn.justwin.DAL.Bud_ConsReport>("Pm2Model.FK__Bud_ConsT__ConsR__61DC42C1", "Bud_ConsReport", value);
                }
            }
        }
        ...
        public EntityCollection<cn.justwin.DAL.Bud_ConsTaskRes> Bud_ConsTaskRes
        {
            get
            {
                return this.RelationshipManager.GetRelatedCollection<cn.justwin.DAL.Bud_ConsTaskRes>("Pm2Model.FK__Bud_ConsT__ConsT__65ACD3A5", "Bud_ConsTaskRes");
            }
            set
            {
                if (value != null)
                {
                    this.RelationshipManager.InitializeRelatedCollection<cn.justwin.DAL.Bud_ConsTaskRes>("Pm2Model.FK__Bud_ConsT__ConsT__65ACD3A5", "Bud_ConsTaskRes", value);
                }
            }
        }
