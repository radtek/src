...
<body class="easyui-layout" style="text-align: center;" onselectstart="return false;">
	...
	<div id="top" data-options="region:'north',title:'',split:true">
		<div id="logo" style="border: 0px solid Red;">
			<img src="../UploadFiles\UserLogo\logo.jpg?time=<%=this.timeStr %>>" alt="工程项目管理软件" />
           <%-- <img src="../UploadFiles\UserLogo\<%=this.logo %>" style="float: left;height: 25px;margin-top: 9px;"/>
            <div style="font-family: 微软雅黑;font-size: 18px;font-weight: bold;color: #5190d5;margin-left: 5px;float: left;margin-top: 8px;">
                <%=this.logoName %>
            </div>--%>
		</div>
		...
		<div id="tabs" class="easyui-tabs" fit="true" border="false">
			<div class='my-desk' title="我的桌面" data-options="iconCls:'icon-reload'" style="overflow: auto;" id="/SysFrame2/Desktop.aspx">
				<div id='div_setting' style="height: 20px; text-align: right; padding-right: 6px;">
					<img id="Img_set" alt="设置桌面布局" title="设置桌面布局" src="/TableTop/image/bg_set.png" style="cursor: pointer" onclick="settingPanel();" />
					<img id="Img_add" alt="桌面栏目管理" title="桌面栏目管理" src="/TableTop/image/bg_add.png" style="cursor: pointer" onclick="mangerPanel();" class="header-cursor" /></div>
				<table id="tabPanels">
				</table>
			</div>
		</div>
	...
	<div id="div_about" title="关于工程项目管理软件" style="font-size: 12px; color: #212121;" data-options="modal:true, collapsible:false, maximizable:false, minimizable:false">
		<div style="padding-left: 30px; padding-top: 20px;">
			<%--<img alt="甲乙软件有限公司" src="/images/justwin.jpg" />--%>
		</div>
		<div style="padding-left: 30px; padding-top: 20px;">
		...
		<div style="padding-left: 30px; padding-top: 50px; color: #666; width: 250px; float: left;">
			版权所有 <span style="font-family: Arial;">&copy;2007-2017 </span>| <a id="a_about_jw"
				target="_blank" href="http://www.joyesoft.com/">大连甲乙软件有限公司</a>
		</div>
		<div id="div_btnok">
