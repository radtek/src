...
using System.Web.UI.WebControls;
	public partial class WorkCost_AimCompare : PageBase, IRequiresSessionState
	{
		...
		{
			string pc = this.ddl_pn.SelectedValue.ToString();
			this.dg_ManPower.DataSource = this.ca.GetWorkCost_AimCompareList(pc);
		...
		{
			this.ExportToExcel("application/ms-excel", "工程成本差异汇总表.xls");
		}
		protected void btnWord_Click(object sender, EventArgs e)
		{
			this.ExportToExcel("application/ms-excel", "工程成本差异汇总表.doc");
		}
		public void ExportToExcel(string FileType, string FileName)
		{
			...
			this.Tabledc.RenderControl(writer);
