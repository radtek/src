...
public partial class FileInfoManager_SetFileAleave : NBasePage, IRequiresSessionState
{
	...
	protected void trvwDepartment_SelectedNodeChanged(object sender, System.EventArgs e)
	{
		...
		this.gvwUser.DataSource = ptYhmcBll.GetAllModelByWhere(string.Format("where i_bmdm = {0} and State!=2 and v_yhdm!='00000000'", selectedValue));
