<%@ Page Language="C#" AutoEventWireup="true" CodeFile="showinfomationbak.aspx.cs" Inherits="ShowInfomation" %>
                ...
                <td width="366px" background="<%=this.strSkinPath %>/bg.gif">
                    <table cellspacing="0" cellpadding="0" width="366px" height="217px" align="center"
                        ...
                        <tr>
                            ...
                            <td height="23px">
                                <img src="<%=this.strSkinPath %>/title-6.gif" width="293px" height="23px" usemap="#Map2" />
                        ...
                        <tr>
                            ...
                            <td height="170px" valign="top">
                               ...
                               <asp:GridView ID="GVNews" AutoGenerateColumns="false" DataSourceID="SqlNews" Width="320px" GridLines="None" ShowHeader="false" OnRowDataBound="GVNews_RowDataBound" runat="server"><Columns><asp:TemplateField><ItemTemplate>
                                            ...
                                            </ItemTemplate></asp:TemplateField><asp:HyperLinkField DataTextField="v_xwbt" /><asp:BoundField DataField="dtm_fbsj" HeaderText="日期" DataFormatString="{0:yyyy-MM-dd}" /></Columns><RowStyle Font-Size="12px" ForeColor="#333333" CssClass="sys_default_liststyle"></RowStyle></asp:GridView>
                                
                                <asp:SqlDataSource ID="SqlNews" SelectCommand="SELECT TOP (6) i_xw_id, c_xwlxdm, txt_xwnr, v_xwbt, c_ttbj, convert(varchar(10),dtm_fbsj,20) as dtm_fbsj, c_sfyx, imageURL FROM Web_News WHERE (c_xwlxdm = @c_xwlxdm) AND c_sfyx =@c_sfyx  order by  dtm_fbsj desc" ConnectionString='<%$ ConnectionStrings:Sql %>' runat="server"><SelectParameters><asp:Parameter DefaultValue="99" Name="c_xwlxdm" Type="String" /><asp:Parameter DefaultValue="y" Name="c_sfyx" /></SelectParameters></asp:SqlDataSource>
                            </td>
                            <td width="15px">
                            </td>
                        </tr>
...
<Columns><asp:TemplateField><ItemTemplate>
    ...
    <area shape="rect" coords="252,2,290,20" href="javascript:toolbox_oncommand('/WEB/WebManagerList.aspx?c_xwlxdm=99&c_xwlxmc=公司新闻&browse=true','公司新闻');">
