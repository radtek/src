...
using System.Web.UI.WebControls;
	public partial class CorpTypeTreeView : PageBase, IRequiresSessionState
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!this.Page.IsPostBack)
			{
				...
				{
					this.TypeList = "";
					this.TVType_Create(treeNode, this.GetDataFromCollection(CorpTypeTreeView.CodingAct.QueryCodeInfoList(Convert.ToInt32(BasicType.CorpType), ValidState.Valid)), 0);
					return;
				}
				this.TypeList = base.Request["ts"];
				this.TVType_Create(treeNode, this.GetDataFromCollection(CorpTypeTreeView.CodingAct.QueryCorpTypeList(this.TypeList)), 0);
			}
		}
