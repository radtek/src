<%@ Page Language="C#" AutoEventWireup="true" CodeFile="contactcorpframe.aspx.cs" Inherits="ContactCorpFrame_aspx" %>
...
<HTML>
	...
	<frameset cols="150,*" frameborder="1" bordercolor="#cccccc" framespacing="5px;">
		<frame name="FraCorpType" src="CorpTypeTree.aspx?ts=&w=0&Audit='<%=Request["Audit"] %>'" frameborder="1">
