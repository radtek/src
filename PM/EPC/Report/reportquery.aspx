<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reportquery.aspx.cs" Inherits="ReportQuery" %>
...
<meta Content="http://schemas.microsoft.com/intellisense/ie5" Name="vs_targetSchema" />
		...
		<script language="javascript">
			function openQuery(reportid)
			{
				...
				return window.showModalDialog(url,window,"dialogHeight:500px;dialogWidth:430px;center:1;help:0;status:0;");
			}
		</script>
	</head>
	<body class="body_popup" scroll="no">
		<form id="Form1" method="post" runat="server">
			<table class="table-normal" height="100%" cellSpacing="0" cellPadding="0" width="100%">
				<tr class="td-search">
					<td height="24">&nbsp;&nbsp;
						<asp:Button ID="btnexecl" CssClass="button-normal" Text="导 出" OnClick="btnexecl_Click" runat="server" />&nbsp;
						<asp:Button ID="btnSearch" CssClass="button-normal" OnClick="btnSearch_Click" runat="server" /></td>
				</tr>
				<TR>
					<TD>
						<table class="table-normal" id="Table1" height="100%" cellspacing="0" cellpadding="0" width="100%" runat="server"><tr class="td-title" id="TRTitle" bgcolor="activeborder" height="24" runat="server"><td align="center" colspan="3" runat="server"><asp:Label ID="Lb_Title" runat="server"></asp:Label></td></tr><tr class="report_grid_head" id="TrHeader" bgcolor="Gainsboro" height="24" runat="server"><td align="left" width="33%" style="height: 24px" runat="server"><asp:Label ID="Lb_H1" runat="server"></asp:Label></td><td align="center" width="33%" style="height: 24px" runat="server"><asp:Label ID="Lb_H2" runat="server"></asp:Label></td><td align="right" width="33%" style="height: 24px" runat="server"><asp:Label ID="Lb_H3" runat="server"></asp:Label></td></tr><tr runat="server"><td valign="top" colspan="3" runat="server">
									<div style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 100%"><asp:DataGrid ID="dgdOrder" CssClass="grid" Width="1000px" runat="server"><AlternatingItemStyle CssClass="grid_row"></AlternatingItemStyle><ItemStyle CssClass="grid_row" BorderStyle="Solid"></ItemStyle><HeaderStyle Wrap="false" HorizontalAlign="Center" BorderColor="ControlText" CssClass="report_grid_head" BackColor="Gainsboro" Height="24px" BorderStyle="Solid"></HeaderStyle><Columns><asp:BoundColumn HeaderText="序号"></asp:BoundColumn></Columns></asp:DataGrid></div>
