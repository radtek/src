<%@ Page Language="C#" AutoEventWireup="true" CodeFile="taskedit111.aspx.cs" Inherits="taskedit111" %>


<HTML>
	<HEAD >
		<title>TaskEdit111</title>
		...
		<script language="javascript">
			...
			function getdata()
			{
			    ...
			    if (res.value!="")
			    {
                    ...
                    document.getElementById('hdnWbsType').value = 1;
			        document.getElementById('hdnType').value=2;
			        document.getElementById('lbParentCode').value=res[9];
                    document.getElementById('txtTaskCode').value=res[7];
                    document.getElementById('DateStart').value=res[12];
                    document.getElementById('DateEnd').value=res[13];
                    document.getElementById("txtUnit").value=res[10];
                    document.getElementById("txtQuantity").value=res[11];
                    document.getElementById('txtUnitPrice').value=res[14];
                    document.getElementById("txtTaskName").value =res[5];
                    document.getElementById('hdnProjectCode').value=res[2] 
                    document.getElementById("hdnProjectName").value =res[3];
                    document.getElementById("hdnPrjGuid").value=res[4];
                    document.getElementById("hdnParentCode").value =res[9];
	...
	<body class="body_clear" scroll="no" onload=getdata();>
					...
					<td>
						<table class="table-none" id="Table1" height="100%" cellSpacing="0" cellPadding="0" width="100%"
							...
							<tr class="td-toolsbar">
								...
								<td align="right"><STRONG><FONT color="#ff0000">注：同级任务编码不能重复，且必须为三位！&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
(元)</TD>
							...
							<TR>
								<TD class="td-submit" colSpan="6">
									...
									<INPUT class="button-normal" type="reset" value="取 消" onclick=window.close();>
