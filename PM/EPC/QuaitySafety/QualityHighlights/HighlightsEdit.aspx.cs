...
using System.Web.UI.WebControls;
	public partial class HighlightsEdit : NBasePage, IRequiresSessionState
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			if (!this.Page.IsPostBack)
			{
				...
				if (base.Request.QueryString["Type"] == "EDIT")
				{
					...
					{
						HighlightsEdit._showtitle = "修改质量亮点";
						HighlightsEdit._showAffairTitle = "质量亮点名称";
					}
					else
					{
		...
		protected void BtnSave_Click(object sender, EventArgs e)
		{
			...
			{
				this.JS.Text = "alert('" + HighlightsEdit._showAffairTitle + "不能为空！');";
				return;
			}
			...
			if (base.Request.QueryString["Type"] == "Add")
			{
				...
				base.RegisterScript("top.ui.tabSuccess({ parentName: '_HighlightsList' });");
				return;
			}
			else
			{
		...
		protected override void OnInit(EventArgs e)
		{
			...
			if (base.Request.QueryString["Type"] == "Add")
			{
				if (base.Request.QueryString["DatumClass"] == "8")
				{
					HighlightsEdit._showtitle = "新增质量亮点";
					HighlightsEdit._showAffairTitle = "质量亮点名称";
				}
				else
				{
					if (base.Request.QueryString["DatumClass"] == "9")
					{
						HighlightsEdit._showtitle = "新增质量活动";
						HighlightsEdit._showAffairTitle = "修改质量活动";
					}
				}
			}
			else
			{
				if (base.Request.QueryString["Type"] == "EDIT")
				{
					...
					else
					{
						if (base.Request.QueryString["DatumClass"] == "9")
						{
							HighlightsEdit._showtitle = "修改质量活动";
							HighlightsEdit._showAffairTitle = "修改质量活动";
						}
					}
				}
				else
				{
					if (base.Request.QueryString["Type"] == "SEE")
					{
						if (base.Request.QueryString["DatumClass"] == "8")
						{
							HighlightsEdit._showtitle = "查看质量亮点";
							HighlightsEdit._showAffairTitle = "质量亮点名称";
						}
						else
						{
							if (base.Request.QueryString["DatumClass"] == "9")
							{
								HighlightsEdit._showtitle = "查看质量活动";
								HighlightsEdit._showAffairTitle = "修改质量活动";
							}
						}
					}
