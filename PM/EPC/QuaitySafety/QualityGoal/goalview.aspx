<%@ Page Language="C#" AutoEventWireup="true" CodeFile="goalview.aspx.cs" Inherits="EPC_QuaitySafety_QualityGoal_goalview" %>
    ...
    <div class="divContent2">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%"  class="viewTable">
            <tr>
                ...
                <td class="elemTd">
                <asp:Literal ID="litGoal" runat="server"></asp:Literal>
                </td>
            </tr>
            <tr>
                <td class="descTd" style="white-space: nowrap;">
