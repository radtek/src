<%@ Page Language="C#" AutoEventWireup="true" CodeFile="costinputtop.aspx.cs" Inherits="CostInputShow" %>
...
<meta http-equiv="Expires" content="0" />
    ...
    <base target="_self">
		...
		{
		    var pmid=document.getElementById('Epmid').value;
			var url = "/CommonWindow/Select_CBS.aspx?type=2&pmid="+pmid;
    ...
    <form id="Form1" method="post" runat="server">
        <font face="宋体">
            <table class="table-normal" id="Table1" height="100%" width="100%" border="1">
                <tr>
                    <asp:HiddenField ID="Epmid" runat="server" />
                    <td style="height: 80px">
                        <table class="table-form" id="Table2" cellspacing="1" cellpadding="1" width="100%"
                            border="1">
                            <tr>
                                <td class="td-label" style="width: 17%; height: 28px;">
                                    费用项目</td>
                                <td class="text-input" style="width: 36%; height: 28px;">
                                    &nbsp;<asp:Label ID="lblItemName" Text="Label" runat="server"></asp:Label>
                                    </td>
                                <td class="td-label" style="width: 17%; height: 28px;">
                                    发生时间</td>
                                <td class="text-input" style="width: 30%; height: 28px;">
                            ...
                            <tr>
                                ...
                                <td class="text-input" style="width: 36%">
                                    &nbsp;<asp:Label ID="lblDept" Text="Label" runat="server"></asp:Label></td>
                                <td class="td-label" style="width: 17%">
                                    填报人</td>
                                <td class="text-input" style="width: 30%">
                                    &nbsp;<asp:Label ID="lblUser" Text="Label" runat="server"></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="td-label" style="width: 17%">
                                    经手人</td>
                                <td colspan="3" class="text-input" style="width: 36%">
                                    ...
                                    <input id="HdnPerson" type="hidden" name="HdnPerson" style="width: 20px" runat="server" />
...
<ItemTemplate>
                                            <asp:Label ID="lblPrice" Text='<%# Convert.ToString(Eval("Price", "{0:F2}")) %>' runat="server"></asp:Label>
                                        </ItemTemplate>
