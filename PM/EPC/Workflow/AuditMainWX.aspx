...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function auditSuccess() {
            alert('添加成功');
            //window.parent.parent.$("#TextBox1").val("");
            //alert(window.parent.parent.$("#TextBox1").val());
            //parent.parent.$("#TextBox1").val("1122");
            parent.parent.window.location = '/EPC/WorkFlow/PTAuditListWX.aspx';
            ////page_close();
                    ...
                    <table id="tableVersion" cellspacing="0" cellpadding="0" width="100%" border="1"
                        ...
                        <tr id="trResult">
                            <td class="td-label" colspan="2" style="white-space: nowrap; width: 90%;">
                                ...
                                <asp:RadioButtonList ID="RBLRoleType" RepeatDirection="Horizontal" RepeatLayout="Flow" runat="server">
                                    <asp:ListItem Selected="true" Value="1" Text="<span class='tooltip' title='通过'>通过</span>" />
                                    <asp:ListItem Value="-3" Text="<span class='tooltip' title='重报的数据可以修改后再次提交审核'>重报</span>" />
                                    <asp:ListItem Value="-2" Text="<span class='tooltip' title='驳回的数据不可以再次提交'>驳回</span>" />
                                </asp:RadioButtonList>
                                &nbsp; &nbsp; &nbsp;
							<asp:ImageButton ID="btnSubmit" Style="vertical-align: middle" Text="确 定" ImageUrl="~/images/auditimg.jpg" OnClick="btnSubmitWX_Click" runat="server" />
                                <asp:Label ID="Label1" Text="1122"  runat="server" onclick="auditSuccess()" Visible="false"></asp:Label>
                        ...
                        <tr id="trFront" style="display: none">
                            <td class="td-label" id="tdFront">选择前插人员
                            </td>
                            <td class="td-content">
                                <span class="spanSelect" style="width: 180px; float: left">
                                    <asp:TextBox ID="txtFrontPerson" Style="width: 155px; height: 15px; border: none; line-height: 16px; margin: 1px 0px 1px 2px;"
                        ...
                        <tr id="trAfter" style="display: none">
                            <td class="td-label">选择后插人员
                            </td>
                            <td class="td-content">
                                <span class="spanSelect" style="width: 180px; float: left">
                                    <asp:TextBox ID="txtAfterPerson" Style="width: 155px; height: 15px; border: none; line-height: 16px; margin: 1px 0px 1px 2px;"
                                        runat="server"></asp:TextBox>
                        ...
                        <tr id="tr_selector" style="display: none" runat="server">
                            <td class="td-label" style="white-space: nowrap" runat="server">请选择流程下一个审核人
                            </td>
                            <td class="td-content" style="white-space: nowrap;" runat="server">
                                <span class="spanSelect" style="width: 180px; float: left;">
                                    <asp:TextBox ID="txtnextperson" Style="width: 155px; height: 15px; border: none; line-height: 16px; margin: 1px 0px 1px 2px;"
                                        runat="server"></asp:TextBox>
                        ...
                        <tr id="trPass" visible="false" runat="server">
                            <td class="td-label" runat="server">
                        ...
                        <tr id="trAuditMain" style="display: ''; width: 100%;" runat="server">
                            <td class="td-label" runat="server">审核要点
                            </td>
                            <td class="td-content" style="padding-top: 2px; width: 80%;" runat="server">
                                <div id="divAuditMain" runat="server">
                                </div>
                            </td>
                        </tr>
                        <tr id="trAuditRemark" style="display: none; width: 100%">
                            <td class="td-label">审核要点
                            ...
                            <td class="td-content" style="padding-top: 2px; height: 120px; width: 80%;">
                                <textarea id="txtAuditRemark" class="wysiwyg" cols="40" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr id="trAuditInfo" style="display:none;">
                            <td class="td-label">审核意见
                            </td>
                            <td class="td-content" style="padding-top: 2px; height: 30px">
                                <textarea id="txtAuditInfo" class="wysiwyg" cols="20" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr id="trUpFiles" style="display:none;">
                            <td class="td-label">相关附件
                            </td>
                        ...
                        <tr id="trAnnouncer" style="display:none;">
                            <td class="td-label">告知人
                            </td>
                            <td class="td-content">
                                <span class="spanSelect" style="width: 320px">
                                    <asp:TextBox ID="txtAnnouncer" Style="width: 295px; height: 15px; border: none; line-height: 16px; margin: 1px 0px 1px 2px;"
                                        runat="server"></asp:TextBox>
                        ...
                        <tr id="trContent" style="display:none;">
                            <td class="td-label">告知内容
                            </td>
                            <td class="td-content" style="padding-top: 2px; height: 60px; width: 80%">
                                <textarea id="txtContent" class="wysiwyg" cols="40" runat="server"></textarea>
                            </td>
                        </tr>
                        <tr id="trSend" style="display:none;">
                            <td></td>
                            <td class="td-content">
