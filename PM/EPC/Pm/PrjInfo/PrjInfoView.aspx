<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrjInfoView.aspx.cs" Inherits="EPC_Pm_PrjInfo_PrjInfoView" %>
...
<head runat="server"><title>项目内容</title>
        ...
        <table id="Table1" width="100%" border="1" class="table-form" style="border-collapse: collapse">
            <tr class="td-title">
                <td width="9%" colspan="6" align=center>
                    --基本内容--
                    <asp:HiddenField ID="hdfPrjGuid" runat="server" />
                    </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="5">
                    ...
                    <asp:TextBox ID="Labprjinfo" TextMode="MultiLine" Width="100%" ReadOnly="true" Rows="8" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="td-label" style="width: 119px">
                    备注:</td>
                <td colspan="5">
                    <font face="宋体">
                        <asp:TextBox ID="LabRemark" ReadOnly="true" TextMode="MultiLine" Width="100%" Rows="5" runat="server"></asp:TextBox></font></td>
            </tr>
            <tr>
                <td class="td-label" style="width: 119px">
                    相关附件</td>
            ...
            <tr>
                ...
                <td colspan="5">
                    <font face="宋体">
                        ...
                        <asp:TextBox ID="LabOtherStatement" Rows="2" TextMode="MultiLine" Width="100%" ReadOnly="true" runat="server"></asp:TextBox></font></td>
            </tr>
            <tr>
