...
using System.Web.UI.WebControls;
	public partial class UCProjectList : System.Web.UI.UserControl
	{
		...
		private void BindProjectYear()
		{
			...
			{
				int num = (projectYears.Rows[0]["BeginYear"] == System.DBNull.Value) ? System.DateTime.Today.Year : int.Parse(projectYears.Rows[0]["BeginYear"].ToString());
				int num2 = (projectYears.Rows[0]["EndYear"] == System.DBNull.Value) ? System.DateTime.Today.Year : int.Parse(projectYears.Rows[0]["EndYear"].ToString());
		...
		private void TrvPrj_Year()
		{
			...
			{
				int num = (prjYears.Rows[0]["BeginYear"] == System.DBNull.Value) ? System.DateTime.Today.Year : int.Parse(prjYears.Rows[0]["BeginYear"].ToString());
				int num2 = (prjYears.Rows[0]["EndYear"] == System.DBNull.Value) ? System.DateTime.Today.Year : int.Parse(prjYears.Rows[0]["EndYear"].ToString());
				for (int i = num; i <= num2; i++)
				{
					this.ddlYear.Items.Add(new ListItem(i.ToString() + "年度", i.ToString()));
				}
