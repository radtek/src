...
using System.Web.UI.WebControls;
	public partial class ScheduleCompleteQueryInfo : PageBase, IRequiresSessionState
	{
		...
		private void Init_theSchedule(Guid versionCode)
		{
			...
			this._DtSchedule.Columns.Add(new DataColumn("Je", typeof(string)));
			this._DtSchedule.Columns.Add(new DataColumn("CompleteJeCount", typeof(string)));
			this._DtSchedule.Columns.Add(new DataColumn("SumCompleteJe", typeof(string)));
			this._DtSchedule.Columns.Add(new DataColumn("LeaveJe", typeof(string)));
			this._DtSchedule.Columns.Add(new DataColumn("IsHaveChild", typeof(string)));
			DataTable scheduleCompleteQuantityList = this.bta.GetScheduleCompleteQuantityList1(this.ProjectCode);
			for (int i = 0; i < scheduleCompleteQuantityList.Rows.Count; i++)
			{
				...
				dataRow["CompleteCount"] = scheduleCompleteQuantityList.Rows[i]["CompleteCount"].ToString();
				dataRow["SumCompleteQuantity"] = scheduleCompleteQuantityList.Rows[i]["SumCompleteQuantity"].ToString();
				dataRow["LeaveQuantity"] = scheduleCompleteQuantityList.Rows[i]["LeaveQuantity"].ToString();
				dataRow["Je"] = scheduleCompleteQuantityList.Rows[i]["Je"].ToString();
				dataRow["CompleteJeCount"] = scheduleCompleteQuantityList.Rows[i]["CompleteJeCount"].ToString();
				dataRow["SumCompleteJe"] = scheduleCompleteQuantityList.Rows[i]["SumCompleteJe"].ToString();
				dataRow["LeaveJe"] = scheduleCompleteQuantityList.Rows[i]["LeaveJe"].ToString();
		...
		private void tblSchedule_Draw(DataTable dt)
		{
			...
			for (int i = 0; i < dt.Rows.Count; i++)
			{
				...
				tableCell = new TableCell();
				tableCell.HorizontalAlign = HorizontalAlign.Right;
				tableCell.Text = dataRow["CompleteCount"].ToString() + "%";
				...
				tableRow.Cells.Add(tableCell);
				tableCell = new TableCell();
				tableCell.Text = dataRow["Je"].ToString();
				tableCell.Width = Unit.Pixel(70);
				tableCell.HorizontalAlign = HorizontalAlign.Right;
				tableCell.Wrap = false;
				tableRow.Cells.Add(tableCell);
				tableCell = new TableCell();
				tableCell.Text = dataRow["SumCompleteJe"].ToString();
				tableCell.Width = Unit.Pixel(70);
				tableCell.HorizontalAlign = HorizontalAlign.Right;
				tableCell.Wrap = false;
				tableRow.Cells.Add(tableCell);
				tableCell = new TableCell();
				tableCell.HorizontalAlign = HorizontalAlign.Right;
				tableCell.Text = dataRow["CompleteJeCount"].ToString() + "%";
				tableCell.Width = Unit.Pixel(50);
				tableCell.Wrap = false;
				tableRow.Cells.Add(tableCell);
				tableCell = new TableCell();
				tableCell.Text = dataRow["LeaveJe"].ToString();
				tableCell.Width = Unit.Pixel(70);
				tableCell.HorizontalAlign = HorizontalAlign.Right;
				tableCell.Wrap = false;
				tableRow.Cells.Add(tableCell);
