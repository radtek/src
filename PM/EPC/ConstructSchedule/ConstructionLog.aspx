<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConstructionLog.aspx.cs" Inherits="TypeList" %>
...
<meta http-equiv="Pragma" content="no-cache" />
    ...
    <script language="javascript">
     window.onload = function() {
            ...
            setButton(purchasePlanTable, 'BtnDel', 'BtnEdit', 'BtnLook', 'hfldConstruct')
            }
	        ...
	        {	
		        ...
		        if (op==2)
		        {
			        LogId = document.getElementById('hfldConstruct').value;
			        title="修改施工日志";
		        }
		        else if (op==3)
		        {
		        ...
		        var url= "/epc/ConstructSchedule/ConstructionLogAdd.aspx?t=" + op  + "&LogId="+ LogId + "&title=" + escape(pageTitle) + "&pmId= "+ document.getElementById('hdnPmId').value ;
            ...
            <td style="vertical-align: top;" width="100%">
                <table class="queryTable" cellpadding="3px" cellspacing="0px">
                    <tr>
                        ...
                        <td>
                            <JWControl:DateBox ID="workdate" runat="server"></JWControl:DateBox>
                        </td>
                        <td>
...
&nbsp;&nbsp;&nbsp;
                <asp:Button ID="BtnAdd" CssClass="button-normal" Text="新  增" runat="server" />&nbsp;
                <asp:Button ID="BtnEdit" CssClass="button-normal" Text="编  辑" Enabled="false" runat="server" />&nbsp;
                <asp:Button ID="BtnDel" CssClass="button-normal" Text="删  除" Enabled="false" OnClick="BtnDel_Click" runat="server" />
                <asp:Button ID="BtnLook" Text="查看" Enabled="false" runat="server" />
            </td>
        </tr>
        <tr>
...
<ItemTemplate>
                              <span class="link" onclick="Query('<%# Eval("logid").ToString() %>')">
      <%# Eval("code") %></span> 
                            </ItemTemplate>
