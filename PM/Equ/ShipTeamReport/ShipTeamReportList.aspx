<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShipTeamReportList.aspx.cs" Inherits="Equ_ShipTeamReport_ShipTeamReportList" %>
...
<head runat="server"><title>船机台班上报</title><link type="text/css" rel="stylesheet" href="../../Script/jquery.easyui/themes/default/easyui.css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnQuery').click(function () {
                var url = '/Equ/ShipTeamReport/ShipTeamReportView.aspx?ic=' + $('#hfldIdsChecked').val();
                viewopen(url, '查看船机台班上报');
            });
        ...
        function openNewTab(action) {
            var title = '新增船机台班上报';
            parent.desktop.ShipTeamReportEdit = window;
            var urlStr = '/Equ/ShipTeamReport/ShipTeamReportEdit.aspx?' + new Date().getTime() + '&action=' + action;
            if (action == 'edit') {
        ...
        //标签页查看
        function Query(id) {
            parent.desktop.ShipTeamReportView = window;
            var url = '/Equ/ShipTeamReport/ShipTeamReportView.aspx?ic=' + id;
            toolbox_oncommand(url, "查看船机台班上报");
        }
        // 选择项目
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border: 0px; width: 100%;
            ...
            <tr>
                <td class="divFooter" style="text-align: left;">
                    ...
                    <MyUserControl:epc_usercontrol1_wf_ascx ID="WF1" BusiClass="001" BusiCode="152" runat="server" />
                </td>
            </tr>
            <tr>
                <td style="width: 100%;">
...
<Columns><asp:TemplateField HeaderStyle-Width="20px"><HeaderTemplate>
                                                ...
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="台班数" ItemStyle-CssClass="decimal_input"><ItemTemplate>
                                                    
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="台班时间" ItemStyle-CssClass="decimal_input"><ItemTemplate>
                                                    
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="产量" ItemStyle-CssClass="decimal_input"><ItemTemplate>
                                                    
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="类型" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px"><ItemTemplate>
