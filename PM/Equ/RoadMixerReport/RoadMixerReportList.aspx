<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoadMixerReportList.aspx.cs" Inherits="Equ_RoadMixerReport_RoadMixerReportList" %>
...
<head runat="server"><title>搅拌车上报</title><link type="text/css" rel="stylesheet" href="../../Script/jquery.easyui/themes/default/easyui.css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnQuery').click(function () {
                var url = '/Equ/RoadMixerReport/RoadMixerReportView.aspx?ic=' + $('#hfldIdsChecked').val();
                viewopen(url, '查看搅拌车上报');
            });
        ...
        function openNewTab(action) {
            var title = '新增搅拌车上报';
            parent.desktop.RoadMixerReportEdit = window;
            var urlStr = '/Equ/RoadMixerReport/RoadMixerReportEdit.aspx?' + new Date().getTime() + '&action=' + action;
            if (action == 'edit') {
        ...
        //标签页查看
        function Query(id) {
            parent.desktop.RoadMixerReportView = window;
            var url = '/Equ/RoadMixerReport/RoadMixerReportView.aspx?ic=' + id;
            toolbox_oncommand(url, "查看搅拌车上报");
        }
        // 选择项目
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border: 0px; width: 100%;
            ...
            <tr>
                <td class="divFooter" style="text-align: left;">
                    ...
                    <MyUserControl:epc_usercontrol1_wf_ascx ID="WF1" BusiClass="001" BusiCode="162" runat="server" />
                </td>
            </tr>
            <tr>
                <td style="width: 100%;">
...
<Columns><asp:TemplateField HeaderStyle-Width="20px"><HeaderTemplate>
                                                ...
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="司机"><ItemTemplate>
                                                    
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="车数" ItemStyle-CssClass="decimal_input"><ItemTemplate>
                                                    
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="出库方数" ItemStyle-CssClass="decimal_input"><ItemTemplate>
                                                    
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="现场确认方数" ItemStyle-CssClass="decimal_input"><ItemTemplate>
