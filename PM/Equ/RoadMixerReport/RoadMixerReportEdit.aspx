<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoadMixerReportEdit.aspx.cs" Inherits="Equ_RoadMixerReport_RoadMixerReportEdit" %>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server"><title>编辑搅拌车上报</title>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnCancel').click(function () {
                winclose('RoadMixerReportEdit', 'RoadMixerReportList.aspx', false);
            });
        });
        // 选择项目
        ...
        function selectUser(type) {
            if (type == 'driver')
                jw.selectOneUser({ nameinput: 'txtDriver', codeinput: 'hfldDriver' });
            else if (type == 'exworksUser')
                jw.selectOneUser({ nameinput: 'txtExworksUser', codeinput: 'hfldExworksUser' });
            else if (type == 'chargeMan')
                jw.selectOneUser({ nameinput: 'txtChargeMan', codeinput: 'hfldChargeMan' });
        }
        //选择任务
        function selectTask() {
    ...
    <div id="divContent2" class="divContent2">
        <table class="tableContent2" cellpadding="5px" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    <span class="spanSelect" style="width: 100%">
                        <input type="text" id="txtDriver" readonly="readonly" style="width: 87%;
                            height: 15px; border: none; line-height: 16px; margin: 1px 2px" runat="server" />

                        <img src="../../images/icon.bmp" style="float: right;" alt="选择" id="img1" onclick="selectUser('driver');" runat="server" />

                        <asp:HiddenField ID="hfldDriver" runat="server" />
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <span class="spanSelect" style="width: 100%">
                        <input type="text" id="txtExworksUser" readonly="readonly" style="width: 87%;
                            height: 15px; border: none; line-height: 16px; margin: 1px 2px" runat="server" />

                        <img src="../../images/icon.bmp" style="float: right;" alt="选择" id="img2" onclick="selectUser('exworksUser');" runat="server" />

                        <asp:HiddenField ID="hfldExworksUser" runat="server" />
                    </span>
                </td>
                <td class="word">
                    现场确认方数
                ...
                <td>
                    <asp:TextBox ID="txtAffirmCubeQty" Height="15px" Width="100%" Text="0.000" CssClass="decimal_input" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="word">
                ...
                <td>
                    <asp:TextBox ID="txtAssociater" Height="15px" Width="100%" runat="server"></asp:TextBox>
                </td>
                <td class="word">
                    现场负责人
                </td>
                <td>
                    <span class="spanSelect" style="width: 100%">
                        <input type="text" id="txtChargeMan" readonly="readonly" style="width: 87%;
                            height: 15px; border: none; line-height: 16px; margin: 1px 2px" runat="server" />

                        <img src="../../images/icon.bmp" style="float: right;" alt="选择" id="imgName" onclick="selectUser('chargeMan');" runat="server" />
