<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoadElseReportList.aspx.cs" Inherits="Equ_RoadElseReport_RoadElseReportList" %>
...
<head runat="server"><title>其他设备上报</title><link type="text/css" rel="stylesheet" href="../../Script/jquery.easyui/themes/default/easyui.css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnQuery').click(function () {
                var url = '/Equ/RoadElseReport/RoadElseReportView.aspx?ic=' + $('#hfldIdsChecked').val();
                viewopen(url, '查看其他设备上报');
            });
        ...
        function openNewTab(action) {
            var title = '新增其他设备上报';
            parent.desktop.RoadElseReportEdit = window;
            var urlStr = '/Equ/RoadElseReport/RoadElseReportEdit.aspx?' + new Date().getTime() + '&action=' + action;
            if (action == 'edit') {
        ...
        //标签页查看
        function Query(id) {
            parent.desktop.RoadElseReportView = window;
            var url = '/Equ/RoadElseReport/RoadElseReportView.aspx?ic=' + id;
            toolbox_oncommand(url, "查看其他设备上报");
        }
        // 选择项目
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border: 0px; width: 100%;
            ...
            <tr>
                <td class="divFooter" style="text-align: left;">
                    ...
                    <MyUserControl:epc_usercontrol1_wf_ascx ID="WF1" BusiClass="001" BusiCode="165" runat="server" />
                </td>
            </tr>
            <tr>
                <td style="width: 100%;">
