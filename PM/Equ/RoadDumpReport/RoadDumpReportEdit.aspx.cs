...
public partial class Equ_RoadDumpReport_RoadDumpReportEdit : NBasePage, IRequiresSessionState
{
	...
	protected void btnSave_Click(object sender, System.EventArgs e)
	{
		try
		{
			...
			stringBuilder.Append("winclose('RoadDumpReportEdit', 'RoadDumpReportList.aspx', true)");
