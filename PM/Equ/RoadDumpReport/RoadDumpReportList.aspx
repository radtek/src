<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoadDumpReportList.aspx.cs" Inherits="Equ_RoadDumpReport_RoadDumpReportList" %>
...
<head runat="server"><title>自卸车上报</title><link type="text/css" rel="stylesheet" href="../../Script/jquery.easyui/themes/default/easyui.css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnQuery').click(function () {
                var url = '/Equ/RoadDumpReport/RoadDumpReportView.aspx?ic=' + $('#hfldIdsChecked').val();
                viewopen(url, '查看自卸车上报');
            });
        ...
        function openNewTab(action) {
            var title = '新增自卸车上报';
            parent.desktop.RoadDumpReportEdit = window;
            var urlStr = '/Equ/RoadDumpReport/RoadDumpReportEdit.aspx?' + new Date().getTime() + '&action=' + action;
            if (action == 'edit') {
        ...
        function Query(id) {
            ...
            var url = '/Equ/RoadDumpReport/RoadDumpReportView.aspx?ic=' + id;
            toolbox_oncommand(url, "查看自卸车上报");
        }
        // 选择项目
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border: 0px; width: 100%;
            ...
            <tr>
                <td class="divFooter" style="text-align: left;">
                    ...
                    <MyUserControl:epc_usercontrol1_wf_ascx ID="WF1" BusiClass="001" BusiCode="160" runat="server" />
                </td>
            </tr>
            <tr>
                <td style="width: 100%;">
...
<Columns><asp:TemplateField HeaderStyle-Width="20px"><HeaderTemplate>
                                                ...
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="地磅房"><ItemTemplate>
                                                    <span class="tooltip" title=''>
                                                        
                                                    </span>
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="流水号"><ItemTemplate>
                                                    <span class="tooltip" title=''>
                                                        
                                                    </span>
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="货名"><ItemTemplate>
                                                    <span class="tooltip" title=''>
