...
public partial class Equ_RoadDrainReport_RoadDrainReportEdit : NBasePage, IRequiresSessionState
{
	...
	protected void btnSave_Click(object sender, System.EventArgs e)
	{
		try
		{
			...
			stringBuilder.Append("winclose('RoadDrainReportEdit', 'RoadDrainReportList.aspx', true)");
