...
public partial class Equ_ShipMudReport_ShipMudReportEdit : NBasePage, IRequiresSessionState
{
	...
	protected void btnSave_Click(object sender, System.EventArgs e)
	{
		try
		{
			...
			stringBuilder.Append("winclose('ShipMudReportEdit', 'ShipMudReportList.aspx', true)");
