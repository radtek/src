<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShipMudReportEdit.aspx.cs" Inherits="Equ_ShipMudReport_ShipMudReportEdit" %>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server"><title>编辑泥驳船上报</title>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnCancel').click(function () {
                winclose('ShipMudReportEdit', 'ShipMudReportList.aspx', false);
            });
        });
        // 选择项目
    ...
    <div id="divContent2" class="divContent2">
        <table class="tableContent2" cellpadding="5px" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtMudTotalQty" Height="15px" Width="100%" Text="0.000" CssClass="decimal_input" runat="server"></asp:TextBox>
                </td>
                <td class="word">
                    开单员
                </td>
