<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DrillMonthReport.aspx.cs" Inherits="Equ_Report_Land_DrillMonthReport" %>
...
<link href="../../../Script/jquery.tooltip/jquery.tooltip.css" rel="Stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        ...
        function setWidthHeight() {
            $('#divBudget').height($(this).height() - 40);
            $('#divBudget').width($('#divContent').width() - 2);
        }
        //查看钻孔机产量明细表
        function Query(id) {
            parent.desktop.DrillDetailReport = window;
            var year = $('select#ddlYear  option:selected').val();
            var month = $('select#ddlMonth  option:selected').val();
            var date = year + "-" + month + "-01";
            var url = '/Equ/Report/Land/DrillDetailReport.aspx?equId=' + id + "&date=" + date;
            toolbox_oncommand(url, "查看钻孔机产量明细表");
        }
    </script>
</head>
<body>
