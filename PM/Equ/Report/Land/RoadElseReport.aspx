<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoadElseReport.aspx.cs" Inherits="Equ_Report_Land_RoadElseReport" %>
...
<head runat="server"><title>其他设备日机械产量报表（按产量上报）</title><link type="text/css" rel="stylesheet" href="../../../Script/jquery.easyui/themes/default/easyui.css" />
...
<link type="text/css" rel="stylesheet" href="../../../Script/jquery.tooltip/jquery.tooltip.css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var jwTable = new JustWinTable('gvwRoadElse');
            replaceEmptyTable('emptyRoadElse', 'gvwRoadElse');
            // 显示被截取的信息
            jw.tooltip();
        })
        // 选择项目
        ...
        <tr>
            <td style="vertical-align: top;">
                <div class="pagediv" style="width: 100%">
                    <asp:GridView ID="gvwRoadElse" AutoGenerateColumns="false" CssClass="gvdata" Width="100%" ShowFooter="true" OnRowDataBound="gvwRoadElse_RowDataBound" runat="server">
<EmptyDataTemplate>
                            <table id="emptyRoadElse">
                                <tr class="header">
                                    <th style="width: 25px;">
                                        序号
                                    </th>
