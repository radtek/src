...
using Wuqi.Webdiyer;
public partial class Equ_Report_Land_RoadInterlockReport : NBasePage, IRequiresSessionState
{
	...
	protected void gvwInterlock_RowDataBound(object sender, GridViewRowEventArgs e)
	{
	...
	public DataTable GetTitleByTable(DataTable dt)
	{
		...
		{
			dt.Columns["EquCode"].ColumnName = "预制联锁块设备编号";
		}
