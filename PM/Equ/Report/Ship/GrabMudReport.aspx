<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GrabMudReport.aspx.cs" Inherits="Equ_Report_Ship_GrabMudReport" %>
...
<head runat="server"><title>抓斗船，泥驳船产量表</title><link type="text/css" rel="stylesheet" href="../../../Script/jquery.easyui/themes/default/easyui.css" />
...
<link type="text/css" rel="stylesheet" href="../../../Script/jquery.tooltip/jquery.tooltip.css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var jwTable = new JustWinTable('gvwGrabMudReport');
            replaceEmptyTable('emptyGrabMudReport', 'gvwGrabMudReport');
            // 显示被截取的信息
            jw.tooltip();
        })
        // 选择项目
            ...
            <td>
                <table class="queryTable" cellpadding="3px" cellspacing="0px">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtGrabShipCode" Width="100%" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="vertical-align: top;">
                <div class="pagediv" style="width: 100%">
                    <asp:GridView ID="gvwGrabMudReport" AutoGenerateColumns="false" CssClass="gvdata" Width="100%" ShowFooter="true" OnRowDataBound="gvwGrabMudReport_RowDataBound" runat="server">
<EmptyDataTemplate>
                            <table id="emptyGrabMudReport">
                                <tr class="header">
...
<Columns><asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px"><ItemTemplate>
                                ...
                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="抓斗船编号"><ItemTemplate>
                                    <span class="tooltip" title=''>
