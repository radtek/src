<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RepairPlanList.aspx.cs" Inherits="Equ_Repair_RepairPlanList" %>
...
<head runat="server"><title>维修保养计划</title><link type="text/css" rel="stylesheet" href="../../Script/jquery.easyui/themes/default/easyui.css" />
...
<link type="text/css" rel="stylesheet" href="../../Script/jquery.tooltip/jquery.tooltip.css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var jwTable = new JustWinTable('gvRepairPlan');
            replaceEmptyTable('emptyRepairPlan', 'gvRepairPlan');
            ...
            $('#btnQuery').click(function () {
                var url = '/Equ/Repair/RepairPlanView.aspx?ic=' + $('#hfldIdsChecked').val();
                viewopen(url, '查看维修保养计划');
            });
        ...
        function openNewTab(action) {
            var title = '新增维修保养计划';
            parent.desktop.RepairPlanEdit = window;
            var urlStr = '/Equ/Repair/RepairPlanEdit.aspx?' + new Date().getTime() + '&action=' + action + '&equipmentType=' + $('#hfldEquipmentType').val();
            if (action == 'edit') {
        ...
        function Query(id) {
            ...
            var url = '/Equ/Repair/RepairPlanView.aspx?ic=' + id;
            toolbox_oncommand(url, "查看维修保养计划");
        }
    </script>
</head>
<body>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border: 0px; width: 100%;
            ...
            <tr>
                <td class="divFooter" style="text-align: left;">
                    ...
                    <MyUserControl:epc_usercontrol1_wf_ascx ID="WF1" BusiClass="001" BusiCode="145" runat="server" />
                </td>
            </tr>
            <tr>
                <td style="width: 100%;">
                    <table class="tab">
                        <tr>
                            <td style="height: 100%; vertical-align: top;">
                                <div class="">
                                    <asp:GridView ID="gvRepairPlan" CssClass="gvdata" AutoGenerateColumns="false" OnRowDataBound="gvRepairPlan_RowDataBound" DataKeyNames="Id" runat="server">
<EmptyDataTemplate>
                                            <table id="emptyRepairPlan" class="gvdata">
                                                <tr class="header">
...
<Columns><asp:TemplateField HeaderStyle-Width="20px"><HeaderTemplate>
                                                ...
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="维修计划编号"><ItemTemplate>
                                                ...
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="计划维修内容"><ItemTemplate>
                                                    <span class="tooltip" title=''>
                                                        
                                                    </span>
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="计划维修费用" ItemStyle-CssClass="decimal_input" ItemStyle-Width="50px"><ItemTemplate>
                                                    
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="计划开始日期" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px"><ItemTemplate>
                                                    
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="计划结束日期" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px"><ItemTemplate>
