<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EquDeployPlanEdit.aspx.cs" Inherits="Equ_EquDeployPlan_EquDeployPlanEdit" %>
...
<link type="text/css" rel="stylesheet" href="../../Script/jquery.easyui/themes/icon.css" />
    ...
    <script type="text/javascript">
        ...
        function btnCancelClick() {
            winclose('EquDeployPlanEdit', 'EquDeployPlanList.aspx', false);
        }
        // 选择设备需求计划
        function selectRequirePlan() {
            var url = '/Equ/EquDeployPlan/SelectRequirePlan.aspx?' + new Date().getDate();
            top.ui.callback = function (requirePlanInfo) {
                $('#hfldRequirePlanId').val(requirePlanInfo.id);
                $('#txtRequirePlanCode').val(requirePlanInfo.code);
            };
            top.ui.openWin({ title: '选择设备需求计划', url: url, width: 1000, height: 500 });
        }
        // 选择设备
        ...
        function setDisabled() {
            $('#txtRequirePlanCode').attr('readonly', 'readonly');
            ...
            $('#txtSpecification').attr('readonly', 'readonly');
        }
    </script>
</head>
<body>
    ...
    <div>
        <table class="tableContent2" cellpadding="5px" cellspacing="0">
            <tr>
                ...
                <td class="txt mustInput">
                    <span class="spanSelect" style="width: 100%">
                        <asp:TextBox ID="txtRequirePlanCode" CssClass="{required:true, messages:{required:'设备需求计划编号不能为空'}}" data-options="validType:'validQueryChars[50]'" Style="width: 88%; height: 15px;
                            border: none; line-height: 16px; margin: 1px 0px 1px 2px;" runat="server"></asp:TextBox>
                        <img alt="选择项目" onclick="selectRequirePlan();" src="../../../images/icon.bmp" style="float: right;" />
                    </span>
                    <asp:HiddenField ID="hfldRequirePlanId" runat="server" />
                </td>
            </tr>
            <tr>
                <td class="word">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox type="text" ID="txtSump" CssClass="decimal_input" Style="width: 100%" runat="server"></asp:TextBox>
                </td>
                <td class="word">
                    台班
                </td>
                <td>
                    <asp:TextBox type="text" ID="txtMachineTeam" CssClass="decimal_input" Style="width: 100%" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="word">
                ...
                <td>
                    <asp:DropDownList ID="dropEquSource" Width="100%" runat="server"><asp:ListItem Text="承租" /><asp:ListItem Text="出租" /><asp:ListItem Text="采购" /><asp:ListItem Text="内部调配" /></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td class="word">
