<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SmMaterialBackAdd.aspx.cs" Inherits="StockManage_MaterialBack_SmMaterialBackAdd" %>
<%@ Import Namespace="com.jwsoft.web.WebControls"%>
<%@ Register TagPrefix="MyUserControl" TagName="stockmanage_common_picktreasury_ascx" Src="~/StockManage/Common/PickTreasury.ascx" %>
...
<head id="Head1" runat="server"><title>材料退库</title>
 ...
 <script type="text/javascript" >
  ...
  {
     var chk=new JustWinTable('gvSmMaterialBack');
     setBtnState();
  }
  //取得出库单列表
  function addResource()
  {
      var url="MaterialOutList.aspx";
      winopen(url);
  }
    </script>
</head>
<body>
    <form id="form1" runat="server">
        <table  width="100%">
                        ...
                        <tr>
                         ...
                         <tr>
                             ...
                             <td style="width: 20%">
                                 仓库编码</td>
                             <td style="width: 30%">
                                 <MyUserControl:stockmanage_common_picktreasury_ascx ID="PickTreasury1" runat="server" />
                             </td>
                         </tr>
                        <tr>
                            <td style="width: 20%">
            ...
            <tr>
                <td class="bottonrow">
                    <input id="btnAddMaterial" type="button" value="从出库单选择" onclick="addResource();" runat="server" />

                    <input id="btnDelMaterial" type="button" value="删除" runat="server" />

                    <asp:Button ID="btnShowMaterial" Text="Button" OnClick="btnShowMaterial_Click" runat="server" />
...
</asp:TemplateField><asp:TemplateField HeaderText="资源编号"><ItemTemplate><%# DataBinder.Eval(Container.DataItem, "ResourceCode") %></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="资源名称"><ItemTemplate><%# DataBinder.Eval(Container.DataItem, "ResourceName") %></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="规格"><ItemTemplate><%# DataBinder.Eval(Container.DataItem, "Specification") %></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="单位"><ItemTemplate><%# DataBinder.Eval(Container.DataItem, "UnitName") %></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="供应商"><ItemTemplate><%# DataBinder.Eval(Container.DataItem, "UnitName") %></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="退库数量"><ItemTemplate>
