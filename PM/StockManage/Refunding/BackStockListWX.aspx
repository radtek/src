    ...
    <form id="form1" runat="server">
        <table class="tab" style="width: 100%;">
            <tr style="display: none;">
                <td class="divHeader">从出库单选择退库物资
                </td>
            </tr>
            <tr>
                <td style="height: 30px;">起始时间
            ...
            <tr>
                <td style="height: 30px;">  结束时间
                <asp:TextBox ID="txtEndTime" Width="115px" onclick="WdatePicker()" runat="server"></asp:TextBox></td>
            </tr>
             <tr>
                <td style="height: 30px;"> 出库编号
                <asp:TextBox ID="txtSwcode" Width="115px" runat="server"></asp:TextBox>
                    <asp:Button ID="btnSearch" Text="查询" Style="cursor: pointer;" OnClick="btnSearch_Click" runat="server" /></td>
            </tr>
            <%-- <tr>
            ...
            <tr style="width: 100%; height: 36%; vertical-align: top;">
                <td>
                    <div class="pagediv" style="height: 180px;">
                        <asp:GridView ID="gvNeed" Width="100%" AutoGenerateColumns="false" AllowPaging="true"  OnPageIndexChanging="gvNeed_PageIndexChanging" runat="server">
                            <Columns>
            ...
            <tr style="width: 100%; height: 47.2%; vertical-align: top;">
                <td>
                    <div class="pagediv" style="height: 200px; width: 100%;">
                        <asp:GridView ID="gvNeedNote" Width="100%" AutoGenerateColumns="false" runat="server">
                            <Columns>
                                <asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px">
                                    <ItemTemplate>
                                        <%# Container.DataItemIndex + 1 %>
