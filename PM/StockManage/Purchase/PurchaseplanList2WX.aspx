    ...
    <script type="text/javascript">
        ...
        function saveEvent() {
            ...
            if (ii != 0) {
                ...
                parent.$('#hfldResourceId').val(obj.id);
                parent.$('#hfldPurchaseplan').val(obj.code);
                parent.$('#hidenppcode').val(obj.code2);
                parent.$('#hfldNumber').val(obj.number);
                parent.$('#btnBindResource').click();
            }
            else {
               alert("请从已选的采购计划中选择需要采购的物资！");
            }
        }
        function saveEvent2() {
            var resources = new Array();
