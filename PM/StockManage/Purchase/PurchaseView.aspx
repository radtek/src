            ...
            <tr style="height: 1px;">
                <td style="vertical-align: top;">
                    <table border="0px" cellpadding="0" cellspacing="0" class="viewTable">
                      ...
                      <input type="button" id="btnDy2" style="float: right;width: auto;" class="noprint" onclick="outEcel()" value="导出物资列表" />
                     <asp:Button ID="btnExecl" style="display:none;" OnClick="btnExecl_Click" runat="server" />
                    <table style="width: 100%; height: 50%; margin-top: 10px;" border="0">
                        <tr style="vertical-align: top;">
                            <td>
                                <asp:GridView ID="gvwPurchaseplanStock" Width="100%" AutoGenerateColumns="false" OnRowDataBound="gvwPurchaseplanStock_RowDataBound" XCssClass="viewTable" DataKeyNames="scode,Total,BugetSum" runat="server">
                                    <EmptyDataTemplate>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="物资名称" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <div style="word-break: break-all;">
                                                    <%# Eval("ResourceName") %>
                                                </div>
                                        ...
                                        <asp:TemplateField HeaderText="单位" HeaderStyle-Width="30px" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <div style="word-break: break-all;">
                                                    <%# Eval("Name") %>
                                                </div>
                                        ...
                                        <asp:TemplateField HeaderText="采购价格" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input">
                                            <ItemTemplate>
                                                <%# Eval("sprice") %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                    ...
                    <td><div style="float:right;">
                        ...
                        <tr id="trDiff" style="vertical-align: top;">
                            <td>
                                ...
                                <div style="width: 100%;">
                                    <asp:GridView AutoGenerateColumns="false" Width="100%" ID="gvwDiff" CssClass="viewTable" runat="server">
                                        <Columns>
                                            <asp:TemplateField HeaderText="序号" HeaderStyle-Width="2%">
                                                <ItemTemplate>
                                                    <%# Container.DataItemIndex + 1 %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="ResourceName" HeaderText="名称" HeaderStyle-Width="15%" />
                                            <asp:BoundField DataField="Specification" HeaderText="规格" HeaderStyle-Width="5%" />
                                            <asp:BoundField DataField="Brand" HeaderText="品牌" HeaderStyle-Width="5%" />
                                            <asp:BoundField DataField="PurPlanNumber" HeaderText="物资采购审核计划量" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="10%" ItemStyle-CssClass="decimal_input" />
                                            <asp:BoundField DataField="PurNumber" HeaderText="本次采购量" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="10%" ItemStyle-CssClass="decimal_input" />
                                            <asp:BoundField DataField="ConResPrice" HeaderText="合同预算报价" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="10%" ItemStyle-CssClass="decimal_input" />
                                            <asp:TemplateField HeaderText="目标成本预算价" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="10%" ItemStyle-CssClass="decimal_input">
                                                <ItemTemplate>
                                                    <%# System.Convert.ToDecimal(Eval("BudPrice")).ToString("0.000") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="PuredPrice" HeaderText="以往采购价" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="10%" ItemStyle-CssClass="decimal_input" />
                                            <asp:BoundField DataField="PurPrice" HeaderText="本次采购价" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="10%" ItemStyle-CssClass="decimal_input" />
                                        </Columns>
                                        <RowStyle CssClass="rowa"></RowStyle>
                                        <AlternatingRowStyle CssClass="rowb"></AlternatingRowStyle>
                                        <HeaderStyle CssClass="header"></HeaderStyle>
