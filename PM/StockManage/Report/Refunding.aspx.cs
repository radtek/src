...
public partial class StockManage_Report_Refunding : NBasePage, IRequiresSessionState
{
	...
	{
		return this.backStockBll.GetTableByParam(this.txtStartTime.Text, this.txtEndTime.Text, this.txtCode.Text.Trim(), this.txtResourceNames.Text.Split(new char[]
		{
			','
		}), this.txtResourceCodes.Text.Split(new char[]
		{
			','
		}), this.txtProjectName.Value, this.txtCorp.Text.Trim(), this.txtCategory.Text.Trim(), this.txtSpecification.Text.Trim(), this.txtBrand.Text.Trim(), this.txtModelNumber.Text.Trim());
	}
	public void BindGv()
	{
	...
	protected void btnexecl_Click(object sender, System.EventArgs e)
	{
		...
		common.ExportToExecelAll(this.GetTitleByTable(table), "退库报表.xls", base.Request.Browser.Browser);
	}
