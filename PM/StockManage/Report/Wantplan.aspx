<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Wantplan.aspx.cs" Inherits="StockManage_Report_Wantplan" %>
<%@ Import Namespace="cn.justwin.BLL"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server"><title>需求计划报表</title><link rel="Stylesheet" type="text/css" href="../../Script/jquery.easyui/themes/default/easyui.css" />
...
<body>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<td>
							<table class="queryTable" cellpadding="3px" cellspacing="0px">
								...
								<tr>
									...
									<td>
										<asp:TextBox ID="txtPrjName" Style="width: 120px;" CssClass="easyui-validatebox select_input" data-options="validType:'validQueryChars[50]'" imgclick="openProjPicker" runat="server"></asp:TextBox>
									</td>
									<td class="descTd">
										资源类别
									</td>
					...
					<tr>
						<td style="height: 100%; vertical-align: top;">
							<div class="">
								<asp:GridView ID="gvPurchaseplan" AutoGenerateColumns="false" CssClass="gvdata" AllowPaging="true" PageSize="5" OnPageIndexChanging="gvPurchaseplan_PageIndexChanging" DataKeyNames="wpcode,swid" runat="server"><Columns><asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px" HeaderStyle-HorizontalAlign="Right"><ItemTemplate>
												...
												<%# Eval("intime") %>
											</ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="需求编号"><ItemTemplate>
												<span class="al" onclick="viewopen('/StockManage/basicset/WantplanView.aspx?ic=<%# Eval("swid") %>&pcode=<%# Eval("prjGuid") %>&optype=look','','')">
													<%# Eval("wpcode") %>
												</span>
	...
	<div id="dlgProject" title="" style="display: none">
		<iframe id="ifrmProject" frameborder="0" width="100%" height="100%" src=""></iframe>
	</div>
	</form>
</body>
</html>
