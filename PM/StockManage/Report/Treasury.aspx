...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function view(corpID) {
            var url = "/EPC/Basic/ContactCorpEdit.aspx?t=3&ci=" + corpID + "&cti=2";
            top.ui.openWin({ title: '查看往来单位', url: url, width: 780, height: 550 });
        }
    </script>
</head>
<body>
                ...
                <td style="vertical-align: top;">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <td>
                                <table class="queryTable" cellpadding="3px" cellspacing="0px">
                                    ...
                                    <tr>
                                        ...
                                        <td class="descTd" style="display: none;">资源类别
                                        </td>
                        ...
                        <tr>
                            <td style="height: 100%;">
                                <div class="">
                                    <asp:GridView ID="gvwTreasury" CssClass="gvdata" Width="100%" AllowPaging="true" AutoGenerateColumns="false" EnableViewState="false" OnPageIndexChanging="gvwPurchase_PageIndexChanging" DataKeyNames="tsid" runat="server">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="total" HeaderText="小计" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input" />
                                             <asp:TemplateField HeaderText="供应商">
                                                <ItemTemplate>
                                                    <span style="color: Blue;cursor: pointer;" title='<%# Eval("CorpName").ToString() %>'  onclick="view('<%# Eval("corp").ToString() %>');">
