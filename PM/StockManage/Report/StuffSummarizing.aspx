                            ...
                            <tr>
                                <td id="td_Left" style="width: 194px; vertical-align: top; height: 100%;">
                                    ...
                                    <div id="div_project" class="pagediv" style="width: 194px; height: 100%;">
                                        <asp:TreeView ID="tvProject" Font-Size="12px" ShowLines="true" OnSelectedNodeChanged="tvProject_SelectedNodeChanged" runat="server">
                                            <SelectedNodeStyle BackColor="#3399FF" ForeColor="White" Height="9px" />
                                        </asp:TreeView>
                                    </div>
                                </td>
                                                    ...
                                                    <asp:GridView ID="gvStuff" AutoGenerateColumns="false" DataKeyNames="" CssClass="gvdata" Width="100%" ShowFooter="true" OnRowDataBound="gvStuff_RowDataBound" runat="server">
                                                        <EmptyDataTemplate>
                                                            <table id="emptyStuff">
                                                                ...
                                                                <tr class="header">
                                                                    ...
                                                                    <th class="tooltip" title=" 实际数量 = 出库数量 &ndash; 退库数量">实际数量
                                                                    </th>
                                                                    <th class="tooltip" title=" 实际价格 = 编制采购单时的价格 ">实际价格
                                                                    </th>
                                                                    <th class="tooltip" title=" 实际数量 = 出库中成本归集于材料的物资金额 &ndash; 退库中成本归集于材料的物资金额">实际金额
                                                                    </th>
                                                                    <th class="tooltip" title=" 数量 = 目标数量 &ndash; 采购数量">数量
                                                                    </th>
                                                                    <th class="tooltip" title=" 金额 = 目标金额 &ndash; 采购金额 ">金额
                                                                    </th>
                                                                    <th class="tooltip" title=" 数量 = 采购数量 &ndash; 出库数量 ">数量
                                                                    </th>
                                                                    <th class="tooltip" title=" 金额 = 采购金额 &ndash;  出库金额 ">金额
                                                                    </th>
                                                                     <th class="tooltip" >已提需求量
                                                                    </th>
                                                                    <th class="tooltip" >已出库量
                                                                    </th>
                                                                </tr>
                                                            </table>
                                                        </EmptyDataTemplate>
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField ItemStyle-CssClass="decimal_input">
                                                              ...
                                                              <asp:TemplateField ItemStyle-CssClass="decimal_input">
                                                                <ItemTemplate><%# System.Convert.ToDecimal(Eval("nums")).ToString("0.000") %>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-CssClass="decimal_input">
                                                                <ItemTemplate><%# System.Convert.ToDecimal(Eval("outNums")).ToString("0.000") %>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
