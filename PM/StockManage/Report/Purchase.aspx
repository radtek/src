<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Purchase.aspx.cs" Inherits="StockManage_Report_Purchase" %>
<%@ Import Namespace="cn.justwin.BLL"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server"><title>物资采购报表</title><link rel="Stylesheet" type="text/css" href="../../Script/jquery.easyui/themes/default/easyui.css" />
			...
			<td>
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
						<td style="height: 100%;">
							<div class="">
								<asp:GridView ID="gvwPurchase" CssClass="gvdata" Width="100%" AllowPaging="true" AutoGenerateColumns="false" EnableViewState="false" OnPageIndexChanging="gvwPurchase_PageIndexChanging" DataKeyNames="psid,pid" runat="server"><Columns><asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px" HeaderStyle-HorizontalAlign="Right"><ItemTemplate>
												<%# Container.DataItemIndex + 1 %>
											</ItemTemplate></asp:TemplateField><asp:BoundField DataField="scode" HeaderText="资源编号" /><asp:TemplateField HeaderText="资源名称"><ItemTemplate>
											...
											</ItemTemplate></asp:TemplateField><asp:BoundField DataField="intime" HeaderText="采购日期" /><asp:TemplateField HeaderText="单据号"><ItemTemplate>
												<span class="al" onclick="viewopen('../Purchase/PurchaseView.aspx?ic=<%# Eval("pid") %>&Action=Query','','')">
													<%# Eval("pscode") %>
												</span>
