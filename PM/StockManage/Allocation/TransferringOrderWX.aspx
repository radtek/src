...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function selectStorageOut() {
            ...
            var url = "/Common/SelectTreasuryWXout.aspx?module=import";
            layer.open({
                type: 2,
                title: '选择调出库',
                shadeClose: true,
        ...
        function selectStorageIn() {
            //selectStorage('txtInDepository', 'HdnSelectInDepo', '0');
            //$('#HdnSelectInDepo').val(o.code)
            //$('#txtInDepository').val(o.name);
            var url = "/Common/SelectTreasuryWXin.aspx?module=import";
            layer.open({
                type: 2,
                title: '选择调入库',
                shadeClose: true,
        ...
        function openSelectMaterial() {
            if (document.getElementById("txtOutDepository").value == "" || document.getElementById("HdnSelectOutDepo").value == "") {
                ...
                var url = "/StockManage/Allocation/PickMaterialsOfDepositoryWX.aspx?did=" + $('#HdnSelectOutDepo').val() +
        ...
        function checkData() {
            ...
            for (i = 1; i < rowCount - 1; i++) {
                ...
                if (allocatNum > totalNum || allocatNum == 0) {
                    alert('调拨数量不能大于库存量，调拨数量不能等于零，请重新填写。');
                    return false;
                }
            }
        }
        ...
        function selectUserOut() {
            ...
            var url = '/EPC/Workflow/SelectUserWXout.aspx';
            layer.open({
                type: 2,
                title: '选择调出人',
                shadeClose: true,
        ...
        function selectUserIn() {
            ...
            var url = '/EPC/Workflow/SelectUserWXin.aspx';
            layer.open({
                type: 2,
                title: '选择接收人',
                shadeClose: true,
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="divContent2">
            <table class="tableContent2" style="margin-left: auto;" cellpadding="5px" cellspacing="0">
                ...
                <tr>
                    ...
                    <td class="txt mustInput" style="padding-right: 3px">
                        <asp:TextBox ID="txtOutDepository" Style="width: 180px" CssClass="select_input" imgclick="selectStorageOut" runat="server"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="txt mustInput" style="padding-right: 3px">
                        <asp:TextBox ID="txtInDepository" Style="width: 180px" CssClass="select_input" imgclick="selectStorageIn" runat="server"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="txt mustInput" style="padding-right: 3px">
                        <asp:TextBox ID="txtOutAllocationPerson" Style="width: 180px" CssClass="select_input" imgclick="selectUserOut" runat="server"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="txt mustInput" style="padding-right: 3px">
                        <asp:TextBox ID="txtInAllocationPerson" Style="width: 180px" CssClass="select_input" imgclick="selectUserIn" runat="server"></asp:TextBox>
                ...
                <tr>
                    <td colspan="4" style="text-align: left;">
                        ...
                        <input type="button" id="btnSelectByd" value="查看需求计划" onclick="displaySelectFromPurchase();" style="width: 100px; display: none;" runat="server" />
                    ...
                    <td colspan="4">
                        <div class="pagediv">
            ...
            </table>  <asp:GridView ID="GVMaterialList" CssClass="gvw" Width="100%" AutoGenerateColumns="false" OnRowDataBound="GVMaterialList_RowDataBound" DataKeyNames="scode,sprice,corp" runat="server">
                                <EmptyDataTemplate>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="规格" ItemStyle-Width="50px">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="型号" ItemStyle-Width="50px">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="品牌" ItemStyle-Width="50px">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="技术参数" ItemStyle-Width="50px">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="单位" ItemStyle-Width="30px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblUnit" runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="采购价" ItemStyle-Width="50px">
                                        <ItemTemplate>
                                            <asp:Label ID="txtUnitPrice" Width="50px" CssClass="decimal_input" ReadOnly="true" Text='<%# Convert.ToString(Eval("sprice")) %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="snumber" HeaderText="库存量" ItemStyle-Width="50px" HeaderStyle-HorizontalAlign="Right" HeaderStyle-CssClass="decimal_input total_num" />
                                    <asp:TemplateField HeaderText="调拨数量" ItemStyle-Width="50px">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtAllocationOutNum" Width="50px" CssClass="decimal_input allocat_num" onblur="setGVTotalNumber()" Style="text-align: right;" Text='<%# Convert.ToString((Eval("number").ToString() == "") ? "0.000" : Convert.ToDecimal(Eval("number")).ToString("0.000")) %>' No='<%# Convert.ToString(Container.DataItemIndex) %>' runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
