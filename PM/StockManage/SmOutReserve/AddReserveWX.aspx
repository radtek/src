...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function valForm() {
            ...
            if (document.getElementById("hdTsid").value == "" && document.getElementById("hfldResourceIdsZZCL").value == "") {
                top.ui.alert("请选择资源");
                return false;
            }
        ...
        function selectResourceWX() {
            if ($('#hfldTrea').val() == "") {
                ...
                var typeCode = '0004';
                var url = '/StockManage/UserControl/SelectResourceZZCLWX.aspx?type=2&TypeCode=' + typeCode;
                //top.ui.callback = function (obj) {
                //    $('#hfldResourceIdsZZCL').val(obj.alls);
                //    $('#btnShowGv').click();
                //}
        ...
        //选择设备
        function selectEqu() {
            var url = '/Equ/Equipment/SelectEquipmentWX.aspx?' + new Date().getTime();
            layer.open({
                type: 2,
                title: '选择设备',
                shadeClose: true,
        ...
        <div class="divContent2" style="text-align: center;">
            <table class="tableContent2" cellpadding="5px" cellspacing="0">
                ...
                <tr>
                    ...
                    <td class="word" style="white-space: nowrap;"></td>
                    <td></td>
                ...
                <tr>
                    <td colspan="4">
                        <div class="headerDiv" style="text-align: left;">
                            <input type="button" id="btnSelectByd" value="从仓库选择资源" onclick="openkc()" style="width: 80px;" runat="server" />
                            ...
                            <input type="button" value="选择组装材料" id="btnSelectResource" onclick="selectResourceWX();"
                                style="width: 80px;" />
                            <asp:Button ID="btnDel" Style="width: 60px;" Text="删除资源" OnClick="btnDel_Click" runat="server" />
                            <asp:Button ID="btnShowGv" Text="显示" Style="display: none;" OnClick="btnShowGv_Click" runat="server" />
                            <input type="button" id="Button1" value="查看需求计划" onclick="displaySelectFromPurchase();" style="width: 80px; display: none;" runat="server" />
                ...
                <tr>
                    <td>
                        <div class="pagediv" style="margin: 0 auto; background-color: Aqua; text-align: center;">
                            <asp:GridView ID="gvNeedNote" CssClass="gvw" Width="100%" AutoGenerateColumns="false" OnRowDataBound="gvNeedNote_RowDataBound" DataKeyNames="scode" runat="server">
                                <EmptyDataTemplate>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="分部分项" Visible="false">
                                        <ItemTemplate>
            ...
            <table class="tableContent2" cellpadding="5px" cellspacing="0">
                <tr>
                    <td>
                        <div class="pagediv" style="margin: 0 auto; background-color: Aqua; text-align: center;">
                            <asp:GridView ID="gvNeedNote2" Width="100%" AutoGenerateColumns="false" DataKeyNames="scode" runat="server">
                                <%--                                <EmptyDataTemplate>
                                    <table id="emptyContractType" class="gvdata">
                                        <tr class="header">
                                            <th scope="col" style="width: 20px;">
