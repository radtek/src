                ...
                <tr>
                    <td colspan="4">
                        <div class="headerDiv" style="text-align: left;">
                            <input type="button" id="btnSelectByd" value="从仓库选择资源" onclick="openkc()" style="width: 100px;display:none;" runat="server" />
                            ...
                            <input type="button" id="Button1" value="查看需求计划" onclick="displaySelectFromPurchase();" style="width: 100px; display:none;" runat="server" />
