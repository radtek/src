...
<head id="Head1" runat="server"><title>查看出库单</title>
                ...
                <table style="vertical-align: top; width: 100%;">
                    <tr>
                        <td style="padding-top: 10px;">
                            <asp:GridView ID="gvNeedNote" Width="100%" AutoGenerateColumns="false" CssClass="viewTable" OnRowDataBound="gvNeedNote_RowDataBound" runat="server"><Columns><asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px"><ItemTemplate>
                                            ...
                                            <%# Eval("ResourceName") %>
                                        </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="规格" ItemStyle-Width="70px"><ItemTemplate>
                                            <%# Eval("Specification") %>
                                        </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="单位" HeaderStyle-Width="40px"><ItemTemplate>
                                            <%# Eval("Name") %>
                                        </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="库存数量" ItemStyle-CssClass="decimal_input" ItemStyle-HorizontalAlign="Right"><ItemTemplate>
                                            <%# Eval("snumber") %>
                                        </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="出库数量" ItemStyle-CssClass="decimal_input" ItemStyle-HorizontalAlign="Right"><ItemTemplate>
                                            <%# Eval("number") %>
                                            ...
                                            <%# Eval("sprice") %>
                                        </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="出库小计" ItemStyle-CssClass="decimal_input" ItemStyle-HorizontalAlign="Right"><ItemTemplate>
                                            <%# (Eval("Total").ToString() == "") ? "0.000" : Convert.ToDecimal(Eval("Total")).ToString("0.000") %>
                                        </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="供应商" ItemStyle-Width="85px"><ItemTemplate>
                                            <div style="word-break: break-all;">
                                                <%# Eval("Corp") %>
                                            </div>
                                        </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="型号" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="60px"><ItemTemplate>
                                            <div style="word-break: break-all;">
                                                <%# Eval("ModelNumber") %>
                                            </div>
                                        </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="品牌" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="60px"><ItemTemplate>
                                            <div style="word-break: break-all;">
                                                <%# Eval("brand") %>
                                            </div>
                                        </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="技术参数" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="60px"><ItemTemplate>
                                            <div style="word-break: break-all;">
                                                <%# Eval("TechnicalParameter") %>
                                            </div>
                                        </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="分部分项" ItemStyle-Width="60px"><ItemTemplate>
                                            <div style="word-break: break-all;">
                                                <%# Eval("TaskName") %>
                                            </div>
