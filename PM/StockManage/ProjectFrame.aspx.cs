...
public partial class StockManage_ProjectFrame : NBasePage, IRequiresSessionState
{
	...
	private void SetSubUrl()
	{
        ...
        if (this.path == "wantPlanWX")
        {
            this.hfldSubUrl.Value = "/StockManage/basicset/SmWantPlanListWX.aspx?prjId=";
            this.hfldStateType.Value = "5";
            return;
        }
        ...
        if (this.path == "purchasePlanWX")
        {
            this.hfldSubUrl.Value = "/StockManage/SmPurchaseplan/SmPurchaseplanListWX.aspx?PrjGuid=";
            this.hfldStateType.Value = "5";
            return;
        }
        ...
        if (this.path == "selectWantPlan2")
        {
            this.hfldSubUrl.Value = "/StockManage/SmPurchaseplan/SelectByNoteList2.aspx?PrjGuid=";
            this.hfldStateType.Value = "5";
            return;
        }
        if (this.path == "selectWantPlanWX")
        {
            this.hfldSubUrl.Value = "/StockManage/SmPurchaseplan/SelectByNoteListWX.aspx?PrjGuid=";
            this.hfldStateType.Value = "5";
            return;
        }
        ...
        if (this.path == "purchaseWX")
        {
            this.hfldSubUrl.Value = "/StockManage/Purchase/PurchaseWX.aspx?PrjGuid=";
            this.hfldStateType.Value = "5";
            return;
        }
        ...
        if (this.path == "outReserveByXQ")
        {
            this.hfldSubUrl.Value = "/StockManage/SmOutReserve/SmOutReserveListByXQ.aspx?PrjGuid=";
            this.hfldStateType.Value = "5";
            return;
        }
        if (this.path == "outReserveWX")
        {
            this.hfldSubUrl.Value = "/StockManage/SmOutReserve/SmOutReserveListWX.aspx?PrjGuid=";
            this.hfldStateType.Value = "5";
            return;
        }
        ...
        if (this.path == "qOutReserveWX")
        {
            this.hfldSubUrl.Value = "/StockManage/SmOutReserve/QOutReserveWX.aspx?PrjGuid=";
            this.hfldStateType.Value = "5";
            return;
        }
        ...
        if (this.path == "refundingListWX")
        {
            this.hfldSubUrl.Value = "/StockManage/Refunding/RefundingListWX.aspx?PrjGuid=";
            this.hfldStateType.Value = "5";
            return;
        }
        ...
        if (this.path == "qoRefundingListWX")
        {
            this.hfldSubUrl.Value = "/StockManage/Refunding/QoRefundingListWX.aspx?PrjGuid=";
            this.hfldStateType.Value = "5";
            return;
        }
        if (this.businessType == "ImgManage")
		{
			this.hfldSubUrl.Value = "/OPM/ComForm/BasicCode/DictFrame1.aspx?codetype=Img&opType= + " + this.opType + "&pc=";
			return;
		}
		if (this.businessType == "ImgMag")
		{
			this.hfldSubUrl.Value = "/OPM/ComForm/BasicCode/DictFrame2.aspx?codetype=Img&opType= + " + this.opType + "&pc=";
			return;
		}
		if (this.businessType == "ImgManageView")
		{
			this.hfldSubUrl.Value = "/OPM/ComForm/BasicCode/DictFrame3.aspx?codetype=Img&opType= + " + this.opType + "&pc=";
			return;
		}
        ...
        if (this.path == "planPlaitWX")
        {
            this.hfldSubUrl.Value = "/ProgressManagement/Plan/PlanWX.aspx?year=" + this.dropYear.SelectedValue + "&prjId=";
            return;
        }
        ...
        if (this.path == "planActualRptWX")
        {
            this.hfldSubUrl.Value = "/ProgressManagement/Actual/ActualReportWX.aspx?year=" + this.dropYear.SelectedValue + "&prjId=";
            return;
        }
        ...
        //日志统计(按项目)
        if (this.path == "JournalByProjectStatisticsList")
        {
            this.hfldSubUrl.Value = "/oa/JournalManage/JournalByProjectStatisticsList.aspx?businessType=JournalByProjectStatisticsList&opType=view&PrjGuid=";
            //this.hfldContainsOrg.Value = "1";
            this.hfldStateType.Value = "5";
            return;
        }
        //需求计划执行情况表
        if (this.path == "StaticByXQ")
        {
            this.hfldSubUrl.Value = "/OA3/Static/StaticByXQ.aspx?businessType=StaticByXQ&PrjGuid=";
            //this.hfldContainsOrg.Value = "1";
            this.hfldStateType.Value = "5";
            return;
        }
        //人工费用报表(按项目)
        if (this.path == "JournalByProjectCost")
        {
            this.hfldSubUrl.Value = "	/OA3/WorkLog/StatisticByUserCost.aspx?businessType=JournalByProjectCost&opType=view&PrjGuid=";
            //this.hfldContainsOrg.Value = "1";
            this.hfldStateType.Value = "5";
            return;
        }
        //项目通讯录(管理)
        if (this.path == "ProAddressListMsg")
        {
            //this.hfldSubUrl.Value = "/OA3/ProUser/List.aspx?action=edit&PrjGuid=";
            //this.hfldStateType.Value = "5";
            this.hfldSubUrl.Value = "/OA3/ProUser/List.aspx?action=edit&year=" + this.dropYear.SelectedValue + "&prjId=";
            //this.hfldContainsOrg.Value = "1";
            this.hfldStateType.Value = "5";
            return;
        }
        //项目通讯录(查看)
        if (this.path == "ProAddressListView")
        {
            //this.hfldSubUrl.Value = "/OA3/ProUser/List.aspx?action=view&PrjGuid=";
            //this.hfldStateType.Value = "5";
            //return;
            this.hfldSubUrl.Value = "/OA3/ProUser/List.aspx?action=view&year=" + this.dropYear.SelectedValue + "&prjId=";
            //this.hfldContainsOrg.Value = "1";
            this.hfldStateType.Value = "5";
            return;
        }
        //文档浏览(按项目)
        if (this.path == "DocViewByProject")
        {
            this.hfldSubUrl.Value = "/OA3/FileMsg/DocList.aspx?hid=&action=read&DocAttribute=4&year=" + this.dropYear.SelectedValue + "&prjId=";
            //this.hfldContainsOrg.Value = "1";
            this.hfldStateType.Value = "5";
            return;
        }
