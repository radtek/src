...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function displayDesignCode() {
            prompt('系统提示', '请输入设计编码', function (r) {
                $('#txtDesignCode').val(r);
        ...
        function displaySelectByBud() {
            //alert($('#hfldResourceIdsZZCL').val());
            if ($('#hfldBudFlowState').val() != '1') {
                alert('该项目的预算没有审核通过，不能从预算中选择材料');
                return false;
            }
            //if ($('#hfldResourceIdsZZCL').val() != "") {
            //    top.ui.alert('不能同时从预算材料中和组装材料中选择,请先清空列表!');
            //    return false;
            //}
            var url = '/StockManage/basicset/SelectByBudWX.aspx?prjId=' + $('#hdnProjectCode').val();
            layer.open({
                type: 2,
                title: '新增入库单',
                shadeClose: true,
        ...
        function selectResource() {
            ...
            top.ui.openWin({ title: '选择组装材料', url: src, width: 1010, height: 690 });
        }
        // 从材料库中选择组装材料
        function selectResourceWX() {
           
                var typeCode = '0004';
                var url = '/StockManage/UserControl/SelectResourceZZCLWX2.aspx?type=2&TypeCode=' + typeCode;
                //top.ui.callback = function (obj) {
                //    $('#hfldResourceIdsZZCL').val(obj.alls);
                //    $('#btnShowGv').click();
                //}
                //top.ui.openWin({ title: '选择组装材料', url: src, width: 860, height: 690 });
                layer.open({
                    type: 2,
                    title: '选择组装材料',
                    shadeClose: true,
    ...
    <form id="form1" runat="server">
        ...
        <div class="divContent2">
            <table class="tableContent2" cellpadding="5px" cellspacing="0">
                ...
                <tr style="display: none;">
                    ...
                    <td>
                        <input type="text" id="txtEquCode" readonly="readonly" style="width: 100%;" runat="server" />
                ...
                <tr visible="false" runat="server">
                    <td colspan="4" style="text-align: left; padding-left: 70px;" runat="server">
            ...
            <table class="tableContent2" style="margin-left: auto;" cellpadding="5px" cellspacing="0">
                ...
                <tr>
                    <td>
                        <div class="headerDiv" style="text-align: left;">
                            ...
                            <input type="button" value="选择组装材料" id="btnSelectResource" onclick="selectResourceWX();"
                                style="width: 90px;" />
                ...
                <tr style="vertical-align: top">
                    <td>
                        <div class="pagediv">
                            <asp:GridView ID="gvSmWantPlanStock"  CssClass="gvw" AutoGenerateColumns="false" OnRowDataBound="gvSmWantPlanStock_RowDataBound" DataKeyNames="ResourceCode" runat="server">
                                <EmptyDataTemplate>
                                    <table id="emptyTable" style="background-color: Red;" class="tab" width="100%">
                                        <tr class="header">
                                            ...
                                            <td style="width: 25px" align="center">序号
                                            </td>
                                            <td style="width: 50px" align="center">资源编号
                                            </td>
                                            <td style="width: 50px" align="center">资源名称
                                            </td>
                                            <td align="center">规格
                                            </td>
                                            <td align="center">型号
                                            ...
                                            <td align="center">技术参数
                                            </td>
                                            <td align="center">单位
                                            </td>
                                            <td align="center">单价
                                            </td>
                                            <td align="center">需求数量
                                            </td>
                                            <td align="center">需求到货日期
                                            </td>
                                            <td align="center">实际到货日期
                                            </td>
                                            <td align="center">设计编码
                                            </td>
                                            <td align="center">分部分项
                                            </td>
                                            <td align="center">备注
                                            </td>
                                        </tr>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="资源编号" HeaderStyle-Width="100px">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="资源名称" HeaderStyle-Width="150px">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="规格" HeaderStyle-Width="40px">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="单位" HeaderStyle-Width="30px">
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "UnitName") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="单价" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="60px">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="需求数量" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="80px">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="需求到货日期" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="80px">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtarrivalDateNeed" onclick="WdatePicker()" Width="70px" Height="15px" Text='<%# System.Convert.ToString((Eval("arrivalDateNeed").ToString() == "") ? "" : Eval("arrivalDateNeed").ToString().Substring(0, Eval("arrivalDateNeed").ToString().LastIndexOf(" ") + 1), System.Globalization.CultureInfo.CurrentCulture) %>' runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="设计编码" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="60px">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="分部分项" HeaderStyle-Width="60px">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="备注" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="250px">
                                        <ItemTemplate>
        ...
        <div class="divFooter2">
            <table class="tableFooter2">
                <tr>
                    <td>
                        <asp:Button ID="btnSave" Text="保存" OnClick="btnSaveWX_ServerClick" runat="server" />
                        <input id="btnClose" type="button" value="取消" onclick="page_close()" />
                    </td>
                </tr>
            </table>
        </div>

        <div id="divDesignCode" class="divContent2" title="添加设计编码" style="display: none; text-align: center;">
