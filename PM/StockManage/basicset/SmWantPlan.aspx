                ...
                <tr>
                    <td>
                        <div class="headerDiv" style="text-align: left;">
                            ...
                            <input type="button" value="从组装材料中选择" id="btnSelectResource" onclick="selectResource();"
                                style="width: 100px;" />
                            ...
                            <asp:Label ID="Label1" runat="server" style="
    color: #8b8b8b;
    padding-left: 15px;
">注:请不要同时从预算材料、组装材料中选择材料。</asp:Label>
                        </div>
                    </td>
                </tr>
                            ...
                            <asp:GridView ID="gvSmWantPlanStock" AutoGenerateColumns="false" CssClass="gvdata" OnRowDataBound="gvSmWantPlanStock_RowDataBound" DataKeyNames="ResourceCode" runat="server">
                                <EmptyDataTemplate>
                                    <table id="emptyTable" style="background-color: Red;" class="tab" width="100%">
                                        <tr class="header">
                                            ...
                                            <td style="width: 100px" align="center">资源编号
                                            </td>
                                            <td style="width: 150px" align="center">资源名称
                                            </td>
                                            <td align="center">规格
                                            </td>
                                            <td align="center">型号
                                            ...
                                            <td align="center">单价
                                             ...
                                             <td align="center">预算数量
                                            </td>
                                             <td align="center">已提需求数量
                                            </td>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="库存量" ItemStyle-HorizontalAlign="Right">
                                     ...
                                     <asp:TemplateField HeaderText="预算数量" ItemStyle-HorizontalAlign="Right">
                                        <ItemTemplate>
                                            <%#Eval("ResourceQuantity").ToString() %>
                                             <asp:Label ID="ResourceQuantity" Visible="false" Text='<%#Eval("ResourceQuantity").ToString() %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="已提需求数量" ItemStyle-HorizontalAlign="Right">
                                        <ItemTemplate>
                                              <%#Eval("numberIng").ToString() %>
                                             <asp:Label ID="numberIng" Visible="false" Text='<%#Eval("numberIng").ToString() %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
