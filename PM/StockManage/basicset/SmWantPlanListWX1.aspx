...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //addEvent(document.getElementById('btnUpdate'), 'click', updateS);
        ...
        //    //alert(this.guid);
        //    //parent.parent.desktop.SmWantPlan = window;
        //    var url = "/StockManage/basicset/SmWantPlanWX.aspx?prjId=" + $('#hndProCode').val() + "&pcode=" + pcode + "&swcode=" + swcode + "&optype=update";
