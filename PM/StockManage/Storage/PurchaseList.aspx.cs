...
using Wuqi.Webdiyer;
public partial class StockManage_Storage_PurchaseList : NBasePage, IRequiresSessionState
{
	...
	protected void AspNetPager1_PageIndexChanged(object sender, System.EventArgs e)
	{
		this.DataBindPurchase();
	...
	private System.Collections.Generic.List<PurchaseModel> GetPurchses()
	{
		...
		return this.purchase.Select(startDate, dateTime, this.txtPcode.Text.Trim(), this.prjId, base.UserCode);
	}
