<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewReceiveNote.aspx.cs" Inherits="StockManage_receiveGoods_ViewSendNote" %>
...
<head id="Head1" runat="server"><title>查看收货验收单</title>
            ...
            <td>
                <table cellpadding="0" cellspacing="0" class="viewTable">
                    <tr>
                        ...
                        <td class="elemTd">
                            <asp:Label ID="sendCode" runat="server"></asp:Label>
                        </td>
                        <td class="descTd">
                            录入人
                        </td>
                        <td class="elemTd">
                            <asp:Label ID="sendAddUser" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="descTd">
                        ...
                        <td class="elemTd">
                            <asp:Label ID="sendAddTime" runat="server"></asp:Label>
                        </td>
                        <td class="descTd">
                            项目
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:Label ID="sendLimit" Text="Label" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td colspan="3">
                            <div style="width: 100%; word-break: break-all;">
                                <asp:Label ID="sendremark" runat="server"></asp:Label></div>
                        </td>
                    </tr>
                </table>
                <table style="vertical-align: top; width: 100%;">
                    <tr>
                        <td style="padding-top: 10px;">
                            <asp:GridView ID="gvdSend" Width="100%" AutoGenerateColumns="false" CssClass="viewTable" runat="server"><Columns><asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px"><ItemTemplate>
...
<ItemTemplate>
    ...
    <table cellpadding="0" cellspacing="0" style="vertical-align: top; min-width: 800px;">
        <tr>
            <td class="divHeader">
                查看收货验收单
            </td>
            ...
            <td>
                <table cellpadding="0" cellspacing="0" class="viewTable">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:Label ID="txtExplain" Height="90px" runat="server"></asp:Label>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:Label ID="txtRemark" Height="90px" runat="server"></asp:Label>
...
<ItemTemplate>
        ...
        <tr id="trAudit" style="vertical-align: top;">
            <td>
                <MyUserControl:stockmanage_common_showaudit_ascx ID="ShowAudit1" BusiCode="096" BusiClass="001" runat="server" />
            </td>
        </tr>
    </table>
    <asp:HiddenField ID="hdGuid" runat="server" />
    <asp:HiddenField ID="hdfSend" runat="server" />
    </form>
</body>
</html>
