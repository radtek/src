    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            resourceTable.registClickSingleCHKListener(function () {
                ...
                if (this.checked && $('#emptySelectedResource').html().indexOf(resourceId) < 0) {
                    ...
                    //alert(1122);
                    var temp = "<td><input type='text' value='1' id='" + resourceId + "' class='decimal_input number' onchange='getResources()' style='height:15px;width:70px;text-align: right;'></td>";
                    var $tr = $('<TR id=' + resourceId + ' code=' + code + '>' + this.parentNode.parentNode.innerHTML + temp + '</TR>');
                    //var $tr1 = $('<TR id=' + resourceId + ' code=' + code + '>' + this.parentNode.parentNode.innerHTML + temp + '</TR>');
                    $('#emptySelectedResource').append($tr);
                    getResources();
        ...
        function getResources() {
            ...
            $('#emptySelectedResource tr:gt(0)').each(function () {
                //alert(this.id);
                //alert(this.lastChild.parentElement.children[10].firstElementChild.value) ;
                idArr1.push(this.id);
                codeArr1.push($(this).attr('code'));
                nums1.push(this.lastChild.parentElement.children[10].firstElementChild.value);
                alls1.push(this.id + '|' + $(this).attr('code') + '|' + this.lastChild.parentElement.children[10].firstElementChild.value);
                //alert(alls1);
            });
            ...
            $.ajax({
                type: "POST",
                url: "../../WeChat/Ajax/AjaxGetMsg.aspx/getResourcesByZZCL",
                data: "{ids: '" + alls1 + "'}",
                ...
                success: function Success(data) {
                    var listHtml = "";
                    if (data.d != "") {
                        $('#emptySelectedResource2').html("");
                        $('#emptySelectedResource2').append(data.d);
                        //var res = eval("(" + data.d + ")");
                        //if (res) {
                        //    var d = res;
        ...
        function saveEvent() {
            ...
            $('#emptySelectedResource tr:gt(0)').each(function () {
               //alert(this.lastChild.parentElement.children[10].firstElementChild.value) ;
                ...
                nums.push(this.lastChild.parentElement.children[10].firstElementChild.value);
                alls.push(this.id + '|' + $(this).attr('code') + '|' + this.lastChild.parentElement.children[10].firstElementChild.value);
            });
            var resObj = {};
            resObj.id = array1dToJson(idArr);
            resObj.code = array1dToJson(codeArr);
            resObj.nums = array1dToJson(nums);
            resObj.alls = array1dToJson(alls);
            ...
            parent.$('#hfldResourceIdsZZCL').val(resObj.alls);
            parent.$('#btnBindResourceZZCL').click();
            page_close();
...
<body>
    <form id="form1" runat="server">
        <div style="width: 100%; height: 25px;">
            <div style="width: 150px; float: left;display: none;">
        ...
        <hr />
        <div style="width: 100%;">
            <div style="display: none;width: 150px; height: 400px; overflow: auto; float: left; border-right: solid 1px #B5CCDE;">
            ...
            <div style="width: 810px; height: 150px; overflow: auto; float: left;">
                <asp:GridView ID="gvwResource" AutoGenerateColumns="false" CssClass="gvdata" OnRowDataBound="gvwResource_RowDataBound" DataKeyNames="ResourceId,ResourceCode" runat="server" ClientIDMode="Static">
                    <EmptyDataTemplate>
                    ...
                    <Columns>
                       ...
                       <%-- <asp:TemplateField HeaderText="数量">
                            <ItemTemplate>
                                 <asp:TextBox Style="text-align: right;" Width="70px" Height="15px" ID="txtNumber"  CssClass="decimal_input number" Text='1' runat="server"></asp:TextBox>
                                   </ItemTemplate>
                        </asp:TemplateField>--%>
                        ...
                        <asp:BoundField HeaderText="计量单位" DataField="Name" />
            ...
            <div style="width: 810px; height: 30px; overflow: auto; float: left;">
            ...
            <div style="width: 810px; height: 190px; overflow: scroll; float: left;">
                <table id="emptySelectedResource" class="gvdata" cellspacing="0" rules="all" border="1"
                ...
                <asp:GridView ID="gvwSelectedResource" Visible="false" AutoGenerateColumns="false" CssClass="gvdata" DataKeyNames="ResourceId,ResourceCode" runat="server" ClientIDMode="Static">
                    <EmptyDataTemplate>
                    </EmptyDataTemplate>
                    <Columns>
                        <asp:TemplateField HeaderStyle-Width="20px">
                       ...
                       <%--  <asp:TemplateField HeaderText="数量">
                            <ItemTemplate>
                                 <asp:TextBox Style="text-align: right;" Width="70px" Height="15px" ID="txtNumber" CssClass="decimal_input" Text='1' runat="server"></asp:TextBox>
                                   </ItemTemplate>
                        </asp:TemplateField>--%>
                        <asp:TemplateField HeaderText="规格">
                            <ItemTemplate>
            ...
            <div style="width: 810px; height: 190px; overflow: scroll; float: left;">
                <table id="emptySelectedResource2" class="gvdata" cellspacing="0" rules="all" border="1"
                    style="border-collapse: collapse;">
                    <tr class="header">
                        <th scope="col" style="width: 20px;">
                            <input id="gvwResource__ctl1_chkAll2" type="checkbox" name="gvwResource:_ctl1:chkAll" />
                        </th>
                        <th scope="col" style="width: 25px;">序号
                        </th>
                        <th scope="col">编码
                ...
                <asp:GridView ID="gvwSelectedResource2" Visible="false" AutoGenerateColumns="false" CssClass="gvdata" DataKeyNames="ResourceId,ResourceCode" runat="server" ClientIDMode="Static">
                    <EmptyDataTemplate>
                    </EmptyDataTemplate>
                    <Columns>
                        <asp:TemplateField HeaderStyle-Width="20px">
