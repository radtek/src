...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var gvNeedNote = new JustWinTable('gvNeedNote');
        ...
        function saveEvent() {
            ...
            //var obj = {};
            var ii = 0;
            $('#gvNeedNote tr:gt(0)').each(function () {
                //console.log(1122);
            ...
            <tr style="width: 100%; height: 47.2%; vertical-align: top;">
                <td style="vertical-align: top;">
                    <div class="pagediv" style="height: 200px;">
                        <asp:GridView ID="gvNeedNote" Width="100%" AutoGenerateColumns="false" CssClass="gvdata" OnPageIndexChanging="gvNeedNote_PageIndexChanging" runat="server" DataKeyNames="scode" OnRowDataBound="gvNeedNote_RowDataBound">
                            <Columns>
