<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewPaymentList.aspx.cs" Inherits="ContractManage_IncometPayment_ViewPaymentList" %>
<%@ Import Namespace="cn.justwin.BLL"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server"><title>收入合同结算</title>
    ...
    <div>
        <div class="pagediv">
            <asp:GridView ID="gvConract" AutoGenerateColumns="false" CssClass="gvdata" runat="server"><Columns><asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px"><ItemTemplate>
                            ...
                            <a href="#" class="al" onclick="rowQueryA('/ContractManage/IncometPayment/AddIncometPayment.aspx?t=1&id=<%# Eval("ID") %>&contractId=<%# Eval("ContractId") %>')">
