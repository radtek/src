...
<head runat="server"><title>支出合同</title><link href="../../Script/jquery.tooltip/jquery.tooltip.css" rel="stylesheet" type="text/css" />
	...
	<script type="text/javascript">
		...
		function addDW() {
		    var url = "/EPC/Basic/ContactCorpEdit.aspx?t=0&ci=0&cti=2";
		    top.ui.openWin({ title: '添加往来单位', url: url, width: 780, height: 550 });
		}
	</script>
</head>
<body>
	...
	<div id="divContent2" class="divContent2">
		<table id="tableContent2" class="tableContent2" cellpadding="5px" cellspacing="0">
			...
			<tr>
				...
				<td class="txt mustInput" style="padding-right: 3px;" colspan="2">
			...
			<tr>
				...
				<td class="txt" style="padding-right: 3px;" colspan="2">
			...
			<tr>
				...
				<td class="txt mustInput" style="padding-right: 3px;line-height: 7px;">
					&nbsp;<input type="button" id="btnAdd" value="新增往来单位" style="width:auto;" onclick="addDW();"/></td>
			</tr>
			<tr>
				<td class="word" style="white-space: nowrap;">
					预付金额
			...
			<tr>
				...
				<td class="txt mustInput" colspan="2">
					<asp:TextBox ID="txtAddress" CssClass="{required:true, messages:{required:'签约地点必须输入'}}" Height="15px" Width="100%" runat="server">大连</asp:TextBox>
				</td>
			</tr>
			<tr>
				<td class="word" style="white-space: nowrap;">
				...
				<td class="txt mustInput" style="padding-right: 1px;" colspan="2">
			...
			<tr>
				...
				<td class="txt readonly" colspan="2">
