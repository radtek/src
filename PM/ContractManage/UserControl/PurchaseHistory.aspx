                        ...
                        <table style="border-collapse: separate; border-spacing: 0px; border-width: 0px;">
                            <tr style="height: 25px;">
                                ...
                                <asp:Button ID="searcheBt" CssClass="button-normal" Text="查询" OnClick="searcheBt_Click" runat="server" />
                                  ...
                                  <td>&nbsp;&nbsp;<asp:Button ID="btnExecl" CssClass="button-normal" Text="导出" OnClick="btnExecl_Click" runat="server" /></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <tr style="vertical-align: top">
                    <td style="width: 100%;">
                        <div class="pagediv" style="">
                            <asp:GridView ID="gvwPurchaseplanStock" AutoGenerateColumns="false" CssClass="gvdata"  DataKeyNames="ResourceCode" runat="server">
                                <EmptyDataTemplate>
