    ...
    <form id="form1" runat="server">
        <div class="pagediv">
            <table class="tab" style="height: 85%;">
                <tr>
                    <td style="text-align: left; border: solid 0px red;">类型编号：<asp:TextBox ID="txtTypeCode" Width="120px" runat="server"></asp:TextBox>&nbsp;
                        ...
                        <div id="pagediv" style="width: 100%; border: solid 0px red; text-align: left;" align="center">
                            <asp:GridView ID="gvwContractType" CssClass="gvdata" Width="100%" AutoGenerateColumns="false" OnRowDataBound="gvwContractType_RowDataBound" DataKeyNames="TypeID,TypeName" runat="server">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="TypeCode" HeaderText="类型编码" HeaderStyle-Width="100px" />
                                    <asp:TemplateField HeaderText="类型名称" HeaderStyle-Width="200px">
                                        <ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="InputPerson" HeaderText="录入人" HeaderStyle-Width="80px" />
                                    <asp:TemplateField HeaderText="录入时间" HeaderStyle-Width="80px">
                                        <ItemTemplate>
