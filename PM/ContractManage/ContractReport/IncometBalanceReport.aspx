<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IncometBalanceReport.aspx.cs" Inherits="ContractManage_ContractReport_IncometBalanceReport" %>
...
<head id="Head1" runat="server"><title>收入合同结算报表</title><link href="../../Script/jquery.tooltip/jquery.tooltip.css" rel="Stylesheet" type="text/css" />
            ...
            <td>
                <table class="queryTable" cellpadding="3px" cellspacing="0px">
                    <tr>
                        ...
                        <td>
                            <input id="txtPrjName" style="width: 120px;" class="select_input easyui-validatebox" imgclick="openProjPicker" data-options="validType:'validChars[50]'" runat="server" />
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" style="width: 120px;" id="txtParty" class="select_input easyui-validatebox" data-options="validType:'validChars[50]'" imgclick="pickCorp" runat="server" />
