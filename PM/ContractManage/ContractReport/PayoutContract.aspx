<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayoutContract.aspx.cs" Inherits="ContractManage_ContractReport_PayoutContract" %>
...
<head runat="server"><title>支出合同报表</title><link href="../../Script/jquery.tooltip/jquery.tooltip.css" rel="Stylesheet" type="text/css" />
...
<Columns><asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px"><ItemTemplate>
                                ...
                                </ItemTemplate></asp:TemplateField><asp:BoundField DataField="ContractCode" HeaderText="合同编号" HeaderStyle-Width="100px" /><asp:TemplateField HeaderText="合同名称" HeaderStyle-Width="200px"><ItemTemplate>
                                ...
                                </ItemTemplate></asp:TemplateField><asp:BoundField HeaderText="签订人" DataField="SignPersonName" /><asp:BoundField DataField="ContractMoney" ItemStyle-HorizontalAlign="Right" HeaderText="合同金额" ItemStyle-CssClass="decimal_input" ItemStyle-Width="80px" /><asp:BoundField DataField="ModifiedMoney" ItemStyle-HorizontalAlign="Right" HeaderText="变更后金额" ItemStyle-CssClass="decimal_input" ItemStyle-Width="80px" /><asp:BoundField DataField="ModifyTotal" ItemStyle-HorizontalAlign="Right" HeaderText="变更累计" ItemStyle-CssClass="decimal_input" ItemStyle-Width="80px" /><asp:TemplateField HeaderText="变更比率" ItemStyle-CssClass="percent"><ItemTemplate>
                                    <%# string.Format("{0:P}", Eval("ModifyRate")) %>
                                </ItemTemplate></asp:TemplateField><asp:BoundField DataField="BalanceTotal" ItemStyle-HorizontalAlign="Right" HeaderText="结算累计" ItemStyle-CssClass="decimal_input" ItemStyle-Width="80px" /><asp:TemplateField HeaderText="结算比率" ItemStyle-CssClass="percent"><ItemTemplate>
                                    <%# string.Format("{0:P}", Eval("BalanceRate")) %>
                                </ItemTemplate></asp:TemplateField><asp:BoundField DataField="PaymentTotal" ItemStyle-HorizontalAlign="Right" HeaderText="付款累计" ItemStyle-CssClass="decimal_input" ItemStyle-Width="80px" /><asp:TemplateField HeaderText="付款比率" ItemStyle-CssClass="percent"><ItemTemplate>
                                    <%# string.Format("{0:P}", Eval("PaymentRate")) %>
                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="付款结算比率" ItemStyle-CssClass="percent"><ItemTemplate>
                                    <%# string.Format("{0:P}", Eval("PaymentBalanceRate")) %>
                                </ItemTemplate></asp:TemplateField><asp:BoundField DataField="InvoiceSum" ItemStyle-HorizontalAlign="Right" HeaderText="发票累计" ItemStyle-CssClass="decimal_input" ItemStyle-Width="80px" /><asp:TemplateField HeaderText="已开发票比率" ItemStyle-CssClass="percent"><ItemTemplate>
                                    <%# string.Format("{0:P}", Eval("InvoiceRate")) %>
                                ...
                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="合同类型" HeaderStyle-Width="150px"><ItemTemplate>
