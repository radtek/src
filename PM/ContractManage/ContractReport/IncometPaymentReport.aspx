<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IncometPaymentReport.aspx.cs" Inherits="ContractManage_ContractReport_IncometPaymentReport" %>
...
<head id="Head1" runat="server"><title>收入合同收款报表</title><link href="../../Script/jquery.tooltip/jquery.tooltip.css" rel="Stylesheet" type="text/css" />
                    ...
                    <tr>
                        <td style="width: 100%;" valign="top">
                            <div class="" style="width: 1700px">
                                <asp:GridView ID="gvConract" AutoGenerateColumns="false" CssClass="gvdata" OnRowDataBound="gvPurchaseplan_RowDataBound" DataKeyNames="ContractId,isFContract" runat="server"><Columns><asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px"><ItemTemplate>
                                                <%# StringUtility.GetStr(Eval("Num").ToString()) %>
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="合同编号" HeaderStyle-Width="200px"><ItemTemplate>
                                                <%# Eval("ContractCode") %>
                                            ...
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="收歀累计" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input"><ItemTemplate>
                                                <%# Eval("CllectionPrice") %>
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="实际收款累计" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input"><ItemTemplate>
                                                <%# WebUtil.SapRealContractMoney(Eval("ContractCode").ToString(), "D") %>
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="合同收款比率" ItemStyle-CssClass="percent"><ItemTemplate>
                                                <%# WebUtil.GetContrast(Eval("CllectionPrice").ToString(), Eval("EndPrice").ToString()) %>
