<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IncometContractContrast.aspx.cs" Inherits="ContractManage_ContractReport_IncometContractContrast" %>
...
<head id="Head1" runat="server"><title>收入合同明细报表</title><link href="../../Script/jquery.tooltip/jquery.tooltip.css" rel="Stylesheet" type="text/css" />
                        ...
                        <td style="width: 100%;" valign="top">
                            <div style="width: 2600px;">
                                <asp:GridView ID="gvConract" AutoGenerateColumns="false" CssClass="gvdata" OnRowDataBound="gvPurchaseplan_RowDataBound" DataKeyNames="ContractId,isFContract" runat="server"><Columns><asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px" HeaderStyle-HorizontalAlign="Right"><ItemTemplate>
                                                ...
                                                <%# Eval("ContractCode") %>
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="合同名称" HeaderStyle-Width="150px"><ItemTemplate>
                                            ...
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="原始金额" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input"><ItemTemplate>
                                                <%# Eval("ContractPrice") %>
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="变更后的金额" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input"><ItemTemplate>
                                                <%# Eval("EndPrice") %>
                                            ...
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="甲方" HeaderStyle-Width="150px"><ItemTemplate>
                                            ...
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="变更累计" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input"><ItemTemplate>
                                                <%# Eval("ModifyPrice") %>
                                                ...
                                                <%# Eval("BalancePrice") %>
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="已收累计" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input"><ItemTemplate>
                                                <%# Eval("PaymentPrice") %>
                                                ...
                                                <%# Eval("InvoicePrice") %>
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="收款结算比率" ItemStyle-CssClass="percent"><ItemTemplate>
                                                <%# WebUtil.GetContrast(Eval("PaymentPrice").ToString(), Eval("BalancePrice").ToString()) %>
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="合同结算比率" ItemStyle-CssClass="percent"><ItemTemplate>
                                                <%# WebUtil.GetContrast(Eval("BalancePrice").ToString(), Eval("EndPrice").ToString()) %>
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="合同收款比率" ItemStyle-CssClass="percent"><ItemTemplate>
                                                <%# WebUtil.GetContrast(Eval("PaymentPrice").ToString(), Eval("EndPrice").ToString()) %>
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="已开发票收款比率" ItemStyle-CssClass="percent"><ItemTemplate>
