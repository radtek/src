<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayoutInvoice.aspx.cs" Inherits="ContractManage_ContractReport_PayoutInvoice" %>
...
<head runat="server"><title>支出合同发票报表</title><link href="../../Script/jquery.tooltip/jquery.tooltip.css" rel="Stylesheet" type="text/css" />
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			<td style="vertical-align: top;">
				<div class="pagediv" style="width: 1550px">
...
<Columns><asp:TemplateField HeaderText="序号" HeaderStyle-Width="25px"><ItemTemplate>
								...
								</ItemTemplate></asp:TemplateField><asp:BoundField HeaderText="签订人" DataField="SignPersonName" /><asp:BoundField DataField="ModifiedMoney" ItemStyle-HorizontalAlign="Right" HeaderText="最终金额" ItemStyle-CssClass="decimal_input" ItemStyle-Width="80px" /><asp:BoundField DataField="InvoiceTotal" ItemStyle-HorizontalAlign="Right" HeaderText="发票累计" ItemStyle-CssClass="decimal_input" ItemStyle-Width="80px" /><asp:TemplateField HeaderText="实际发票累计" ItemStyle-CssClass="decimal_input"><ItemTemplate>
									<%# WebUtil.SapRealContractMoney(Eval("ContractCode").ToString(), "A") %>
								</ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="发票已收比率" ItemStyle-CssClass="percent" ItemStyle-Width="120px"><ItemTemplate>
