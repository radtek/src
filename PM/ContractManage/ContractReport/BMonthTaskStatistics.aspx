<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BMonthTaskStatistics.aspx.cs" Inherits="ContractManage_ContractReport_BMonthTaskStatistics" %>
                    ...
                    <table border="0" class="tab">
                        ...
                        <tr>
                            <td style="width: 100%; background-color: rgb(238,242,242);" valign="top">
                                <asp:GridView ID="gvwPrjBudgetStatistics" Width="100%" AutoGenerateColumns="false" AllowPaging="true" CssClass="gvdata" ShowFooter="true" OnRowDataBound="gvwPrjBudgetStatistics_RowDataBound" OnPageIndexChanging="gvwPrjBudgetStatistics_PageIndexChanging" DataKeyNames="TaskId,ModifyType,SubCount,OrderNumber" runat="server">
<EmptyDataTemplate>
...
<ItemTemplate>
    ...
    <asp:HiddenField ID="hfldTotal2" Value="0" runat="server" />
    <asp:HiddenField ID="hfldMTotal" Value="0" runat="server" />
    <asp:HiddenField ID="hfldCTotal" Value="0" runat="server" />
    <asp:HiddenField ID="hfldTTotal" Value="0" runat="server" />
    </form>
</body>
</html>
