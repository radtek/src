...
public partial class ContractManage_PaymentApply_ViewPaymentApplyList : NBasePage, IRequiresSessionState
{
	...
	public void BindGv()
	{
		...
		this.BindGv(this.incometContractBll.GetInfoByParam(base.Request.QueryString["contractID"], "Con_Income_PaymentApply", base.UserCode, text));
	}
