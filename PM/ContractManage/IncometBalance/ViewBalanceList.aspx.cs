...
public partial class ContractManage_IncometBalance_ViewBalanceList : NBasePage, IRequiresSessionState
{
	...
	public void BindGv()
	{
		...
		this.BindGv(this.incometContractBll.GetInfoByParam(base.Request.QueryString["contractId"], "Con_Incomet_Balance", base.UserCode, text));
	}
