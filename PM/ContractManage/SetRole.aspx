<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SetRole.aspx.cs" Inherits="ContractManage_SetRole" EnableEventValidation="false" %>
            ...
            <tr>
                <td style="vertical-align: top; border: solid 0px red; width: 200px; text-align: left;"
                    ...
                    <div id="departmentDiv" style="height: 400px; width: 200px; overflow: auto; border: solid 1px #cdd4df;">
                        <asp:TreeView ID="trvwDepartment" Width="100%" ShowLines="true" ExpandDepth="1" OnSelectedNodeChanged="trvwDepartment_SelectedNodeChanged" runat="server"><SelectedNodeStyle CssClass="trvw_select" /></asp:TreeView>
                    </div>
                </td>
