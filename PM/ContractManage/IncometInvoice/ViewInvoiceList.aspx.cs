...
public partial class ContractManage_IncometInvoice_ViewInvoiceList : NBasePage, IRequiresSessionState
{
	...
	public void BindGv()
	{
		...
		this.BindGv(this.incometContractBll.GetInfoByParam(base.Request.QueryString["contractId"], "Con_Incomet_Invoice", base.UserCode, text));
	}
