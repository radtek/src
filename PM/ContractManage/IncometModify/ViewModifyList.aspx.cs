...
public partial class ContractManage_IncometModify_ViewModifyList : NBasePage, IRequiresSessionState
{
	...
	public void BindGv()
	{
		...
		this.BindGv(this.incometContractBll.GetInfoByParam(base.Request.QueryString["contractID"], "Con_Incomet_Modify", base.UserCode, text));
	}
