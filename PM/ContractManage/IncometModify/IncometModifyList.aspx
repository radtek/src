<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IncometModifyList.aspx.cs" Inherits="ContractManage_IncometModify_IncometModifyList" %>
...
<head id="Head1" runat="server"><title>收款合同变更列表</title>
    ...
    <script type="text/javascript">
     ...
     function rowEdit()
     {
      ...
      function rowBAdd()
     {
        var url="AddIncometModify.aspx?b=" + document.getElementById("hfldPurchaseChecked").value;
        winopen(url)
     }
     function rowQuery()
     {
