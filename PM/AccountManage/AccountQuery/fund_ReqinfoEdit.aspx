...
<link href="/Script/jquery.treeview/jquery.treeview.css" rel="Stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        ...
        function selectContr() {
            ...
            document.getElementById("ifFram").src = "/Common/DivSelectMyContrt.aspx?Method=returnContr";
            selectnEvent('divFram');
        }
...
<body>
   ...
   <div style="text-align:left; margin-left:130px">
    资金申请方式&nbsp; &nbsp; <asp:DropDownList ID="DroType" AutoPostBack="true" OnSelectedIndexChanged="DroType_SelectedIndexChanged" runat="server"><asp:ListItem Text="按合同" Value="0" /><asp:ListItem Text="按项目" Value="1" /></asp:DropDownList>
        ...
        <table class="tableFooter2">
            <tr>
                <td>
                    ...
                    <input type="button" id="btnCancel" value="取消" runat="server" />
