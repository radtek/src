<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fund_ReqinforeplyList.aspx.cs" Inherits="AccountManage_fund_Reqinfo_fund_ReqinforeplyList" %>
...
<link href="/Script/jquery.treeview/jquery.treeview.css" rel="Stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        ...
        function queryPurchase() {
            ...
            var url = "/AccountManage/fund_Reqinfo/fund_ReqinfoView.aspx?ic=" + document.getElementById('hfldPurchaseChecked').value;
            toolbox_oncommand(url, "资金申请查看");
        }
        ...
        <tr>
            <td style="vertical-align: top;">
                <table class="queryTable" cellpadding="3px" cellspacing="0px">
                    <tr>
                        <td>
                            <asp:DropDownList ID="DroType" AutoPostBack="true" OnSelectedIndexChanged="DroType_SelectedIndexChanged" runat="server"><asp:ListItem Text="按合同" Value="0" /><asp:ListItem Text="按项目" Value="1" /></asp:DropDownList>
                        </td>
                    ...
                    <table class="tab" style="vertical-align: top;">
                        <tr>
                            <td class="divFooter" style="text-align: left">
                                ...
                                <input id="btnQuery" type="button" value="查看" onclick ="queryPurchase()" disabled ="disabled"  />
                        ...
                        <tr>
                            <td>
                                <div class="pagediv">
                                    <asp:GridView ID="gvMony" AutoGenerateColumns="false" CssClass="gvdata" AllowPaging="true" PageSize="5" OnPageIndexChanging="gvPurchaseplan_PageIndexChanging" OnRowDataBound="gvPurchaseplan_RowDataBound" DataKeyNames="reqNum,auditState" runat="server"><Columns><asp:TemplateField HeaderText="序号" ItemStyle-Width="10px" ><ItemTemplate>
                                                    ...
                                                    <asp:Label ID="labReqNum" Text='<%# Convert.ToString(Eval("reqNum")) %>' runat="server"></asp:Label>
