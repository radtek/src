	...
	<div class="login-box">
		<div class="login-left">
           ...
           <%-- <div style="margin-top: 57px;">
                <img src="../UploadFiles\UserLogo\<%=this.logo %>" style="float: left;height: 30px;margin-top: 5px;"/>
            <div style="font-family: 微软雅黑;font-size: 26px;font-weight: bold;color: #ffffff;margin-left: 5px;float: left;">
                   <%=this.logoName %>
            </div></div>
		...
		<div class="login-right">
			...
			<ul>
				...
				<li>系统建议使用IE8.0以上版本浏览器，计算机屏幕</li>
				<li class="xx">分辨率1280*768或以上。</li>
			</ul>
		</div>
		<div class="login-bottom ">
			<div class="copyright">
				版权所有&copy;2007-2017<a href='#' target="_blank"></a>
			</div>
		</div>
	</div>
	</form>
