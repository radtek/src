<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalaryAdjustEdit.aspx.cs" Inherits="HR_Salary_SalaryAdjustEdit" %>
...
<body class="body_clear" scroll="no">
    ...
    <div>
     <table class="table-normal" cellspacing="0" cellpadding="0" width="100%" border="1">
      <tr>
             <td class="td-title" colspan="4">工资调标准调整</td>
      </tr>
	...
	<td class="td-label" style="width:15%;">
        姓名&nbsp;</td>
	<td colspan="3">
		<asp:TextBox ID="txtEmployeeCode" Width="70%" Enabled="false" runat="server"></asp:TextBox>
	...
	<tr>
	    ...
	    <td colspan="3">
		    <asp:TextBox ID="txtRemark" Width="90%" MaxLength="250" runat="server"></asp:TextBox>
	    </td>
	</tr>
	    <tr>
