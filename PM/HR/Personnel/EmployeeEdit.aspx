				...
				<iewc:MultiPage ID="MultiPage1" Height="100%" runat="server"><iewc:PageView ID="PageView1" runat="server">
						<table class="table-form" id="Table1" cellspacing="0" cellpadding="0" width="100%"
							...
							<tr>
								...
								<td style="width: 15%;">
									<asp:TextBox ID="txtMobilePhoneCode" CssClass="text-input  easyui-validatebox" data-options="required:true, validType:'validChars[20]'" MaxLength="13" TabIndex="20" Width="90%" runat="server"></asp:TextBox>
