...
public partial class HR_Personnel_QueryEmployee : NBasePage, IRequiresSessionState
{
	...
	public void BindGv()
	{
		this.AspNetPager1.RecordCount = this.ptDutyAction.GetEmployees_Count(this.txtCode.Text.Trim(), this.txtName.Text.Trim(), this.txtDepartment.Text.Trim(), this.txtPost.Text.Trim(), this.ddlEducationalBackground.Text.Trim(), this.ddlClassID.SelectedValue, this.ddlPostAndRank.Text.Trim(), this.ddlPositionLevel.SelectedValue, this.ddlWXZT.SelectedValue);
		DataTable employeesData = this.ptDutyAction.GetEmployeesData(this.txtCode.Text.Trim(), this.txtName.Text.Trim(), this.txtDepartment.Text.Trim(), this.txtPost.Text.Trim(), this.ddlEducationalBackground.Text.Trim(), this.ddlClassID.SelectedValue, this.ddlPostAndRank.Text.Trim(), this.ddlPositionLevel.SelectedValue, this.AspNetPager1.CurrentPageIndex, this.AspNetPager1.PageSize, this.ddlWXZT.SelectedValue);
	...
	public void ExportToExcel(string FileType, string FileName)
	{
		...
		DataTable employeesData = this.ptDutyAction.GetEmployeesData(this.txtCode.Text.Trim(), this.txtName.Text.Trim(), this.txtDepartment.Text.Trim(), this.txtPost.Text.Trim(), this.ddlEducationalBackground.Text.Trim(), this.ddlClassID.SelectedValue, this.ddlPostAndRank.Text.Trim(), this.ddlPositionLevel.SelectedValue, 1, this.AspNetPager1.RecordCount, this.ddlWXZT.SelectedValue);
	...
	public DataTable FormateExportTable(DataTable dt)
	{
        ...
        dataTable.Columns.Add("微信号", typeof(string));
        dataTable.Columns.Add("微信状态", typeof(string));
        for (int i = 0; i < dt.Rows.Count; i++)
		{
            ...
            dataRow["微信号"] = dt.Rows[i]["WXID"].ToString();
            dataRow["微信状态"] = dt.Rows[i]["WXZT"].ToString();
