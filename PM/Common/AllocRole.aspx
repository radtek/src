...
<body style="overflow: hidden">
    <form id="form1" runat="server">
        <div style="height: 95%; overflow: auto">
            <asp:GridView ID="gvwRole" CssClass="gvdata" AutoGenerateColumns="false" Width="100%" OnRowDataBound="gvwRole_RowDataBound" DataKeyNames="Id" runat="server">
                <Columns>
                    ...
                    <asp:BoundField DataField="Name" HeaderText="名称" HeaderStyle-Width="300px" />
                </Columns>
