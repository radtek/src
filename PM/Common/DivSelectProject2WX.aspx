...
<head runat="server">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function okEvent() {
            ...
            parent.$('#hfldProject').val(prj.prjId);
            parent.$('#txtProject').val(prj.prjName);
            page_close();
        }
...
<body>
    <form id="Form1" method="post" runat="server">
        <table id="Table2" class="table-nomal" height="85%" cellspacing="0" cellpadding="0"
            width="100%">
            <tr>
                <td style="text-align: left; height: 25px;">项目编号：<asp:TextBox ID="prjcode" Width="120px" runat="server"></asp:TextBox>&nbsp;
                </td>
            </tr>
            <tr>
                <td style="text-align: left; height: 25px;">项目名称：<asp:TextBox ID="prjname" Width="120px" runat="server"></asp:TextBox>&nbsp;
            ...
            <tr>
                <td valign="top" style="height: 100%; padding-top: 2px; vertical-align: top; text-align: center;">
                    <div id="Div1" style="width: 100%; text-align: left;" align="center">
                        <asp:GridView ID="gvwPrj" CellPadding="0" Width="100%" AutoGenerateColumns="false" AllowPaging="true" PageSize="15" OnPageIndexChanging="gvwPrj_PageIndexChanging" OnRowDataBound="gvwPrj_RowDataBound" DataKeyNames="Id,Code,Name,State,IsParent,TypeCode" runat="server">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="项目名称" ItemStyle-VerticalAlign="Middle">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="项目地点">
                                    <ItemTemplate>
        ...
        <div style="text-align: right">
            ...
            <input id="btnCancel" type="button" value="取 消" onclick="page_close();" />
        </div>
