...
public partial class Common_DivSelectProject3 : NBasePage, IRequiresSessionState
{
	...
	{
		System.Collections.Generic.IList<SelectProject> project = SelectProjectHelper.GetProject(base.UserCode, Parameters.PrjAvaildState, code, name);
