...
public partial class AsTestDetail : NBasePage, IRequiresSessionState
{
	...
	{
        AsTest byId = this.AstSer.GetById(this.pcId);
        if (byId != null)
        {
        ...
        //      AsTestService pTdbmService = new AsTestService();
