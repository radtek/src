...
function setWfButtonState2(jwTable, wfId) {
    ...
    jwTable.registClickSingleCHKListener(function () {
        ...
        //console.log($(this).parent().attr('guid'));
        //console.log(tr.attr('guid'));
        //console.log(tr.guid);
        console.log(tr);
        ...
        var prjGuid = "";
        var auditContent = "";
        var iis = tr.attributes.length;
        for(var ii = 0; ii < iis; ii++){
            var temp = tr.attributes[ii].name;
            if (temp.toLowerCase() == "guid") {
                    guid = tr.attributes[ii].value;
            }
            if (temp.toLowerCase() == "prjguid") {
                prjGuid = tr.attributes[ii].value;
            }
            if (temp.toLowerCase() == "auditcontent") {
                auditContent = tr.attributes[ii].value;
            }
        }
        //const arr = [1, 2, 3];
        ...
        //.tr.attributes[2]
        //for (var ii = 0; ii++; ii < tr.attributes.length) {
        //    var tr1= tr.attributes[ii].name;
        //    if (tr1 == "guid") {
        //        guid = tr.attributes[ii].value;
        //        break;
        //    }
        //}
        //for (var ii = 0; ii++; ii < tr.attributes.length) {
        //    if (tr.attributes[ii].name == "prjGuid") {
        //        prjGuid = tr.attributes[ii].value;
        //        break;
        //    }
        //}
        //for (var ii = 0; ii++; ii < tr.attributes.length) {
        //    if (tr.attributes[ii].name == "auditContent") {
        //        auditContent = tr.attributes[ii].value;
        //        break;
        //    }
        //}
        ...
        //项目相关
        $('input[id$=PrjGuid]').val(prjGuid);
        //审核内容
        $('input[id$=hidcontent]').val(auditContent);
