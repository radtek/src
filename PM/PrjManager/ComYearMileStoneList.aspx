<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ComYearMileStoneList.aspx.cs" Inherits="PrjManager_ComYearMileStoneList" %>
<%@ Import Namespace="Wuqi.Webdiyer"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server"><title>公司年度</title><link rel="Stylesheet" type="text/css" href="/Script/jquery.easyui/themes/default/easyui.css" />
...
</asp:TemplateField><asp:TemplateField HeaderText="上报时间" ItemStyle-HorizontalAlign="Left"><ItemTemplate>
