...
using Wuqi.Webdiyer;
public partial class PrjManager_PrjMilestoneDetailDepList : NBasePage, IRequiresSessionState
{
	...
	protected void btnImput_Click(object sender, System.EventArgs e)
	{
		...
		excelExporter.ExportAll(data, current, "部门明细.xls");
	}
