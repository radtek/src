<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrjMileStoneDetailList.aspx.cs" Inherits="PrjManager_PrjMilestoneDetailList" %>
...
<body>
    ...
    <div>
        <asp:GridView ID="gvPrjMilestoneDetail" CssClass="gvdata" AutoGenerateColumns="false" OnRowDataBound="gvPrjMilestoneDetail_RowDataBound" DataKeyNames="Id" runat="server">
<EmptyDataTemplate>
                <table id="emptyTable">
                    <tr class="header">
...
<ItemTemplate>
                        ...
                        <%# Eval("DepName") %>
                    </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="项目负责人"><ItemTemplate>
                        <%# Eval("UserName") %>
