<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserPrjMilestoneQuery.aspx.cs" Inherits="PrjManager_UserPrjMilestoneQuery" %>
<%@ Import Namespace="Wuqi.Webdiyer"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server"><title>工程项目进度及销售预测汇总表（人员）</title>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var justTable = new JustWinTable('UserPrjMilestoneQuery');
            replaceEmptyTable('emptyTable', 'UserPrjMilestoneQuery');
        });
        //选择人员
        ...
        function Query(name, time) {
            ...
            var url = '/PrjManager/PrjMileStoneDetailPerList.aspx?name=' + name + '&time=' + time;
            toolbox_oncommand(url, "个人汇总明细查看");
        }
    </script>
</head>
<body>
                ...
                <td style="vertical-align: top">
                    <table class="tab" style="vertical-align: top;">
                        ...
                        <tr>
                            <td>
                                <div>
                                    <asp:GridView ID="UserPrjMilestoneQuery" CssClass="gvdata" AutoGenerateColumns="false" ShowFooter="true" OnRowDataBound="UserPrjMilestoneQuery_RowDataBound" DataKeyNames="NUM" runat="server">
<EmptyDataTemplate>
                                            <table id="emptyTable">
                                                <tr class="header">
                                                    <th scope="col">
...
<ItemTemplate>
                                                    ...
                                                    <asp:HyperLink ID="hlinkShowName" Style="text-decoration: none; color: Black;" CssClass="tooltip" ToolTip='<%# System.Convert.ToString(Eval("v_xm").ToString(), System.Globalization.CultureInfo.CurrentCulture) %>' runat="server">                       
                                                        <span class="link" onclick="Query('<%# Eval("v_xm") %>','');">
                                                            <%# Eval("v_xm") %>
                                                        </span>
                                                    </asp:HyperLink>
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="项目储备额" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input"><ItemTemplate>
                                                    <%# Eval("StoreAmount") %>
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="当年预测" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input"><ItemTemplate>
                                                    <%# Eval("ForeCast") %>
                                                ...
                                                </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="明年预测" ItemStyle-HorizontalAlign="Right"><ItemTemplate>
                                                    <%# Eval("NextForeCast") %>
