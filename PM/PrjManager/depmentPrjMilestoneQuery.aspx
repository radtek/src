<%@ Page Language="C#" AutoEventWireup="true" CodeFile="depmentPrjMilestoneQuery.aspx.cs" Inherits="PrjManager_depmentPrjMilestoneQuery" %>
<%@ Import Namespace="Wuqi.Webdiyer"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server"><title>工程项目进度及销售预测汇总表（部门）</title>
    ...
    <script type="text/javascript">
        ...
        function Query(name) {
            ...
            var url = '/PrjManager/PrjMileStoneDetailDepList.aspx?name=' + name;
            toolbox_oncommand(url, "部门汇总明细查看");
        }
    </script>
</head>
<body>
                ...
                <td style="vertical-align: top">
                    <table class="tab" style="vertical-align: top;">
                        ...
                        <tr>
                            <td>
                                <div>
                                    <asp:GridView ID="depmentPrjMilestoneQuery" CssClass="gvdata" AutoGenerateColumns="false" ShowFooter="true" OnRowDataBound="depmentPrjMilestoneQuery_RowDataBound" DataKeyNames="NUM" runat="server">
<EmptyDataTemplate>
                                            <table id="emptyTable">
                                                <tr class="header">
                                                    <th scope="col">
