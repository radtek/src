<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ComMonthMileStoneList.aspx.cs" Inherits="PrjManager_ComMonthMileStoneList" %>
<%@ Import Namespace="Wuqi.Webdiyer"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server"><title>公司月度</title>
                ...
                <td style="vertical-align: top">
                    <table class="tab" style="vertical-align: top;">
                        ...
                        <tr>
                            <td>
                                <div>
                                    <asp:GridView ID="depmentPrjMilestoneQuery" CssClass="gvdata" AutoGenerateColumns="false" ShowFooter="true" runat="server">
<EmptyDataTemplate>
                                            <table id="emptyTable">
                                                <tr class="header">
                                                    <th scope="col">
