		...
		<table class="tableContent2" style="" cellpadding="5px" cellspacing="0">
			<tr>
				...
				<td class="elemTds txt mustInput">
					<asp:TextBox ID="txtResourceName" Height="15px" Width="100%" CssClass="easyui-validatebox" data-options="required: true, validType: 'validChars[30]'" runat="server" onkeydown="metion()"></asp:TextBox>
				</td>
			</tr>
			<tr>
				<td class="descTds">
...
<ItemTemplate>
	...
	<div id="divFooter" class="divFooter2">
		<table class="tableFooter2">
			<tr>
				<td>
                    <asp:Button ID="btnSaveMore" Text="保存并新增" OnClick="btnSaveMore_Click" runat="server" style="width: auto;"/>
					<asp:Button ID="btnSave" Text="保存并返回" OnClick="btnSave_Click" runat="server" style="width: auto;"/>
