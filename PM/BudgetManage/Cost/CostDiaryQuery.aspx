<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CostDiaryQuery.aspx.cs" Inherits="BudgetManage_Cost_CostDiaryQuery" %>
...
<link rel="Stylesheet" type="text/css" href="../../Script/jquery.easyui/themes/icon.css" />
	...
	<script type="text/javascript">
		...
		function openDetails(id, title) {
			...
			var url = '/BudgetManage/Cost/CostVerifyRecord.aspx?ic=';
			if (ddlValue == 'zzjg')
										...
										<td>
											<table class="queryTable" cellpadding="3px" cellspacing="0px">
												...
												<tr>
													...
													<td>
														<asp:DropDownList ID="ddlFlowState" Width="120px" runat="server"><asp:ListItem Text="" Value="" /><asp:ListItem Text="未提交" Value="-1" /><asp:ListItem Text="审核中" Value="0" /><asp:ListItem Text="已审核" Value="1" /><asp:ListItem Text="驳回" Value="-2" /><asp:ListItem Text="重报" Value="-3" /></asp:DropDownList>
													</td>
												</tr>
												<tr>
													<td>
...
<ItemTemplate>
																...
																</ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="金额" ItemStyle-CssClass="decimal_input" ItemStyle-HorizontalAlign="Right"><ItemTemplate>
																	 <%# Eval("TotalAmount") %>
																</ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="月度差额比例" HeaderStyle-Width="90px">
<ItemTemplate>
