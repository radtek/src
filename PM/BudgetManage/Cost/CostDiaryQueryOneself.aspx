                            ...
                            <tr>
                                <td style="width: 100%; vertical-align: top; height: 100%; border-left: solid 2px #CADEED;">
                                    <table>
                                            ...
                                            <td>
                                                <table class="queryTable" cellpadding="3px" cellspacing="0px">
                                                    <tr>
                                                        ...
                                                        <td class="descTd">经手人
                                                        <asp:DropDownList ID="ddlSelectPerson" Visible="false" runat="server">
                                                            <asp:ListItem Text="填报人" Value="1" Selected="true" />
                                                            <asp:ListItem Text="经手人" Value="0" />
                                                        </asp:DropDownList>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="descTd">审核状态
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlFlowState" Width="120px" runat="server">
                                                                <asp:ListItem Text="" Value="" Selected="true" />
                                                                <asp:ListItem Text="未提交" Value="-1" />
                                                                <asp:ListItem Text="审核中" Value="0" />
                                                                <asp:ListItem Text="已审核" Value="1" />
                                                                <asp:ListItem Text="驳回" Value="-2" />
                                                                <asp:ListItem Text="重报" Value="-3" />
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <tr>
                                            <td class="divFooter" style="text-align: right;"></td>
                                        </tr>
                                        <tr>
                                            <td style="vertical-align: top; height: 100%;">
                                                <div id="divBudget" style="overflow: hidden;">
                                                    ...
                                                    <div id="divDetails" style="border-style: none; border-top: solid 1px #CADEED; margin-top: 1px;">
                                                        <iframe id="ifDetails" style="width: 100%; height: 98%;" frameborder="none" border="0"></iframe>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
