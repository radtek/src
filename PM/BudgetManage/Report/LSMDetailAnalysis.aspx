<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LSMDetailAnalysis.aspx.cs" Inherits="BudgetManage_Report_LSMDetailAnalysis" %>
...
<head id="Head1" runat="server"><title>人材机成本明细表</title><link rel="Stylesheet" type="text/css" href="../../Script/jquery.easyui/themes/default/easyui.css" />
...
<body>
    ...
    <div class="divHeader" style="display: none;">
        <table class="tableHeader">
            <tr>
                <td>
                    <asp:Label ID="lblTitle" Font-Bold="true" Text="人材机成本明细表" runat="server"></asp:Label>
                </td>
            </tr>
        </table>
    </div>
...
<EmptyDataTemplate>
                                                        <table id="empetyFillTable">
                                                            <tr class="header">
                                                                ...
                                                                <th rowspan="2" class="tooltip" title=" 差额 = 目标成本.小计 &ndash; 报量成本.小计">
                                                                    差额
                                                                </th>
                                                            </tr>
                                                            <tr class="header">
...
<ItemTemplate>
                                                                <%# System.Convert.ToDecimal(Eval("StuffBudCost")).ToString("0.000") %>
                                                            </ItemTemplate>
</asp:TemplateField><asp:TemplateField HeaderStyle-Width="80px">
<ItemTemplate>
                                                                <%# System.Convert.ToDecimal(Eval("MachineBudCost")).ToString("0.000") %>
                                                            </ItemTemplate>
</asp:TemplateField><asp:TemplateField HeaderStyle-Width="80px">
<ItemTemplate>
...
<ItemTemplate>
                                                                <%# System.Convert.ToDecimal(Eval("StuffConsCost")).ToString("0.000") %>
                                                            </ItemTemplate>
</asp:TemplateField><asp:TemplateField HeaderStyle-Width="80px">
<ItemTemplate>
                                                                <%# System.Convert.ToDecimal(Eval("MachineConsCost")).ToString("0.000") %>
                                                            </ItemTemplate>
</asp:TemplateField><asp:TemplateField HeaderStyle-Width="80px">
<ItemTemplate>
