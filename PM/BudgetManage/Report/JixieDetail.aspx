<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JixieDetail.aspx.cs" Inherits="BudgetManage_Report_JixieDetail" %>
...
<head runat="server"><title>机械费差异分析表</title><link rel="Stylesheet" type="text/css" href="../../Script/jquery.tooltip/jquery.tooltip.css" />
...
<EmptyDataTemplate>
                                            <table class="gvdata" cellspacing="0" rules="all" border="1" id="emptyCost" style="width: 100%;
                                                ...
                                                <tr class='header'>
                                                    ...
                                                    <th rowspan="1" class="tooltip" title=" 差异金额 = 目标成本 &ndash; 实际成本">
                                                        差异金额
                                                    </th>
                                                    <th rowspan="1">
                                                        目标成本
...
</asp:TemplateField><asp:BoundField DataField="MonthTotalBud" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input" /><asp:BoundField DataField="Monthjiacha" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input" /><asp:BoundField DataField="Monthchazhi" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input" /><asp:BoundField DataField="TotalBud" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input" /><asp:BoundField DataField="QuantityChazhi" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input" /><asp:BoundField DataField="Jiacha" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input" /><asp:BoundField DataField="Chazhi" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="decimal_input" /></Columns><RowStyle CssClass="rowa"></RowStyle><AlternatingRowStyle CssClass="rowb"></AlternatingRowStyle><HeaderStyle CssClass="header"></HeaderStyle><FooterStyle CssClass="footer"></FooterStyle></asp:GridView>
