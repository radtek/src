<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EvenAnalysisDetail.aspx.cs" Inherits="BudgetManage_Report_EvenAnalysisDetail" %>
...
<head id="Head1" runat="server"><title>盈亏分析明细</title><link rel="Stylesheet" type="text/css" href="../../Script/jquery.easyui/themes/default/easyui.css" />
...
<body>
	...
	<div class="divHeader" style="display: none;">
		<table class="tableHeader">
			<tr>
				<td>
					<asp:Label ID="lblTitle" Font-Bold="true" Text="盈亏分析明细" runat="server"></asp:Label>
				</td>
			</tr>
		</table>
	</div>
...
<EmptyDataTemplate>
														<table id="empetyFillTable" class="gvdata">
															<tr class="header">
																<th rowspan="2">
																	序号
																</th>
...
<ItemTemplate>
																<span class="tooltip" title='<%# Eval("TaskCode").ToString() %>'>
																	<%# StringUtility.GetStr(Eval("TaskCode").ToString(), 25) %>
																</span>
															</ItemTemplate>
</asp:TemplateField><asp:TemplateField>
<ItemTemplate>
																<span class="tooltip" title='<%# Eval("TaskName").ToString() %>'>
																	<%# StringUtility.GetStr(Eval("TaskName").ToString(), 25) %>
																</span>
															</ItemTemplate>
...
<ItemTemplate>
																<%# System.Convert.ToDecimal(Eval("ConstructCost")).ToString("0.000") %>
															</ItemTemplate>
</asp:TemplateField><asp:TemplateField HeaderStyle-Width="80px" ItemStyle-CssClass="decimal_input">
<ItemTemplate>
