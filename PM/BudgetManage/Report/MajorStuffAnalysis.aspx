<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MajorStuffAnalysis.aspx.cs" Inherits="BudgetManage_Report_MajorStuffAnalysis" %>
...
<head id="Head1" runat="server"><title>主材分析表</title><link rel="Stylesheet" type="text/css" href="../../Script/jquery.easyui/themes/default/easyui.css" />
...
<link href="../../Script/jquery.tooltip/jquery.tooltip.css" rel="Stylesheet" type="text/css" />
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			var gvBudget = new JustWinTable('gvMajorStuff');
...
<body>
	...
	<div class="divHeader" style="display: none;">
		<table class="tableHeader">
			<tr>
				<td>
					<asp:Label ID="lblTitle" Font-Bold="true" Text="主材分析表" runat="server"></asp:Label>
				</td>
			</tr>
		</table>
	</div>
