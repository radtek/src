<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StuffDetailAnalysis.aspx.cs" Inherits="BudgetManage_Report_StuffDetailAnalysis" %>
...
<head id="Head1" runat="server"><title>材料明细表</title><link rel="Stylesheet" type="text/css" href="../../Script/jquery.easyui/themes/default/easyui.css" />
...
<link href="../../Script/jquery.tooltip/jquery.tooltip.css" rel="Stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var gvBudget = new JustWinTable('gvStuffCost');
            replaceEmptyTable('empetyFillTable', 'gvStuffCost');
            setWidthHeight();
            jw.tooltip();
        });
...
<body>
    ...
    <div class="divHeader" style="display: none;">
        <table class="tableHeader">
            <tr>
                <td>
                    <asp:Label ID="lblTitle" Font-Bold="true" Text="材料明细表" runat="server"></asp:Label>
                </td>
            </tr>
        </table>
    </div>
                                    ...
                                    <tr>
                                        <td style="width: 100%; height: 90%;">
                                            <div id="divBudget" class="pagediv" style="border-bottom: solid 0px red;">
                                                <asp:GridView ID="gvStuffCost" AutoGenerateColumns="false" DataKeyNames="" CssClass="gvdata" ShowFooter="true" OnRowDataBound="gvStuffCost_RowDataBound" runat="server">
<EmptyDataTemplate>
...
</asp:TemplateField><asp:TemplateField HeaderText="材料编号">
<ItemTemplate>
                                                                <%# Eval("ResourceCode") %>
                                                            </ItemTemplate>
</asp:TemplateField><asp:TemplateField HeaderText="材料名称">
<ItemTemplate>
...
</asp:TemplateField><asp:TemplateField HeaderText="出库金额" ItemStyle-CssClass="decimal_input" ItemStyle-HorizontalAlign="Right"><ItemTemplate>
                                                                <%# Eval("OutPrice") %>
