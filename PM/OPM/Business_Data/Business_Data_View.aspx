<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Business_Data_View.aspx.cs" Inherits="OPM_Business_Data_Business_Data_View" %>
<%@ Register TagPrefix="MyUserControl" TagName="stockmanage_common_showaudit_ascx" Src="~/StockManage/Common/ShowAudit.ascx" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server"><title>查看图纸信息</title>
            ...
            <tr id="tr_tb" runat="server"><td style="vertical-align: top" runat="server">
                    <table cellpadding="0" cellspacing="0" class="viewTable">
                        <tr>
                            ...
                            <td class="elemTd">
                                <asp:Label ID="lblBCode" runat="server"></asp:Label>
                            </td>
                            <td class="descTd">
                                图纸计划名称
                            </td>
            ...
            <tr id="tr_lb" runat="server"><td style="vertical-align: top" colspan="4" runat="server">
                    <table style="width: 100%; height: 50%; margin-top: 10px;" border="0">
                        <tr id="trAudit" style="vertical-align: top;">
                            <td>
                                <MyUserControl:stockmanage_common_showaudit_ascx ID="ShowAudit1" BusiCode="821" BusiClass="001" runat="server" />
                            </td>
                        </tr>
                    </table>
                </td></tr>
