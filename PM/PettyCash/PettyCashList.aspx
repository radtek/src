                    ...
                    <td>
                        <table class="queryTable" cellpadding="3px" cellspacing="0px">
                            <tr>
                                ...
                                <td class="descTd" style="width: 50px;">申请金额
                                </td>
                                <td>
                    ...
                    <td>
                        <asp:GridView ID="gvwPettyCash" CssClass="gvdata" Width="100%" AutoGenerateColumns="false" OnRowDataBound="gvwPettyCash_RowDataBound" DataKeyNames="Id" runat="server">
                            <EmptyDataTemplate>
                                <table class="gvdata" cellspacing="0" rules="all" border="1" id="gvwPettyCashEmpty"
                                    ...
                                    <tr class="header">
                                        ...
                                        <th scope="col" style="width: 80px;">申请日期
                                        </th>
                                        <th scope="col" style="width: 200px;">申请金额
                                        </th>
                                        <th scope="col" style="width: 100px;">事项
                                        </th>
                                        <th scope="col" style="width: 80px;">用款日期
                                        </th>
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Cash" HeaderText="申请金额" ItemStyle-Width="120px" ItemStyle-CssClass="decimal_input" ItemStyle-HorizontalAlign="Right" />
                                <asp:BoundField DataField="Matter" HeaderText="事项" />
                                <asp:TemplateField HeaderText="用款日期" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
