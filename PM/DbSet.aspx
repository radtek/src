<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DbSet.aspx.cs" Inherits="DbSet" %>
            ...
            <table style="width: 351px; border-right: lightblue 1px solid; table-layout: fixed;
                ...
                <tr>
                    <td colspan="2" style="height: 26px" align="right">
                        <asp:Button ID="Button3" Text="测\u3000试" Width="66px" OnClick="Button3_Click" runat="server" />
                        <asp:Button ID="Button2" Text="保存配置" Width="75px" OnClick="Button2_Click" runat="server" />
