<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="PrequalificationQuery.aspx.cs" Inherits="TenderManage_PrequalificationQuery" %>
...
<head runat="server"><title>资格预审项目一览</title>
...
</asp:TemplateField><asp:TemplateField HeaderText="项目状态" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px"><ItemTemplate>
                                                    <%# GetState(Eval("PrjState").ToString()) %>
                                                </ItemTemplate></asp:TemplateField><asp:BoundField HeaderText="项目跟踪人" DataField="Person" /><asp:BoundField HeaderText="项目编号" DataField="PrjCode" /><asp:TemplateField HeaderText="项目名称" HeaderStyle-Width="150px"><ItemTemplate>
...
<ItemTemplate>
                        ...
                        <tr>
                            <td style="padding-top: 5px">
                                标示：<span style='color: green; font-size: 20px;'>#</span>—报名通过<span style='color: green; font-size: 20px;'>●</span>—正在预审 <span style='color: green;
                                    font-size: 20px; font-weight: bold;'>√</span>—预审通过 <span style='color: green; font-size: 20px;
                                        font-weight: bold;'>×</span>—预审失败<span style='color: green; font-size: 20px;'>▼</span>—放弃
                            </td>
                        </tr>
                        <tr>
                            <td style="padding-top: 5px">
