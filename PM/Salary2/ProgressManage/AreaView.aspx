<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AreaView.aspx.cs" Inherits="ProgressManage_AreaView" %>


<!DOCTYPE html >
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server"><title>期间进度视图</title>
    ...
    <script type="text/javascript">
        ...
        function loadGantt(prjId) {
            var url = "../ProgressManage/Gantt/AreaView.htm?id=" + prjId;
