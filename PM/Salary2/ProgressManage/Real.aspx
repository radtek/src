<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Real.aspx.cs" Inherits="ProgressManage_Real" %>

<!DOCTYPE html >
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server"><title>实际进度上报</title>
    ...
    <script type="text/javascript">
        ...
        function loadGantt(prjId) {
            var url = "../ProgressManage/Gantt/Real.htm?id=" + prjId;
                                        ...
                                        <td style="vertical-align: top;" colspan="3">
                                            <div id="divBudget" class="pagediv" style="overflow: hidden;">
                                                <span id="noProject" style="color: Red; display: none;">没有项目可以加载</span> <span id="setDate"
                                                    style="color: Red; display: none;">项目的结束时间必须大于开始时间，请设置时间 </span>
