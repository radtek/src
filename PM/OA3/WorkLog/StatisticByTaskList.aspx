<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StatisticByTaskList.aspx.cs" Inherits="StatisticByTaskList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function viewLog(id) {
            top.ui._Task = window;
            var url = "/OA3/WorkLog/MyLogList.aspx?action=view&time=&taskId=" + id;
            title = '查看关联日志';
            toolbox_oncommand(url, title);
        }
    </script>
                ...
                <td style="vertical-align: top;">
                    <table class="queryTable">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="title" CssClass="easyui-validatebox" data-options="validType:'validQueryChars[50]'" runat="server"></asp:TextBox>
                            </td> &nbsp; &nbsp;
                           ...
                           <%-- <td style="white-space: nowrap;"></td>
                             <td class="descTd" style="white-space: nowrap;">任务执行日期
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:Button ID="btnQuery" style="margin-left: 10px;" Text="查询" OnClick="btnQuery_Click" runat="server" />
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <div class="pagediv">
                        <asp:GridView ID="GvList" CssClass="gvdata" Width="100%" AutoGenerateColumns="False" OnRowDataBound="GvList_RowDataBound" DataKeyNames="" runat="server">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="任务名称" HeaderStyle-Width="50px">
                                    <ItemTemplate>
                                           <%# Eval("title")%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="操作" HeaderStyle-Width="80px">
                                    <ItemTemplate>
                                        <a href="javascript:void(0)" onclick="viewLog('<%# Eval("id") %>')" style="margin-left: 10px;">查看关联日志</a> 
                                    </ItemTemplate>
                                </asp:TemplateField>
