<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckView.aspx.cs" Inherits="OA3_WorkTask_CheckView" %>
    ...
    <form id="form1" runat="server">
        <div class="VPage">
            ...
            <table class="tabCss" style="vertical-align: top; border-collapse: collapse;">
                <tr>
                    <td class="title-divHeader">工作任务信息详情
            ...
            <table class="tabCss" style="vertical-align: top; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td class="elemTd">
                        <asp:Label ID="progress" runat="server" class="decimal_input"></asp:Label>%
                        <a href="javascript:void(0)" onclick="upProgress()" style="margin-left: 10px;" runat="server" id="upProgress">[更新进度]</a>  
                  ...
                  <tr id="upShow">
                    ...
                    <tr id="up1">
                        <td class="descTd">更新进度
                        </td>
                        <td class="elemTd">
                            <asp:TextBox ID="t1" Height="100%" Width="80px" runat="server" class="mustInput"></asp:TextBox>%
                        </td>
                    </tr>
                    <tr id="up2">
                        <td class="descTd">进度说明
                        </td>
                        <td class="elemTd">
                            <asp:TextBox ID="t2" Style="overflow: auto; line-height: 1.25" Height="60px" Width="85%" Wrap="true" Rows="20" TextMode="MultiLine" runat="server"></asp:TextBox>
                         <input id="btnUP" name="submit" type="submit" value="更新进度" style="width: auto;" onserverclick="btnUP_Click" runat="server" />
                        </td>
                    </tr>
                <tr>
                    <td class="descTd">执行人
                ...
                <tr id="PLtitle" runat="server">
                    <td class="descTd" colspan="2">
                        <div class="cell_title_blue_line">
                            ...
                            <div class="cell_title_blue_bg">
                                <span class="titlespan">工作任务评论</span>
                            </div>
                            <div class="cell_title_blue_right">
                            </div>
                        </div>
