<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TaskEdit.aspx.cs" Inherits="OA3_WorkTask_TaskEdit" %>
    ...
    <script type="text/javascript">
        ...
        function typeChange() {
            ...
            if (tempId != 0) {
                if (document.getElementById('title').value == "" && document.getElementById('content').value == "") {
                    ...
                    if (confirm('是否用\'项目模版\'替换当前的\'标题\'和\'内容\'?')) {
                        ajax = 1;
                    } else { ajax = 0; }
                }
        ...
        function controlDate() {
            ...
            if (startDates != '' && endDates != '') {
                ...
                if (sTime - eTime > 0) {
                    $.messager.alert('系统提示', '工作任务 开始时间[' + startDates + ']</br>不能小于 结束时间[' + endDates + ']</br>请重新填写！');
        ...
        function valForm() {
            ...
            else if ($('#priority_id option:selected').val() == "") {
                alert("系统提示：\n任务优先级必须输入！");
                //document.getElementById("type_id").focus();
                return false;
            }
            ...
            <div align="center" id="mTable" style="margin-top: 5px; vertical-align: top;">
                <div style="vertical-align: top;">
                    <table class="tableContent2" cellpadding="5px"cellspacing="0"  style="vertical-align: middle; width: 80%">
                        <tr>
                            <td style="width: 10%; text-align: right;">任务类型</td>
                            <td style="width: 40%; text-align: left" class="mustInput" >
                                <asp:DropDownList ID="type_id"  runat="server" Width="99%" onchange="typeChange()"></asp:DropDownList>
                            </td>
                           <td style="width: 10%; text-align: right;">任务优先级</td>
                            <td style="width: 40%; text-align: left"  class="mustInput">
                                <asp:DropDownList ID="priority_id"  runat="server" Width="99%"></asp:DropDownList>
                            </td>
                        </tr>
                       ...
                       <tr>
                        ...
                        <tr>
                            <td style="text-align: right;"  style="width: 10%; text-align: right">开始时间
                            </td>
                            <td style="text-align: left" class="auto-style2" >
                                <table>
                                    <tr>
                                        ...
                                        <td style="background-color: #fafafa;display:none;">持续<asp:TextBox ID="txtValue" runat="server" onkeyup="AddOption();" sucmsg="填写正确" Style="text-align: right; width: 40px;" Width="50px" />
                        ...
                        <tr>
                            <td style="text-align: right;" class=" auto-style1 ">结束时间
                                        ...
                                        <td style="text-align: left" class="auto-style2 mustInput" >
                        ...
                        <tr>
                            <td style="width: 10%; text-align: right">任务内容
                            </td>
                            <td style="text-align: left;" colspan="3"  class="mustInput">
                        ...
                        <%--  <tr>
                          ...
                          <tr>
                            <td style="width: 10%; text-align: right">是否通知<%--更新进度时,</br>是否发送通知给--%>
                            </td>
                              <td style="text-align: left;" colspan="3">

                                  <asp:RadioButtonList ID="if_send" runat="server" RepeatDirection="Horizontal" Style="float: left; margin-right: 15px;">
                                      <asp:ListItem Value="1" Selected="True">是</asp:ListItem>
                                      <asp:ListItem Value="0">否</asp:ListItem>
                                  </asp:RadioButtonList>
                                  <label style="float: left; margin-top: 5px; color: #6d6b6b;">
                                      执行人更新任务进度时,是否发送微信消息给任务创建人</label>
                              </td>
                          </tr>
                        <tr>
                            <td style="width: 10%; text-align: right;">执行人
                            </td>
                            <td style="text-align: left" colspan="3">
                                <span class="spanSelect mustInput" style="width: 100%">
                            ...
                            <td style="text-align: left" colspan="3">
                                <span class="spanSelect" style="width: 100%;">
                                    <asp:TextBox ID="txtCopyto" Style="width: 90%; height: 15px; border: none; line-height: 16px; margin: 1px 2px"
                                        runat="server"></asp:TextBox>
                                    <img src="../../images/icon_17.bmp" style="float: right;" alt="选择" id="img1" onclick="jw.selectMultiUser({ nameinput: 'txtCopyto', codeinput: 'hfldCopyto' });" runat="server" />
                        ...
                        <tr>
                            <td style="text-align: right;"  style="width: 10%; text-align: right">相关图片
                            </td>
                            <td style="text-align: left" class="auto-style2" colspan="3">
                                <MyUserControl:usercontrol_fileupload_fileupload_ascx1 ID="FileUpload1" Name="图片" FileType="*.jpg;*.gif;*.png" Class="TaskPhotos" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right;"  style="width: 10%; text-align: right">相关音频
                            </td>
                            <td style="text-align: left" class="auto-style2" colspan="3">
                                <MyUserControl:usercontrol_fileupload_fileupload_ascx3 ID="FileUpload3" Name="音频"  Class="TaskVoices" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right;"  style="width: 10%; text-align: right">相关视频
                            </td>
                            <td style="text-align: left" class="auto-style2" colspan="3">
                                <MyUserControl:usercontrol_fileupload_fileupload_ascx4 ID="FileUpload4" Name="视频"  Class="TaskVideos" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right;"  style="width: 10%; text-align: right">相关附件
                            </td>
                            <td style="text-align: left" class="auto-style2" colspan="3">
                                <MyUserControl:usercontrol_fileupload_fileupload_ascx2 ID="FileUpload2" Name="附件" Class="TaskFiles" runat="server" />
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <table class="tableFooter2">
                <tr>
                    <td>
                      ...
                      <%--  <asp:Button ID="btnSaveWC" Text="保存并完成" OnClientClick="return valForm()" OnClick="btnSaveWC_Click"  runat="server" style="width: auto;"/>
                        <asp:Button ID="btnSaveGB" Text="保存并关闭" OnClientClick="return valForm()" OnClick="btnSaveGB_Click"  runat="server" style="width: auto;"/>--%>
