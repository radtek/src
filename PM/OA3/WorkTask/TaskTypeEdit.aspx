<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TaskTypeEdit.aspx.cs" Inherits="OA3_WorkTask_TaskTypeEdit" %>
<!DOCTYPE html>
            ...
            <div align="center" id="mTable" style="margin-top: 5px; vertical-align: top;">
                <div style="vertical-align: top;">
                    <table class="tableContent2" style="vertical-align: middle; width: 80%">
                        <tr>
                            <td style="text-align: right;" class="auto-style1">任务类型名称
                            </td>
                        ...
                        <tr>
                            <td style="text-align: right;" class="auto-style1">排序
                            </td>
                            <td style="text-align: left" class="auto-style2">
                                <%--<asp:TextBox ID="sort" Height="100%" Width="99%" runat="server"></asp:TextBox>--%>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left" class="auto-style2">
                                ...
                                <%--<asp:CheckBoxList ID="is_use" runat="server" Height="16px" RepeatDirection="Horizontal">
                                    
                                </asp:CheckBoxList>--%>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right;" class="auto-style1">任务标题缺省值
                            </td>
                            <td style="text-align: left" class="auto-style2">
                        ...
                        <tr>
                            <td style="width: 15%; text-align: right">任务内容缺省值
                            </td>
                        ...
                        <tr>
                            <td style="text-align: right;" class="auto-style1">备注说明
                            </td>
                            <td style="text-align: left" class="auto-style2">
