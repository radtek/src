...
mini.extend(CalendarWindow, mini.Window, {
    ...
    initControls: function() {
        ...
        this.setBody(
            ...
            '<div style="height:190px;overflow:hidden; display:none;"><div style="float:left;width:150px;">图例：</div>' +
            ...
            '</div>' +
            '<div class="mini-tabs" activeIndex="0" bodyStyle="padding:0;" height="270" >' +
                '<div title="例外日期">' +
                    ...
                    '</div>' +
                    '<div id="cwin_exceptions" class="mini-supergrid" style="width:100%;height:205px;" borderStyle="border:0;">' +
                        '<div property="columns">' +
                            ...
                            '<div name="from" field="FromDate" >开始日期<input property="editor" id="cwin_fromdate" class="mini-datepicker" readOnly="false" /></div>' +
                            '<div name="to" field="ToDate" >完成日期<input property="editor" id="cwin_todate" class="mini-datepicker" readOnly="true"/></div>' +
                        '</div>' +
                    '</div>' +
                '</div>' +
                '<div title="工作周" >' +
                    '<div id="cwin_weekdays" class="mini-supergrid" style="width:100%;height:240px;" borderStyle="border:0;">' +
                        '<div property="columns">' +
                            '<div type="checkboxcolumn" trueValue="1" falseValue="0" field="DayWorking" width="60">工作日</div>' +
