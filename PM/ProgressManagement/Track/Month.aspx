<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Month.aspx.cs" Inherits="ProgressManagement_Track_Month" %>
...
<head id="Head1" runat="server"><title>月度报告</title><link rel="Stylesheet" type="text/css" href="../../Script/jquery.tooltip/jquery.tooltip.css" />
	...
	<script type="text/javascript">
		...
		function lookInfo(version, verId, verName) {
			var url = '/ProgressManagement/Track/TrackDetail.aspx?' + new Date().getTime() + '&verId=' + verId + '&type=1';
			toolbox_oncommand(url, verName + '-月度报告');
		}
	</script>
</head>
<body>
							...
							<td style="width: 100%; vertical-align: top; height: 100%; border-left: solid 2px #CADEED;">
								<table class="tab">
									<tr class="divFooter" style="text-align: left;">
										<td>
											<input type="button" id="btnEdit" value="月度报告" disabled="disabled" style="width: auto;" />
										</td>
									</tr>
									<tr>
