<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlanWarn.aspx.cs" Inherits="ProgressManagement_Actual_PlanWarn" %>
...
<head id="Head1" runat="server"><title>进度计划预警</title>
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			setButton(jwTable, 'btnEmpty', 'btnEmpty', 'btnLook', 'hfldChecked');
		...
		function lookInfo(version, verId, verName) {
			var url = '/ProgressManagement/Actual/PlanWarnDetail.aspx?' + '&verId=' + verId;
			toolbox_oncommand(url, verName + '-进度预警');
		}
	</script>
	<style type="text/css">
		.style1
							...
							<td style="width: 100%; vertical-align: top; height: 100%; border-left: solid 2px #CADEED;">
								<table class="tab">
									<tr class="divFooter" style="text-align: left;">
										<td>
											<input type="button" id="btnLook" value="查看进度预警" disabled="disabled" style="width: auto;" />
										</td>
									</tr>
									<tr>
										<td style="vertical-align: top;" colspan="3">
											<div id="divBudget" class="pagediv" style="overflow: hidden;">
												<asp:GridView ID="gvwPlans" CssClass="gvdata" AutoGenerateColumns="false" OnRowDataBound="gvwPlans_RowDataBound" DataKeyNames="ProgressId" runat="server">
<EmptyDataTemplate>
														<table id="tblEmpty">
															<tr class="header">
