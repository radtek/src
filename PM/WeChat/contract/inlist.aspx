<%@ Page Language="C#" AutoEventWireup="true" CodeFile="inlist.aspx.cs" Inherits="WeChat_contract_inlist" %>
    ...
    <form id="form1" runat="server">
        ...
        <script type='text/javascript'>
            ...
            function addItems(rows, page) {//获取数据函数
                ...
                $.ajax({
                    type: "POST",   //请求方式
                    url: "../contract/inlist.aspx/getList",    //请求的url地址
                            ...
                            if (res[0].data) {
                                ...
                                for (var i = 0; i < d.length; i++) {
                                    ...
                                    listHtml += "<div class=\"settings-item\">" +
                                        "<span class=\"time\">" +
                                            "<span style=\"float: right\">签约日期：" + d[i].SignedTime + "</span>" +
                                            "<span style=\"float:right;margin-top:17px;margin-right:-110px\">签订类型：" + temp + "</span>" +
                                        "</span>" +
            ...
            function gotoDetail(Id) {
                //$.showPreloader('加载中');
                var url =  '/ContractManage/IncometContract/IncometContractQueryMobel.aspx?ic=' + Id;
