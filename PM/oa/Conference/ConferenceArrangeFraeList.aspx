<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConferenceArrangeFraeList.aspx.cs" Inherits="ConferenceArrangeFraeList" %>
...
<head runat="server"><title></title>
	...
	function ClickRow(op,recordId)
	{
	    if (op=="0")
	    {
	        ...
	        document.getElementById('hdnMeetingInfoID').value = recordId;
	    }
	    else
	    {
            document.getElementById('btnEdit'+op).disabled = false;
	        document.getElementById('btnDel'+op).disabled = false;
	        document.getElementById('hdnMeetingInfoID'+op).value = recordId;
	    }
	}
	function openArrangeFraeEdit(types,op,MeetingInfoID)
	{
	    var recordId = 0;
	    var stateParm = "";
		if (op==2)
		{
		    if (types == "0")
		        recordId = document.getElementById('hdnMeetingInfoID').value;
		    else
			    recordId = document.getElementById('hdnMeetingInfoID'+types).value;
		}
		if (types == "0")
		{
		    var url= "SubsectionEdit.aspx?t=" + op + "&mid=" + MeetingInfoID + "&rid="+ recordId;
		    stateParm = "dialogHeight:250px;dialogWidth:400px;center:1;help:0;status:0;";
		}
		else if (types == "1")
		{
		    var url= "MeetingWaiterEdit.aspx?t=" + op + "&mid=" + MeetingInfoID + "&rid="+ recordId;
		    stateParm = "dialogHeight:140px;dialogWidth:400px;center:1;help:0;status:0;";
		}
		else if (types == "2")
		{
		    var url= "MeetingEquipmentEdit.aspx?t=" + op + "&mid=" + MeetingInfoID + "&rid="+ recordId;
		    stateParm = "dialogHeight:140px;dialogWidth:400px;center:1;help:0;status:0;";
		}
		else
		{
		    var url= "MeetingProjectEdit.aspx?t=" + op + "&mid=" + MeetingInfoID + "&rid="+ recordId;
		    stateParm = "dialogHeight:160px;dialogWidth:400px;center:1;help:0;status:0;";
		}
            ...
            <iewc:MultiPage ID="MultiPage1" Height="100%" runat="server"><iewc:PageView runat="server">
                    <table id="table2" border="1" cellpadding="0" cellspacing="0" class="table-form" width="100%">
                        ...
                        <tr id="btnTr" height="24" runat="server"><td class="td-toolsbar" runat="server">
						        <input type="hidden" id="hdnMeetingInfoID" name="hdnMeetingInfoID" style="WIDTH: 10px" runat="server" />
...
<EmptyDataTemplate>
                                            <table class="grid" cellspacing="0" rules="all" border="1" id="gvSubsection" style="border-collapse:collapse;">
                                                <tr class="grid_head">
...
<Triggers><asp:AsyncPostBackTrigger ControlID="__Page" EventName="Load" runat="server" /><asp:AsyncPostBackTrigger ControlID="btnAdd" EventName="Click" runat="server" /><asp:AsyncPostBackTrigger ControlID="btnEdit" EventName="Click" runat="server" /><asp:AsyncPostBackTrigger ControlID="btnDel" EventName="Click" runat="server" /></Triggers></asp:UpdatePanel>
                    ...
                    <table id="table3" border="1" cellpadding="0" cellspacing="0" class="table-form" width="100%">
                        ...
                        <tr id="btnTr1" height="24" runat="server"><td class="td-toolsbar" runat="server">
						        <input type="hidden" id="hdnMeetingInfoID1" name="hdnMeetingInfoID1" style="WIDTH: 10px" runat="server" />
...
<ItemTemplate>
                                ...
                                <asp:SqlDataSource ID="SqlWaiter" SelectCommand="SELECT [RecordID],[MeetingInfoID], [WaiterCode], [WaiterName], [Content] FROM [OA_Meeting_Waiter] WHERE ([MeetingInfoID] = @MeetingInfoID)" ConnectionString='<%$ ConnectionStrings:Sql %>' runat="server"><SelectParameters><asp:QueryStringParameter Name="MeetingInfoID" QueryStringField="mid" Type="Int32"></asp:QueryStringParameter></SelectParameters></asp:SqlDataSource>
                                </ContentTemplate>
<Triggers><asp:AsyncPostBackTrigger ControlID="__Page" EventName="Load" runat="server" /><asp:AsyncPostBackTrigger ControlID="btnAdd1" EventName="Click" runat="server" /><asp:AsyncPostBackTrigger ControlID="btnEdit1" EventName="Click" runat="server" /><asp:AsyncPostBackTrigger ControlID="btnDel1" EventName="Click" runat="server" /></Triggers></asp:UpdatePanel>
                    ...
                    <table id="table4" border="1" cellpadding="0" cellspacing="0" class="table-form" width="100%">
                        ...
                        <tr id="btnTr2" height="24" runat="server"><td class="td-toolsbar" runat="server">
						        <input type="hidden" id="hdnMeetingInfoID2" name="hdnMeetingInfoID2" style="WIDTH: 10px" runat="server" />
...
<ItemTemplate>
                                ...
                                <asp:SqlDataSource ID="SqlEquipment" SelectCommand="SELECT [RecordID], [MeetingInfoID], [EquipmentName], [Number] FROM [OA_Meeting_Equipment] WHERE ([MeetingInfoID] = @MeetingInfoID)" ConnectionString='<%$ ConnectionStrings:Sql %>' runat="server"><SelectParameters><asp:QueryStringParameter Name="MeetingInfoID" QueryStringField="mid" Type="Int32"></asp:QueryStringParameter></SelectParameters></asp:SqlDataSource>
                                </ContentTemplate>
<Triggers><asp:AsyncPostBackTrigger ControlID="__Page" EventName="Load" runat="server" /><asp:AsyncPostBackTrigger ControlID="btnAdd2" EventName="Click" runat="server" /><asp:AsyncPostBackTrigger ControlID="btnEdit2" EventName="Click" runat="server" /><asp:AsyncPostBackTrigger ControlID="btnDel2" EventName="Click" runat="server" /></Triggers></asp:UpdatePanel>
                    ...
                    <table id="table5" border="1" cellpadding="0" cellspacing="0" class="table-form" width="100%">
                        ...
                        <tr id="btnTr3" height="24" runat="server"><td class="td-toolsbar" runat="server">
						        <input type="hidden" id="hdnMeetingInfoID3" name="hdnMeetingInfoID3" style="WIDTH: 10px" runat="server" />
...
<ItemTemplate>
                                ...
                                <asp:SqlDataSource ID="SqlProject" SelectCommand="SELECT [RecordID], [MeetingInfoID], [ProjectName], [Content], [OriginalName], [FilePath] FROM [OA_Meeting_Project] WHERE ([MeetingInfoID] = @MeetingInfoID)" ConnectionString='<%$ ConnectionStrings:Sql %>' runat="server"><SelectParameters><asp:QueryStringParameter Name="MeetingInfoID" QueryStringField="mid" Type="Int32"></asp:QueryStringParameter></SelectParameters></asp:SqlDataSource>
                                </ContentTemplate>
