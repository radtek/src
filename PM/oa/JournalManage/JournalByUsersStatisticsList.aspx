<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JournalByUsersStatisticsList.aspx.cs" Inherits="oa_JournalManage_JournalByUsersStatisticsList" %>
                    ...
                    <div class="pagediv">
                        <asp:GridView ID="GvList" CssClass="gvdata" Width="100%" AutoGenerateColumns="False" OnRowDataBound="GvList_RowDataBound" DataKeyNames="creater" runat="server">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="总时长(分钟)" HeaderStyle-Width="80px">
                                    <ItemTemplate>
                                     <%# Eval("sums") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
