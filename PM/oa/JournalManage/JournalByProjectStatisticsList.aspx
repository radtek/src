<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JournalByProjectStatisticsList.aspx.cs" Inherits="oa_JournalManage_JournalByProjectStatisticsList" %>
                    ...
                    <table class="queryTable">
                        <tr>
                         <%--   <td class="descTd" style="white-space: nowrap;">标题
                            ...
                            <td class="descTd" style="white-space: nowrap;">填写日期
                            </td>
                            <td>
                    ...
                    <div class="pagediv">
                        <asp:GridView ID="GvList" CssClass="gvdata" Width="100%" AutoGenerateColumns="False" OnRowDataBound="GvList_RowDataBound" DataKeyNames="creater" runat="server">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="工作日志总数" HeaderStyle-Width="80px">
                                    <ItemTemplate>
                                        <%# Eval("counts") %>
                                        </span>
                                    </ItemTemplate>
