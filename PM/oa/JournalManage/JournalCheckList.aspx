<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JournalCheckList.aspx.cs" Inherits="oa_JournalManage_JournalCheckList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function view() {
            top.ui._Journal = window;
            var url = "/oa/JournalManage/JournalCheckDetail.aspx?action=view&id=" + document.getElementById('KeyId').value;
            title = '查看工作日志';
            toolbox_oncommand(url, title);
        }
            ...
            <tr>
                <td style="vertical-align: top;">
                    <table class="queryTable">
                        <tr>  <td class="descTd" style="white-space: nowrap;">日志状态
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="txtStartTime" style="width: 110px;" onclick="WdatePicker()" runat="server"></asp:TextBox>
                            </td>
                            <td class="descTd" style="white-space: nowrap;">至
                            </td>
                            <td>
                                <asp:TextBox ID="txtEndTime" style="width: 110px;" onclick="WdatePicker()" runat="server"></asp:TextBox>
                            </td>
                        ...
                        <asp:GridView ID="GvList" CssClass="gvdata" Width="100%" AutoGenerateColumns="False" OnRowDataBound="GvList_RowDataBound" DataKeyNames="Id" runat="server">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="标题">
                                    <ItemTemplate>
                                      <%--  <%# Eval("title").ToString() %>--%>
                                        <asp:HyperLink ID="HyperLink1" NavigateUrl="" Text='<%# Convert.ToString(Eval("title")) %>' runat="server"></asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="结束时间">
                                    <ItemTemplate>
                                        <center><%# System.Convert.ToDateTime(Eval("end_time")).ToString("MM-dd HH:mm") %></center>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="内容" HeaderStyle-Width="380px">
                                    <ItemTemplate>
                                        <span class="tooltip" title="<%# Eval("content") %>">
                                            <%# StringUtility.GetStr(Eval("content").ToString(), 100) %>
                                        </span>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="填写日期">
                                    <ItemTemplate>
                                        <center><%# Common2.GetTime(Eval("create_date")) %></center>
                                    </ItemTemplate>
                                </asp:TemplateField>
