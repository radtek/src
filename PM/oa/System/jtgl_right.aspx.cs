...
public partial class oa_System_jtgl_right : BasePage, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			this.btnAdd.Attributes["onclick"] = "showEditWin('add');";
			this.btnEdit.Attributes["onclick"] = "showEditWin('edit');";
	...
	protected void SystemInfoBind()
	{
		...
		if (base.Request["cid"] != "")
		{
			strWhere = "a.SystemType=1 and a.ClassID=" + base.Request["cid"].ToString();
		}
		else
		{
			strWhere = "SystemType=1";
		}
