<%@ Page Language="C#" AutoEventWireup="true" CodeFile="worklogupdate.aspx.cs" Inherits="workLogUpdate" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<head runat="server"><title>日志更新</title><meta Content="Microsoft Visual Studio .NET 7.1" Name="GENERATOR" />
	...
	<body bgColor="#ffffff">
		<form id="Form1" method="post" runat="server">
			<table class="table-none" width="50%" align="center" border="0">
				...
				<tr>
					<td width="25%"></td>
					<td align="center" width="25%"><asp:Button ID="btnAdd" CssClass="button-normal" Text=" 提交 " OnClick="btnAdd_Click" runat="server" /></td>
					<td align="center" width="25%"><input class="button-normal" type="reset" value=" 重写 " name="btnCancel">
					</td>
					<td width="25%"></td>
				</tr>
			</table>
