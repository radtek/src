<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubCompanyPersonFrame.aspx.cs" Inherits="oa_WorkManage_BlocManage_SubCompanyPersonFrame" %>
...
<meta http-equiv="Pragma" content="no-cache" />
    ...
    <script language="javascript" type="text/javascript">
        function ClickRow(PARecordID,IsComplete)
        {
            ...
            frmMatter.location.href = "SubCompanyPersonDraw.aspx?id="+PARecordID;
        }
    </script>
</head>
...
<HeaderStyle HorizontalAlign="Center" CssClass="grid_head"></HeaderStyle><Columns><asp:BoundField HeaderText="序号" HtmlEncode="false" /><asp:BoundField DataField="ApplyDate" HeaderText="申请日期" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="false" /><asp:BoundField HeaderText="申请人" HtmlEncode="false" /><asp:BoundField HeaderText="状态" HtmlEncode="false" /></Columns><RowStyle CssClass="grid_row"></RowStyle><PagerStyle HorizontalAlign="Center"></PagerStyle><PagerSettings FirstPageText="首页" LastPageText="尾页" NextPageText="下一页" PreviousPageText="上一页"></PagerSettings></asp:GridView>
                        <asp:SqlDataSource ID="SQLDataSource" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [OA_OfficeRes_PersonalApplication] as a inner join OA_OfficeRes_ApplicationCollect b 
on a.ACRecordID = b.ACRecordID where AuditState = 1 and a.IsSubmit = 1 and a.CorpCode<>'00' " ConnectionString='<%$ ConnectionStrings:Sql %>' runat="server"></asp:SqlDataSource>
                    </div>
                </td>
             </tr>
             <tr>
                <td height="50%" valign="top">
                    <iframe id="frmMatter" name="frmMatter" src="SubCompanyPersonDraw.aspx?id=0" frameborder="0" width="100%" height="100%" runat="server"></iframe>
                </td>
            </tr>
        </table>
    </form>
