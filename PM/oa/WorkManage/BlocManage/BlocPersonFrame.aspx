<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BlocPersonFrame.aspx.cs" Inherits="oa_WorkManage_BlocManage_BlocPersonFrame" %>
...
<meta http-equiv="Pragma" content="no-cache" />
    ...
    <script language="javascript" type="text/javascript">
        function ClickRow(PARecordID,IsComplete)
        {
            ...
            frmMatter.location.href = "BlocPersonDraw.aspx?id="+PARecordID;
        }
    </script>
</head>
...
on a.ACRecordID = b.ACRecordID where b.AuditState = 1 and a.IsSubmit = 1 and a.CorpCode='00' " ConnectionString='<%$ ConnectionStrings:Sql %>' runat="server"></asp:SqlDataSource>
                    </div>
                </td>
             </tr>
             <tr>
                <td height="50%" valign="top">
                    <iframe id="frmMatter" name="frmMatter" src="BlocPersonDraw.aspx?id=0" frameborder="0" width="100%" height="100%" runat="server"></iframe>
                </td>
            </tr>
        </table>
    </form>
