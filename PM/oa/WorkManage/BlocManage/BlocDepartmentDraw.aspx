<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BlocDepartmentDraw.aspx.cs" Inherits="oa_WorkManage_BlocManage_BlocDepartmentDraw" %>
...
<body class="body_clear" scroll="no">
    <form id="formx" runat="server">
        <table width="100%"  height="100%" cellpadding="0" cellspacing="0" border="0" id="tablex" class="table-normal">
            <tr>
                <td height="20px" class="td-title">用品领用办理（集团部门领用）</td>
            </tr>
            <tr>
