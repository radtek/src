<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IndividualDrawApplyAssTab.aspx.cs" Inherits="oa_WorkManage_StorageManage_IndividualDrawApplyAssTab" %>
...
<meta http-equiv="Pragma" content="no-cache" />
	...
	function OpenWin(op)
	{
	    ...
	    var useCode = document.getElementById('HdnUseCode').value;
		var url= "IndividualDrawApplyAssTabEdit.aspx?op=" + op + "&rid=" + RecordID + "&id="+ InStorageID +"&uc="+useCode;
...
<body class="body_clear" scroll="no">
    <form id="formx" runat="server">
        <table width="100%"  height="100%" cellpadding="0" cellspacing="0" border="0" id="tablex" class="table-normal">
            <tr>
                <td height="20px" class="td-title">个人领用申请</td>
            </tr>
            <tr>
                <td height="20px" class="td-toolsbar">
                    ...
                    <input id="HdnUseCode" type="hidden" style="width:20px" runat="server" />
