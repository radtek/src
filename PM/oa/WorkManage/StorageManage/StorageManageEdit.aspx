<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageManageEdit.aspx.cs" Inherits="oa_WorkManage_StorageManage_StorageManageEdit" %>

<html>
<head id="Head1" runat="server"><title>����ֿ���Ϣ</title><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <table class="table-form" id="tablex" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="1">
		...
		<tr>
			<td class="td-label" width="20%">
                ���ӻ�������</td>
			<td>
                <asp:DropDownList ID="DDLCorp" DataSourceID="SqlDataSource" DataTextField="CorpName" DataValueField="CorpCode" runat="server"></asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [CorpCode], [CorpName] FROM [PT_d_CorpCode] ORDER BY [CorpCode]" ConnectionString='<%$ ConnectionStrings:Sql %>' runat="server"></asp:SqlDataSource>
			</td>
		</tr>  
		<tr>
			<td class="td-label" width="20%">
