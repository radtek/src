<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DepartmentDrawApplyEdit.aspx.cs" Inherits="oa_WorkManage_StorageManage_DepartmentDrawApplyEdit" %>
    ...
    <form id="Formx" runat="server">
		...
		<tr>
			<td class="td-label" width="20%">
                ������</td>
			<td><asp:TextBox ID="txtApplyPerson" CssClass="text-input" Enabled="false" runat="server"></asp:TextBox>
			</td>
			<td class="td-label" width="20%">
                ���벿��</td>
			<td><asp:TextBox ID="txtApplyDept" CssClass="text-input" Enabled="false" runat="server"></asp:TextBox>
			</td>
		</tr> 
		<tr>
			<td class="td-label" width="20%">
