<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplySelectFrame.aspx.cs" Inherits="oa_WorkManage_SubCompanyManage_ApplySelectFrame" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server"><title>个人申请记录</title><meta http-equiv="Expires" content="0" />
<meta http-equiv="Cache-Control" content="no-cache" />
<meta http-equiv="Pragma" content="no-cache" />

	<base target="_self">
    <script language="javascript" type="text/javascript">
    function ClickRow(GuidMainID,InStorageID,AuditState,useMan)
	{
		frmInStoreroom.location.href = "ApplySelectList.aspx?ic="+GuidMainID+"&id="+InStorageID+"&uc="+useMan;
	}
    </script>
</head>
...
<HeaderStyle HorizontalAlign="Center" CssClass="grid_head"></HeaderStyle><Columns><asp:BoundField HeaderText="序号" /><asp:BoundField DataField="ApplyDate" HeaderText="申请日期" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="false" /><asp:BoundField HeaderText="申请人" HtmlEncode="false" /></Columns><RowStyle CssClass="grid_row"></RowStyle><PagerStyle HorizontalAlign="Center"></PagerStyle><PagerSettings FirstPageText="首页" LastPageText="尾页" NextPageText="下一页" PreviousPageText="上一页"></PagerSettings></asp:GridView>
                    </div>
                </td>
            </tr>
            <tr>
                <td valign="top" height="60%">
                    <iframe id="frmInStoreroom" frameborder="0" width="100%" height="100%" src="ApplySelectList.aspx?ic=&id=&uc=" runat="server"></iframe>
                </td>
            </tr>
        </table>
    </form>
