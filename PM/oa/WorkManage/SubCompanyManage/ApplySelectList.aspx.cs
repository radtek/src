...
public partial class oa_WorkManage_SubCompanyManage_ApplySelectList : BasePage, IRequiresSessionState
{
	public OAOfficeResPersonalApplicationDetailAction pAction
	{
		get
		{
	...
	private void Bind()
	{
		this.GVBook.DataSource = this.pAction.GetList("a.PARecordID=" + this.RecordID);
