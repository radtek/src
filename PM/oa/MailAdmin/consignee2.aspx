<%@ Page Language="C#" AutoEventWireup="true" CodeFile="consignee2.aspx.cs" Inherits="oa_MailAdmin_consignee2" %>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <table height="378" cellspacing="0" cellpadding="0" width="100%" border="0">
                                            ...
                                            <tr>
                                                <td bgcolor="#ffffff">
                                                    <iframe id="FraDept" name="FraDept" src="deptinfo.aspx?ht=2" width="100%" scrolling="auto" height="370" runat="server"></iframe>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td>
                                        <table cellspacing="0" cellpadding="0" width="397" border="0">
                                            <tr>
                                                <td>
                                                    <iframe id="FraHuman" name="FraHuman" src="Human2.aspx" width="397" height="392"
