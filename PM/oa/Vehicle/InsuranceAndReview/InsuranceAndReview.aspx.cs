...
public partial class oa_Vehicle_InsuranceAndReview_InsuranceAndReview : NBasePage, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!base.IsPostBack)
		{
			List<InsuranceAndReviewModel> modelList = this.IARBLL.GetModelList(" TYPE<2 ORDER BY Date desc");
