<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Complete.aspx.cs" Inherits="ProgressManage_Complete" %>

<!DOCTYPE html >
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server"><title>实际完成量</title>
...
//                    $('#txtEndDate').val(end);
        ...
        function loadGantt(prjId) {
            var url = "../ProgressManage/Gantt/Complete.htm?id=" + prjId;
                    ...
                    <table style="width: 100%; height: 100%;">
                        <tr>
                            <td id="td_Left" style="width: 195px; vertical-align: top; height: 100%;">
                                ...
                                <div id="div_project" class="pagediv" style="width: 195px; height: 100%; vertical-align:top; position:relative;">
                                    <asp:TreeView ID="tvBudget" Font-Size="12px" ShowLines="true" style=" top:0px; position:absolute;" OnSelectedNodeChanged="tvBudget_SelectedNodeChanged" runat="server"><SelectedNodeStyle BackColor="#3399FF" ForeColor="White" /></asp:TreeView>
                                </div>
                            </td>
                                    ...
                                    <tr>
                                        <td style="vertical-align: top;" colspan="3">
                                            <div id="divBudget" class="pagediv" style=" overflow:hidden;">
                                                <span id="noProject" style="color: Red; display:none;">没有项目可以加载</span> 
                                                <span id="setDate" style=" color:Red; display: none;">
                                                    项目的结束时间必须大于开始时间，请联系管理员进行设置时间 </span>
                                                <iframe id="ifPlusGantt" style="width: 100%; height: 100%;" frameborder="0" scrolling="no">
                                                </iframe>
                                            </div>
                                        </td>
                                    </tr>
