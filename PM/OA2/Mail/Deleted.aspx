<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Deleted.aspx.cs" Inherits="OA2_Mail_Deleted" %>
<%@ Import Namespace="cn.justwin.BLL"%>
<%@ Import Namespace="Wuqi.Webdiyer"%>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server"><title>已删除邮件箱</title><link type="text/css" rel="stylesheet" href="../../Script/jquery.tooltip/jquery.tooltip.css" />
...
<link rel="Stylesheet" type="text/css" href="/Script/jquery.easyui/themes/icon.css" />
    ...
    <script type="text/javascript">
        ...
        function btnQueryClick(MailId, AnnexId) {
            ...
            var url = '/OA2/Mail/ViewMail.aspx?mailId=' + MailId + '&mailTY=L';
            //toolbox_oncommand(url, "查看邮件");
            this.location.href = url;
        }

        //选择人员
        function selectUser(nameinput) {
            ;
        }
    </script>
</head>
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%; height: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="spanSelect" style="width: 130px;">
                                                ...
                                                <img src="../../images/icon.bmp" style="float: right;" alt="选择" id="img1" onclick="jw.selectOneUser({ nameinput: 'txtTo' });" runat="server" />
                        ...
                        <tr>
                            <td id="td_buttons" class="divFooter" style="text-align: left;">
                                ...
                                <asp:Button ID="btnDelete" Width="70px" Text="彻底删除" disabled="disabled" OnClientClick="return confirm('你确定要彻底删除吗？');" OnClick="btnDelete_Click" runat="server" />
...
<Columns><asp:TemplateField HeaderStyle-Width="20px" HeaderStyle-HorizontalAlign="Center"><HeaderTemplate>
                                            ...
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="时间" HeaderStyle-Width="150px"><ItemTemplate>
                                                <%# Eval("InputDate") %>
