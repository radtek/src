<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Repeal.aspx.cs" Inherits="OA2_Mail_Repeal" %>
<%@ Import Namespace="cn.justwin.BLL"%>
<%@ Import Namespace="Wuqi.Webdiyer"%>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server"><title>撤回邮件</title><link type="text/css" rel="stylesheet" href="../../Script/jquery.tooltip/jquery.tooltip.css" />
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%; height: 100%;">
                        ...
                        <tr>
                            <td id="td_buttons" class="divFooter" style="text-align: left;">
                                ...
                                <asp:Button ID="btnRepeal" Text="撤 销" disabled="disabled" Visible="false" OnClick="btnRepeal_Click" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
...
<Columns><asp:TemplateField HeaderStyle-Width="20px" HeaderStyle-HorizontalAlign="Center"><HeaderTemplate>
                                                ...
                                                <span class="link tooltip" title='<%# Eval("MailName").ToString() %>' onclick="btnQueryClick('<%# Eval("MailId") %>')">
                                            ...
                                            </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="附件" HeaderStyle-Width="80px"><ItemTemplate>
